const CACHE_NAME = "the-sfm-trader-v20260918-quote-observation";
const STATIC_ASSETS = [
  "/",
  "/index.html",
  "/detail.html",
  ...
  "/assets/drawer-data.js?v=20260918-quote-observation",
  "/assets/drawer-mobile.css?v=20260918-analysis-layout",
  "/assets/drawer-focus.js?v=20260916-symbol-data",
  "./watchlist-engine.js?v=20260918-quote-observation",
  "./watchlist-view.js?v=20260918-quote-observation",
  "./watchlist.css?v=20260918-quote-observation",
  "./smart-analyzer.js?v=20260918-quote-observation",
  "./smart-analyzer.css?v=20260918-quote-observation",
  "/app.js?v=20260918-quote-observation",
