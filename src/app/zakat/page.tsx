  ...
  return (
    <div className="zakat-page" dir={dir}>
      ...
      <style jsx>{`
        ...
        .zakat-main-grid{grid-template-columns:minmax(0,1.05fr) minmax(0,1fr) minmax(300px,.8fr);gap:16px;align-items:start}.split-grid{grid-template-columns:minmax(0,.92fr) minmax(0,1.08fr);gap:16px}.section-head{align-items:center}.section-head h2{letter-spacing:0;text-wrap:balance}.form-grid{gap:14px}.form-grid label,.asset-box label{line-height:1.45}.form-grid input,.form-grid select,.asset-box input{min-height:46px;border-radius:var(--r-md)}.asset-box,.manual-box,.import-box,.guidance-list p,.result-grid div,.asset-list article,.history-list article{border-radius:var(--r-xl)}.guidance-panel,.summary-panel,.input-panel{height:fit-content}.history-list article,.asset-list article{min-width:0}.history-list span,.history-list small,.asset-list span,.asset-list small{overflow-wrap:anywhere}.muted{border-radius:var(--r-xl);background:rgba(234,246,255,.55);padding:14px;border:1px dashed rgba(29,140,255,.18)}
