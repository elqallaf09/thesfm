  ...
  return (
    <div className="zakat-page" data-charity-experience="zakat" dir={dir}>
      ...
      <style jsx>{`
        ...
        .zakat-page .gold-btn,.zakat-page .primary-wide{color:var(--primary-foreground)}.zakat-page .dark-btn{background:color-mix(in srgb, var(--hero-foreground) 10%, transparent);color:var(--hero-foreground)}
        ...
        .report-records{display:grid;gap:12px}.report-record{border:1px solid var(--border);border-radius:var(--radius-card);background:var(--surface-muted);padding:14px}.report-record dl{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin:0}.report-record dl div{min-width:0;display:grid;gap:5px}.report-record dt{color:var(--foreground-muted);font-size:12px;font-weight:600}.report-record dd{margin:0;color:var(--foreground);font-weight:600;overflow-wrap:anywhere}.report-record button{min-height:36px;border:1px solid var(--border);border-radius:var(--radius-control);background:var(--surface);color:var(--primary);padding:0 10px;font-weight:600;cursor:pointer}.report-status{display:inline-flex;border-radius:var(--radius-pill);padding:5px 9px;background:color-mix(in srgb, var(--accent) 12%, transparent);color:var(--primary-hover);font-size:12px}.report-status.draft{background:color-mix(in srgb, var(--warning) 14%, transparent);color:var(--accent)}.report-footer-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:16px}
