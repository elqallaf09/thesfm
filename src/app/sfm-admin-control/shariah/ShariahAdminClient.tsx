  ...
  return (
    <main dir={dir} className="sharia-admin-page">
      ...
      <style jsx>{`
        ...
        @media(max-width:520px){.sharia-admin-page{padding:14px;gap:16px}.sharia-admin-search{display:grid}.sharia-admin-search input,.sharia-admin-search button{width:100%;min-width:0}.sharia-admin-table-shell{border-radius:14px}.sharia-admin-review-panel{padding:15px}}
