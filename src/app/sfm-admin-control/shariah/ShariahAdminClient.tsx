    ...
    <main dir={dir} className="sharia-admin-page">
      ...
      <section className="sharia-admin-workspace">
        <div
          ...
          role="region"
          tabIndex={0}
          aria-label={t('admin_shariah_title')}
        >
          <table>
            <thead>
              <tr>
      ...
      <style jsx>{`
        .sharia-admin-page{display:grid;gap:20px;min-width:0;padding:0;color:var(--foreground);background:var(--background);font-family:var(--font-ui)}
        ...
        @media(max-width:520px){.sharia-admin-page{gap:16px}.sharia-admin-search{display:grid}.sharia-admin-search input,.sharia-admin-search button{width:100%;min-width:0}.sharia-admin-table-shell{border-radius:var(--radius-control)}.sharia-admin-review-panel{padding:15px}}
