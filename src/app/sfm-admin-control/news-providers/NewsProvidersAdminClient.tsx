  ...
  return (
    <AdminDashboardShell ariaLabel={text.title} contentClassName="news-provider-admin-content" contentStyle={{ width: '100%', maxWidth: '100%' }}>
      ...
      <style jsx>{`
        ...
        .news-provider-hero{display:flex;align-items:center;justify-content:space-between;gap:20px;border:1px solid rgba(29,140,255,.14);border-radius:var(--r-2xl);padding:clamp(20px,3vw,34px);background:linear-gradient(135deg,rgba(29,140,255,.10),rgba(24,212,212,.06));box-shadow:0 18px 55px rgba(15,23,42,.07)}
        ...
        .news-provider-hero button{min-height:44px;min-width:150px;border:0;border-radius:var(--r-md);padding:0 16px;background:linear-gradient(135deg,#1d8cff,#18d4d4);color:#061a2e;display:inline-flex;align-items:center;justify-content:center;gap:8px;font:900 14px Tajawal,Arial,sans-serif;cursor:pointer;white-space:nowrap}.news-provider-hero button:disabled{opacity:.65;cursor:wait}.spinning{animation:spin .8s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}
        .news-provider-summary{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.news-provider-summary article{min-width:0;border:1px solid rgba(148,163,184,.16);border-radius:var(--r-xl);background:var(--sfm-card-bg,#fff);padding:16px;display:grid;grid-template-columns:auto 1fr;gap:4px 10px;align-items:center;box-shadow:0 12px 30px rgba(15,23,42,.05)}.news-provider-summary svg{grid-row:1/3;color:#1d8cff}.news-provider-summary strong{font-size:25px;font-weight:950}.news-provider-summary span{color:var(--sfm-muted,#64748b);font-size:13px;font-weight:850}
        .news-provider-notice{min-height:58px;border:1px solid rgba(29,140,255,.18);border-radius:var(--r-lg);padding:13px 16px;display:flex;align-items:center;gap:10px;background:rgba(29,140,255,.06)}.news-provider-notice.warning{border-color:rgba(217,119,6,.22);background:rgba(245,158,11,.09);color:#92400e}.news-provider-notice.danger{border-color:rgba(220,38,38,.22);background:rgba(220,38,38,.07);color:#b91c1c}.news-provider-notice p{margin:0;font-size:14px;line-height:1.65;font-weight:850}
        .news-provider-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.news-provider-card{min-width:0;border:1px solid rgba(148,163,184,.17);border-radius:var(--r-2xl);background:var(--sfm-card-bg,#fff);padding:18px;display:grid;gap:15px;box-shadow:0 14px 40px rgba(15,23,42,.055)}
