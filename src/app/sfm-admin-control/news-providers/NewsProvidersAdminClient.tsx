  ...
  return (
    <AdminDashboardShell ariaLabel={text.title} contentClassName="news-provider-admin-content" contentStyle={{ width: '100%', maxWidth: '100%' }}>
      ...
      <style jsx>{`
        ...
        .news-provider-admin{width:100%;max-width:none;margin:0;padding:0 0 calc(16px + env(safe-area-inset-bottom));display:grid;gap:18px;color:var(--foreground);font-family:var(--font-ui);overflow-x:hidden}
