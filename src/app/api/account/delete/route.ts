...
const DELETE_TARGETS: DeleteTarget[] = [
  ...
  { table: 'khums_reminders', column: 'user_id', optional: true },
  { table: 'khums_payments', column: 'user_id', optional: true },
  { table: 'khums_entries', column: 'user_id', optional: true },
  { table: 'khums_years', column: 'user_id', optional: true },
