...
const gateStyles = `
  ...
  .trader-gate-card { width:min(620px,100%);border:1px solid #24486F;border-radius:22px;padding:34px;background:linear-gradient(180deg,rgba(15,34,56,.96),rgba(10,23,40,.94));box-shadow:0 24px 64px rgba(0,0,0,.34);text-align:start }
