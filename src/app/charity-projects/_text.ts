...
const RAW_TEXT = {
  ar: {
    ...
    subtitle: 'نظّم الكفالات والصدقات والمشاريع الخيرية طويلة الأمد، مع إبقاء الزكاة والخمس في مساريهما المستقلين.',
    ...
    forecastEmpty: 'أضف كفالة أو مشروعاً خيرياً لتقدير الالتزامات الطوعية المتوقعة.',
    ...
    impactDashboardDesc: 'تتبّع أثر تبرعاتك ومشاريعك والمستفيدين في لوحة واضحة قابلة للمتابعة.',
    notEnoughImpactData: 'لا توجد بيانات كافية لعرض الأثر حالياً.',
    impactEmptyBody: 'أضف مشروعاً خيرياً أو تبرعاً لبدء تتبع الأثر.',
    ...
    impactByCategory: 'توزيع الأثر حسب الفئة',
    beneficiaryImpact: 'أثر المستفيدين',
    yearlyImpactSummary: 'ملخص الأثر السنوي',
    customImpactIndicators: 'مؤشرات أثر مخصصة',
    addImpactMetric: 'حفظ مؤشر الأثر',
  ...
  en: {
    ...
    subtitle: 'Organize sponsorships, donations, and long-term charity projects while Zakat and Khums remain independent workflows.',
    ...
    forecastEmpty: 'Add sponsorships or charity projects to estimate expected voluntary commitments.',
    ...
    reportsDesc: 'Generate annual summaries from saved voluntary charity projects, donations, beneficiaries, and documents.',
  ...
  fr: {
    ...
    subtitle: 'Organisez les parrainages, les dons et les projets caritatifs, tandis que la zakat et le khums restent des parcours indépendants.',
    ...
    forecastEmpty: 'Ajoutez des parrainages ou des projets caritatifs pour estimer les engagements volontaires prévus.',
    ...
    reportsDesc: 'Générez des synthèses annuelles à partir des projets caritatifs volontaires, dons, bénéficiaires et documents.',
...
const ARABIC_COPY_OVERRIDES = {
  ...
  documentsEmptyBody: 'احفظ إيصالات التبرعات، شهادات الجمعيات، وتقارير المشاريع في مكان واحد.',
  impactDashboard: 'لوحة الأثر',
  impactDashboardDesc: 'تتبّع أثر التبرعات والمشاريع والمستفيدين في لوحة واضحة قابلة للمتابعة.',
  notEnoughImpactData: 'لا توجد بيانات كافية لعرض الأثر حالياً.',
  impactEmptyBody: 'أضف مشروعاً خيرياً أو تبرعاً لبدء تتبع الأثر.',
  reportsDesc: 'أنشئ تقارير خيرية مستقلة للتبرعات الطوعية والمستفيدين والمشاريع.',
  notEnoughReportData: 'لا توجد بيانات كافية لإنشاء تقرير حالياً',
  emptyReportsBody: 'أضف مشاريع أو تبرعات لبدء إنشاء التقارير.',
  yearlyCharityReport: 'التقرير الخيري السنوي',
  zakatKhumsReport: 'تقرير الزكاة والخمس',
