  ...
  return (
    <main className="report-page" dir={dir}>
      ...
      <style jsx global>{`
        ...
        .report-actions{max-width:1040px;margin:0 auto 16px;display:flex;justify-content:space-between;gap:10px}.report-actions button{height:42px;border-radius:12px;border:1px solid rgba(29,140,255,.22);background:var(--sfm-card);color:var(--sfm-midnight);padding:0 14px;display:inline-flex;align-items:center;gap:7px;font:900 13px Tajawal,Arial,sans-serif;cursor:pointer}
        .report-sheet{max-width:1040px;margin:0 auto;background:var(--sfm-card);border:1px solid rgba(29,140,255,.18);border-radius:24px;box-shadow:0 18px 54px rgba(3,18,37,.12);overflow:hidden}.cover{background:linear-gradient(135deg,var(--sfm-deep-navy),var(--sfm-primary-dark) 62%,var(--sfm-card-dark) 145%);color:var(--sfm-card);padding:34px}.brand{display:flex;align-items:center;gap:12px}.brand img{border-radius:12px}.brand strong{display:block;color:var(--sfm-soft-cyan);font-size:18px}.brand span{display:block;color:rgba(234,246,255,.58);font-size:12px}.cover h1{margin:28px 0 14px;font-size:42px}.cover-meta{display:flex;gap:12px;flex-wrap:wrap}.cover-meta span{border:1px solid rgba(255,255,255,.16);background:rgba(255,255,255,.08);border-radius:999px;padding:7px 12px;color:rgba(234,246,255,.75)}
        .section{padding:24px 30px;border-bottom:1px solid rgba(29,140,255,.12)}.section h2{margin:0 0 14px;color:var(--sfm-midnight);font-size:23px}.section h3{margin:16px 0 8px;color:var(--sfm-primary-hover);font-size:15px}.summary-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}.summary-grid.three{grid-template-columns:repeat(3,minmax(0,1fr))}.metric{border:1px solid rgba(29,140,255,.14);background:rgba(29,140,255,.10);border-radius:16px;padding:14px}.metric small{display:block;color:var(--sfm-primary-hover);font-weight:800}.metric strong{display:block;margin-top:6px;color:var(--sfm-primary-dark);font-size:20px;overflow-wrap:anywhere}.table-wrap{overflow-x:auto}table{width:100%;border-collapse:collapse;font-size:12px}th,td{padding:10px;border-bottom:1px solid rgba(29,140,255,.12);text-align:start;vertical-align:top}th{color:var(--sfm-primary-hover);background:rgba(29,140,255,.10)}.empty{color:var(--sfm-muted);margin:0;line-height:1.8}ul{margin:0 20px;color:var(--sfm-midnight)}footer{padding:20px 30px;background:var(--sfm-light-card);color:var(--sfm-muted);font-size:12px;line-height:1.8}footer span{display:block;margin-top:8px;color:var(--sfm-primary-hover);font-weight:900}
