...
export default function CharityProjectsPage() {
  ...
  return (
    <div className="charity-projects-page" dir={dir}>
      ...
      <style jsx>{`
        .charity-projects-page{min-height:100vh;background:#F5F1E8;color:#1A0F05;font-family:Tajawal,Arial,sans-serif}
        .charity-projects-content{display:grid;gap:18px}
        .cp-hero{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;border-radius:26px;padding:30px;background:radial-gradient(circle at 18% 20%,rgba(239,159,39,.28),transparent 28%),linear-gradient(135deg,#1A0F05,#2B1A0F 58%,#8A5514 140%);color:#FFFDF8;box-shadow:0 18px 48px rgba(45,26,10,.18);overflow:visible}
        ...
        .project-card{border:1px solid rgba(186,117,23,.14);border-radius:18px;background:#FFFDF8;padding:16px;display:grid;gap:13px}.project-top{display:flex;justify-content:space-between;gap:12px}.project-top strong{display:block;color:#3D2914;font-size:17px}.project-top span,.badge-row span,.project-card p{color:#7A6A55;font-size:12px}.status,.badge-row span{border-radius:999px;padding:5px 9px;background:#FAEEDA;color:#854F0B;font-size:11px}.badge-row{display:flex;gap:8px;flex-wrap:wrap}.progress{height:9px;border-radius:99px;background:#F1E6D4;overflow:hidden}.progress i{display:block;height:100%;border-radius:99px;background:linear-gradient(90deg,#BA7517,#EF9F27)}.money-row{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.money-row div{background:#F7F0E4;border-radius:13px;padding:10px}.money-row small{display:block;color:#8A6A55}.money-row strong{display:block;color:#3D2914;font-size:13px}.card-actions{display:flex;gap:8px;flex-wrap:wrap}.card-actions button{border:1px solid rgba(186,117,23,.16);background:#FFF8EA;color:#3D2914;border-radius:11px;min-height:36px;padding:0 10px;display:inline-flex;align-items:center;gap:6px;cursor:pointer;font-weight:800;font-size:12px}
        ...
        @media(max-width:1180px){.summary-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.span-7,.span-5{grid-column:span 12}.split-grid{grid-template-columns:1fr}.project-grid{grid-template-columns:1fr}}
