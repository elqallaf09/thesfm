...
export default function DecisionsPage() {
  ...
  return (
    <div className="decisions-page" dir={dir}>
          ...
          <article className="decision-card">
            ...
            <div className="decision-form-grid">
              ...
              <label>
                ...
                <div style={{display:'flex',alignItems:'center',border:'1px solid rgba(29,140,255,.2)',borderRadius:'var(--r-md)',background:'var(--sfm-light-card)',overflow:'hidden'}}>
      ...
      <style jsx global>{`
        .decisions-page{min-height:100vh;background:var(--sfm-light-card);color:var(--sfm-foreground);font-family:Tajawal,Arial,sans-serif}.decisions-content{display:grid;gap:16px}.decision-layout{display:grid;grid-template-columns:minmax(0,1.05fr) minmax(320px,.95fr);gap:16px;align-items:start}.decision-card{background:var(--sfm-card);border:1px solid rgba(29,140,255,.16);border-radius:var(--r-2xl);padding:18px;box-shadow:0 14px 34px rgba(3,18,37,.07);min-width:0}.decision-card-head{display:flex;align-items:center;gap:10px;margin-bottom:14px;color:var(--sfm-primary)}.decision-card-head h2{margin:0;color:var(--sfm-midnight);font-size:19px}.decision-form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.decision-form-grid label{display:grid;gap:7px;min-width:0}.decision-form-grid .wide{grid-column:1/-1}.decision-form-grid span{color:var(--sfm-muted);font-weight:900}.decision-form-grid input,.decision-form-grid select,.decision-form-grid textarea{width:100%;min-width:0;border:1px solid rgba(29,140,255,.2);background:var(--sfm-light-card);color:var(--sfm-foreground);border-radius:var(--r-md);padding:11px 12px;font-family:inherit;font-weight:850;outline:none}.decision-form-grid input:focus,.decision-form-grid select:focus,.decision-form-grid textarea:focus{border-color:var(--sfm-accent);box-shadow:0 0 0 3px rgba(24,212,212,.15)}.decision-primary{margin-top:14px;min-height:44px;border:0;border-radius:var(--r-md);background:linear-gradient(135deg,var(--sfm-primary),var(--sfm-accent));color:#fff;padding:0 16px;display:inline-flex;align-items:center;justify-content:center;gap:8px;font-family:inherit;font-weight:950;cursor:pointer}.decision-primary:disabled{opacity:.65;cursor:not-allowed}.risk-meter{height:150px;border-radius:var(--r-2xl);background:radial-gradient(circle at 50% 35%,rgba(167,243,240,.25),transparent 40%),linear-gradient(135deg,var(--sfm-deep-navy),var(--sfm-primary-dark));display:grid;place-items:center;text-align:center;color:#fff;margin-bottom:12px}.risk-meter strong{display:block;color:var(--sfm-soft-cyan);font-size:42px}.risk-meter span{display:block;font-weight:900}.decision-metrics{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.decision-metric{border:1px solid rgba(29,140,255,.12);background:var(--sfm-light-card);border-radius:var(--r-lg);padding:12px}.decision-metric span{display:block;color:var(--sfm-muted);font-size:12px;font-weight:900}.decision-metric strong{display:block;margin-top:6px;color:var(--sfm-primary-dark);font-size:16px;overflow-wrap:anywhere}.decision-reason{margin-top:12px;border:1px solid rgba(29,140,255,.12);background:var(--sfm-light-card);border-radius:var(--r-lg);padding:12px}.decision-reason b{display:block;color:var(--sfm-midnight);margin-bottom:6px}.decision-reason p{margin:0;color:var(--sfm-muted);line-height:1.7;font-weight:850}.decision-reason ul{margin:0;padding:0;list-style:none;display:grid;gap:7px}.decision-reason li{display:flex;align-items:flex-start;gap:7px;color:var(--sfm-muted);font-weight:850}.decision-reason li svg{color:#047857;flex:0 0 auto;margin-top:2px}.decision-disclaimer{margin:12px 0 0;color:var(--sfm-muted);font-size:12px;font-weight:900;line-height:1.7}.decision-message{border:1px solid rgba(34,197,94,.18);background:#ECFDF5;color:#047857;border-radius:var(--r-lg);padding:12px 14px;font-weight:900}.decision-message.error{border-color:rgba(239,68,68,.2);background:#FEF2F2;color:#B91C1C}.decision-empty{min-height:130px;display:grid;place-items:center;text-align:center;color:var(--sfm-muted);font-weight:900;border:1px dashed rgba(29,140,255,.22);border-radius:var(--r-lg);background:var(--sfm-light-card)}.decision-list{display:grid;gap:9px}.decision-row{display:grid;grid-template-columns:minmax(0,1fr) auto auto;gap:8px;align-items:center;border:1px solid rgba(29,140,255,.12);border-radius:var(--r-lg);background:var(--sfm-light-card);padding:8px}.decision-row.active{border-color:rgba(24,212,212,.38);box-shadow:0 0 0 3px rgba(24,212,212,.12)}.decision-row button{border:0;background:transparent;color:var(--sfm-midnight);font-family:inherit;text-align:start;cursor:pointer}.decision-row button strong,.decision-row button span{display:block}.decision-row button span{color:var(--sfm-muted);font-size:12px;font-weight:900;margin-top:4px}.decision-row em{font-style:normal;border-radius:999px;background:rgba(29,140,255,.10);color:var(--sfm-primary-hover);padding:6px 9px;font-size:12px;font-weight:950}.decision-row .delete{width:34px;height:34px;display:grid;place-items:center;color:#B91C1C;border-radius:var(--r-md)}.decision-row .delete:hover{background:#FEF2F2}.decision-loading{min-height:260px;display:grid;place-items:center;color:var(--sfm-muted);font-weight:900}.spin{animation:spin 1s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}.analysis.good{border-color:rgba(34,197,94,.22)}.analysis.warning{border-color:rgba(245,158,11,.25)}.analysis.danger{border-color:rgba(239,68,68,.25)}@media(max-width:1180px){.decision-layout{grid-template-columns:1fr}.decision-metrics{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:720px){.decision-card{padding:16px}.decision-form-grid,.decision-metrics{grid-template-columns:1fr}.decision-primary{width:100%}.decision-row{grid-template-columns:1fr auto}.decision-row .delete{grid-column:2}.risk-meter{height:130px}}
      `}</style>
    </div>
  );
}
