  ...
  return (
    <div className="invest-shell" dir={dir}>
      ...
      <style jsx global>{`
        ...
        .invest-hero-total{position:relative;z-index:1;min-width:270px;background:linear-gradient(145deg,rgba(6,18,34,.92),rgba(13,43,68,.88));border:1px solid rgba(167,243,240,.28);border-radius:20px;padding:18px;display:grid;gap:8px;backdrop-filter:blur(12px);box-shadow:inset 0 0 0 1px rgba(255,255,255,.06),0 18px 42px rgba(0,0,0,.28);color:#F8FAFC}.invest-live-icon{width:42px;height:42px;border-radius:14px;display:grid;place-items:center;background:rgba(47,214,192,.16);color:#67E8F9}.invest-hero-total span{color:#D8E8F8;font-size:12px;font-weight:950}.invest-hero-total strong{font-size:24px;color:#F8FAFC;font-variant-numeric:tabular-nums;overflow-wrap:anywhere;text-shadow:0 2px 10px rgba(0,0,0,.28)}.invest-live-delta{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.invest-live-delta b{font-size:13px;font-weight:950;color:#E8EEF6}.invest-live-delta em{font-style:normal;border-radius:999px;padding:5px 9px;font-size:11px;font-weight:950;background:rgba(255,255,255,.12);color:#F8FAFC}.invest-hero-total small{color:#C9D8E8;font-size:11px;font-weight:900;line-height:1.6}.invest-hero-total small b{font-weight:950;color:#FFFFFF}.invest-live-count{color:#B8C7D9!important}.invest-hero-total--up{border-color:rgba(34,197,94,.52);background:linear-gradient(145deg,rgba(5,46,22,.88),rgba(6,18,34,.92))}.invest-hero-total--up .invest-live-icon,.invest-hero-total--up .invest-live-delta em{background:rgba(34,197,94,.18);color:#BBF7D0}.invest-hero-total--up strong,.invest-hero-total--up .invest-live-delta b{color:#BBF7D0}.invest-hero-total--down{border-color:rgba(248,113,113,.58);background:linear-gradient(145deg,rgba(69,10,10,.9),rgba(6,18,34,.92))}.invest-hero-total--down .invest-live-icon,.invest-hero-total--down .invest-live-delta em{background:rgba(248,113,113,.18);color:#FECACA}.invest-hero-total--down strong,.invest-hero-total--down .invest-live-delta b{color:#FECACA}
