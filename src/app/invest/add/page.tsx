  ...
  return (
    <main className="page" dir={dir}>
      ...
      <style jsx>{`
        ...
        .card{width:min(100%,620px);background:var(--sfm-card);border:1px solid rgba(167,243,240,.16);border-radius:26px;box-shadow:0 24px 70px rgba(3,18,37,.12);padding:24px}
        .top{display:flex;align-items:center;justify-content:space-between;margin-bottom:18px}.back{height:40px;border-radius:12px;border:1px solid rgba(167,243,240,.22);background:#FFFFFF;color:var(--sfm-muted);display:inline-flex;align-items:center;gap:8px;padding:0 14px;font:800 13px Tajawal,Arial,sans-serif;cursor:pointer}
        .hero{display:flex;gap:16px;align-items:center;background:linear-gradient(135deg,var(--sfm-foreground),var(--sfm-primary-dark));border-radius:22px;padding:22px;color:#fff;margin-bottom:20px}.mark{width:58px;height:58px;border-radius:18px;background:rgba(167,243,240,.14);color:var(--sfm-soft-cyan);display:grid;place-items:center;flex:0 0 auto}.hero h1{margin:0 0 8px;font-size:28px}.hero p{margin:0;color:rgba(255,255,255,.68);line-height:1.7}
        form{display:grid;gap:12px}label{font-size:13px;font-weight:900;color:var(--sfm-muted)}.types{display:grid;grid-template-columns:repeat(3,1fr);gap:9px}.type{min-height:54px;border:1px solid rgba(167,243,240,.2);border-radius:14px;background:#FFFFFF;color:var(--sfm-muted);font:800 13px Tajawal,Arial,sans-serif;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:7px}.type.active{background:rgba(167,243,240,.16);border-color:var(--sfm-soft-cyan);color:var(--sfm-foreground)}
        input{height:50px;border-radius:14px;border:1.5px solid rgba(167,243,240,.22);background:rgba(247,243,234,.7);padding:0 13px;font:800 15px Tajawal,Arial,sans-serif;outline:none;color:var(--sfm-foreground)}input:focus{border-color:var(--sfm-soft-cyan);box-shadow:0 0 0 4px rgba(167,243,240,.14)}
        .save{height:54px;border:0;border-radius:16px;background:linear-gradient(135deg,var(--sfm-foreground),var(--sfm-primary-dark),var(--sfm-soft-cyan));color:#fff;font:900 15px Tajawal,Arial,sans-serif;display:flex;align-items:center;justify-content:center;gap:9px;cursor:pointer;margin-top:8px}.save:disabled{opacity:.6;cursor:wait}.msg{border-radius:13px;padding:11px 13px;background:rgba(239,68,68,.08);color:#B91C1C;font-size:13px;font-weight:800}.msg.ok{background:rgba(34,197,94,.08);color:#15803D}.spinner{width:44px;height:44px;border-radius:50%;border:3px solid rgba(167,243,240,.22);border-top-color:var(--sfm-soft-cyan);animation:spin 1s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}@media(max-width:620px){.types{grid-template-columns:1fr}.hero{align-items:flex-start;flex-direction:column}}
      `}</style>
    </main>
  );
}
