...
const styles = `
  ...
  .hero-actions{display:flex;gap:9px;flex-wrap:wrap;justify-content:flex-end}.hero-actions a,.hero-actions button,.empty-state a,.module-links a,.copilot-panel a{border:0;border-radius:var(--r-md);display:inline-flex;align-items:center;justify-content:center;gap:8px;font:950 13px Tajawal,Arial,sans-serif;cursor:pointer;min-height:44px;padding:0 16px;text-decoration:none;transition:transform .18s ease,box-shadow .18s ease,background .18s ease}
  ...
  .hero-actions a:hover{background:rgba(255,255,255,.2);border-color:rgba(255,255,255,.44);transform:translateY(-1px);box-shadow:0 12px 28px rgba(3,18,37,.22),inset 0 1px 0 rgba(255,255,255,.22)}.load-warning{display:flex;align-items:center;gap:8px;background:#FFF7ED;border:1px solid rgba(154,94,13,.18);color:#7A4B09;border-radius:var(--r-lg);padding:12px 14px;font-weight:900}
  .selector-panel,.readiness-head,.warm-card,.empty-state,.state-panel{background:var(--sfm-card);border:1px solid rgba(29,140,255,.14);border-radius:var(--r-2xl);box-shadow:0 14px 38px rgba(3,18,37,.06);min-width:0}
  ...
  .selector-panel label,.field{display:grid;gap:7px;min-width:0}.selector-panel label span,.field span{font-size:12px;font-weight:950;color:var(--sfm-muted)}.selector-panel select,.field select,.field input,.field textarea{width:100%;min-width:0;border:1px solid rgba(29,140,255,.2);background:var(--sfm-card);color:var(--sfm-deep-navy);border-radius:var(--r-md);min-height:44px;padding:0 12px;font:900 13px Tajawal,Arial,sans-serif;outline:none}.field textarea{min-height:86px;padding:11px 12px;line-height:1.6;resize:vertical}.selector-panel select:focus,.field select:focus,.field input:focus,.field textarea:focus{border-color:var(--sfm-accent);box-shadow:0 0 0 3px rgba(24,212,212,.14)}
  ...
  .readiness-head{padding:18px;display:flex;align-items:center;justify-content:space-between;gap:16px}.score-pill{display:grid;place-items:center;text-align:center;min-width:140px;border-radius:var(--r-xl);background:var(--sfm-light-card);border:1px solid rgba(29,140,255,.16);padding:12px}.score-pill strong{font-size:24px;color:var(--sfm-primary-dark)}.score-pill span{font-size:12px;font-weight:950;color:var(--sfm-primary-hover)}
  .readiness-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:12px;min-width:0}.readiness-card{background:var(--sfm-card);border:1px solid rgba(29,140,255,.14);border-radius:var(--r-xl);padding:15px;box-shadow:0 14px 38px rgba(3,18,37,.06);display:grid;gap:12px;min-width:0}.readiness-icon{width:42px;height:42px;border-radius:var(--r-md);display:grid;place-items:center;background:rgba(29,140,255,.10);color:var(--sfm-primary)}.readiness-card h3{margin:0;color:var(--sfm-midnight);font-size:15px;font-weight:950;line-height:1.35}.readiness-card strong{display:block;margin:5px 0;color:var(--sfm-primary-dark);font-size:20px;overflow-wrap:anywhere}
  ...
  .check-list,.document-grid,.module-links{display:grid;gap:10px}.check-row,.document-link{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:10px;align-items:center;border:1px solid rgba(29,140,255,.12);background:var(--sfm-light-card);border-radius:var(--r-lg);padding:11px;text-decoration:none;color:var(--sfm-primary-dark);min-width:0}.check-row strong,.document-link span{min-width:0;font-weight:950;overflow-wrap:anywhere}.check-row small,.document-link small{color:var(--sfm-muted);font-size:11px;font-weight:950}.done,.todo{width:28px;height:28px;border-radius:var(--r-md);display:grid;place-items:center}.done{background:#ECFDF5;color:#047857}.todo{background:#FEF2F2;color:#B91C1C}.document-link.disabled{opacity:.68;cursor:not-allowed}
  .copilot-panel{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:center;border:1px solid rgba(29,140,255,.12);background:var(--sfm-light-card);border-radius:var(--r-lg);padding:14px}.copilot-panel span{display:block;color:var(--sfm-muted);font-size:12px;font-weight:950}.copilot-panel strong{display:block;margin-top:5px;color:var(--sfm-primary-dark);overflow-wrap:anywhere}
  .wizard-form{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.wizard-project-selector{grid-column:1 / -1;min-width:0}.wizard-output{position:sticky;top:18px}.jurisdiction-summary{display:grid;gap:8px;margin:12px 0}.jurisdiction-summary p{margin:0;display:grid;grid-template-columns:minmax(120px,.42fr) minmax(0,1fr);gap:10px;border-bottom:1px solid rgba(29,140,255,.1);padding-bottom:8px}.jurisdiction-summary b{color:var(--sfm-muted)}.jurisdiction-summary span{font-weight:950;color:var(--sfm-primary-dark)}.plain-list,.missing-box ul{margin:12px 0 0;padding-inline-start:18px;color:var(--sfm-muted);line-height:1.8;font-weight:850}.missing-box{margin-top:12px;border:1px dashed rgba(29,140,255,.24);background:var(--sfm-light-card);border-radius:var(--r-lg);padding:12px}.missing-box strong{color:var(--sfm-primary-hover)}.trusted-note{margin:12px 0 0;color:var(--sfm-muted);font-weight:900;line-height:1.7}
