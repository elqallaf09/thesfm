...
const styles = `
  ...
  .module-links{grid-template-columns:repeat(2,minmax(0,1fr))}.module-links a{background:var(--sfm-light-card);color:var(--sfm-midnight);border:1px solid rgba(29,140,255,.14);min-height:46px}.module-links a:hover{transform:translateY(-1px);box-shadow:0 12px 28px rgba(29,140,255,.14)}html.dark .business-hub-shell .module-links a{background:rgba(15,29,49,.96);color:#EAF6FF;border-color:rgba(47,214,192,.26);box-shadow:inset 0 1px 0 rgba(255,255,255,.04),0 10px 24px rgba(0,0,0,.18)}html.dark .business-hub-shell .module-links a svg{color:#2FD6C0}html.dark .business-hub-shell .module-links a:hover{background:rgba(19,36,58,.98);border-color:rgba(47,214,192,.46);box-shadow:0 14px 32px rgba(0,0,0,.24),0 0 0 3px rgba(47,214,192,.10)}.mini-metrics{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin-top:14px}.mini-metrics p{margin:0;border:1px solid rgba(29,140,255,.12);background:var(--sfm-light-card);border-radius:15px;padding:12px;min-width:0}.mini-metrics span{display:block;color:var(--sfm-muted);font-size:12px;font-weight:950}.mini-metrics strong{display:block;margin-top:5px;color:var(--sfm-primary-dark);overflow-wrap:anywhere}
