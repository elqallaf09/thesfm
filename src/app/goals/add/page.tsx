  ...
  return (
    <main className="page" dir={dir}>
      ...
      <style jsx>{`
        ...
        form{display:grid;gap:12px}label{font-size:13px;font-weight:900;color:var(--sfm-muted)}input,textarea{border-radius:14px;border:1.5px solid rgba(167,243,240,.22);background:rgba(247,243,234,.7);padding:0 13px;font:800 15px Tajawal,Arial,sans-serif;outline:none;color:var(--sfm-foreground)}input{height:50px}textarea{min-height:86px;padding-top:12px;resize:vertical}input:focus,textarea:focus{border-color:var(--sfm-soft-cyan);box-shadow:0 0 0 4px rgba(167,243,240,.14)}
        .durations{display:grid;grid-template-columns:repeat(4,1fr);gap:9px}.duration{min-height:44px;border:1px solid rgba(167,243,240,.2);border-radius:14px;background:#FFFFFF;color:var(--sfm-muted);font:800 13px Tajawal,Arial,sans-serif;cursor:pointer}.duration.active{background:rgba(167,243,240,.16);border-color:var(--sfm-soft-cyan);color:var(--sfm-foreground)}
