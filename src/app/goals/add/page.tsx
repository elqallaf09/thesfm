...
export default function AddGoalPage() {
  ...
  return (
    <main className="page" dir={dir}>
      ...
      <style jsx>{`
        .page{min-height:100vh;background:var(--background);display:grid;place-items:center;padding:24px;font-family:var(--font-ui);color:var(--foreground)}
        .card{width:min(100%,620px);background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-panel);box-shadow:var(--shadow-md);padding:24px}
        .top{display:flex;align-items:center;justify-content:space-between;margin-bottom:18px}.back{height:40px;border-radius:var(--radius-control);border:1px solid var(--border);background:var(--control-background);color:var(--foreground-secondary);display:inline-flex;align-items:center;gap:8px;padding:0 14px;font:600 13px var(--font-ui);cursor:pointer}.back:hover{background:var(--control-hover)}.back:focus-visible{outline:2px solid var(--focus-ring);outline-offset:2px}
        .hero{display:flex;gap:16px;align-items:center;background:var(--hero-gradient);border-radius:var(--radius-panel);padding:22px;color:var(--hero-foreground);margin-bottom:20px}.mark{width:58px;height:58px;border-radius:var(--radius-card);background:color-mix(in srgb,var(--hero-foreground) 12%,transparent);color:var(--hero-foreground);display:grid;place-items:center;flex:0 0 auto}.hero h1{margin:0 0 8px;font-size:28px;font-weight:700}.hero p{margin:0;color:var(--hero-foreground-muted);line-height:1.7}
        form{display:grid;gap:12px}label{font-size:13px;font-weight:500;color:var(--foreground-secondary)}input,textarea{border-radius:var(--radius-control);border:1px solid var(--border-strong);background:var(--control-background);padding:0 13px;font:500 15px var(--font-ui);outline:none;color:var(--foreground)}input[dir="ltr"]{font-family:var(--font-data)}input{height:var(--control-h-lg)}textarea{min-height:86px;padding-top:12px;resize:vertical}input:focus,textarea:focus{border-color:var(--focus-ring);box-shadow:var(--focus-shadow)}
        .durations{display:grid;grid-template-columns:repeat(4,1fr);gap:9px}.duration{min-height:44px;border:1px solid var(--border);border-radius:var(--radius-control);background:var(--control-background);color:var(--foreground-secondary);font:500 13px var(--font-ui);cursor:pointer}.duration:hover{background:var(--control-hover)}.duration:focus-visible{outline:2px solid var(--focus-ring);outline-offset:2px}.duration.active{background:var(--primary-soft);border-color:var(--primary);color:var(--primary-active)}
        .save{height:54px;border:0;border-radius:var(--radius-card);background:var(--primary);color:var(--primary-foreground);font:600 15px var(--font-ui);display:flex;align-items:center;justify-content:center;gap:9px;cursor:pointer;margin-top:8px}.save:hover{background:var(--primary-hover)}.save:focus-visible{outline:2px solid var(--focus-ring);outline-offset:2px}.save:disabled{opacity:.6;cursor:wait}.msg{border-radius:var(--radius-control);padding:11px 13px;background:var(--danger-soft);color:var(--danger);font-size:13px;font-weight:500}.msg.ok{background:var(--success-soft);color:var(--success)}.spinner{width:44px;height:44px;border-radius:var(--radius-pill);border:3px solid var(--border);border-top-color:var(--primary);animation:spin 1s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}@media(max-width:620px){.durations{grid-template-columns:1fr 1fr}.hero{align-items:flex-start;flex-direction:column}}
      `}</style>
    </main>
  );
}
