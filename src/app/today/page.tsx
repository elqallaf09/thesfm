...
const TEXT = {
  ar: {
    ...
    recentActivity: 'النشاط المهم الأخير', noActivity: 'لا يوجد نشاط حديث لعرضه.', quickActions: 'إجراءات سريعة',
  ...
  en: {
    ...
    recentActivity: 'Recent important activity', noActivity: 'No recent activity to show.', quickActions: 'Quick actions',
  ...
  fr: {
    ...
    recentActivity: 'Activité importante récente', noActivity: 'Aucune activité récente à afficher.', quickActions: 'Actions rapides',
...
export default function TodayCenterPage() {
  ...
  const { rows: recentActivity } = useRecentAccountActivity(6);
