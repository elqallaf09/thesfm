...
export const TEXT = {
  ...
  activeDebtsCount: { ar: 'عدد الديون النشطة', en: 'Active debts', fr: 'Dettes actives' },
  paidDebtsCount: { ar: 'الديون المسددة', en: 'Paid debts', fr: 'Dettes payées' },
  ...
  principalPaid: { ar: 'أصل الدين المدفوع', en: 'Principal paid', fr: 'Capital remboursé' },
  finalPaymentAmount: { ar: 'الدفعة النهائية المتوقعة', en: 'Estimated final payment', fr: 'Paiement final estimé' },
  totalRemainingInterest: { ar: 'إجمالي الفائدة المتبقية', en: 'Remaining interest', fr: 'Intérêts restants' },
  principalReductionNextPayment: { ar: 'تخفيض الأصل بالدفعة القادمة', en: 'Principal reduction next payment', fr: 'Capital réduit au prochain paiement' },
  monthlyInterestCurrent: { ar: 'الفائدة الشهرية الحالية', en: 'Current monthly interest', fr: 'Intérêt mensuel actuel' },
  enteredPayment: { ar: 'الدفعة المدخلة', en: 'Entered payment', fr: 'Paiement saisi' },
  ...
  showDebtDetails: { ar: 'عرض تفاصيل الدين', en: 'Show debt details', fr: 'Afficher les détails de la dette' },
  hideDebtDetails: { ar: 'إخفاء تفاصيل الدين', en: 'Hide debt details', fr: 'Masquer les détails de la dette' },
  remainingPaymentsCount: { ar: 'عدد الأقساط المتبقية', en: 'Remaining payments', fr: 'Paiements restants' },
  expectedPayoffByCurrentPayment: { ar: 'تاريخ السداد المتوقع حسب الدفعة الحالية', en: 'Expected payoff at current payment', fr: 'Remboursement estimé au paiement actuel' },
  repaymentPlan: { ar: 'خطة السداد', en: 'Repayment plan', fr: 'Plan de remboursement' },
  paymentGroup: { ar: 'المدفوعات', en: 'Payments', fr: 'Paiements' },
  scheduleGroup: { ar: 'الجدول المتوقع', en: 'Projected schedule', fr: 'Échéancier estimé' },
  termsGroup: { ar: 'شروط الدين', en: 'Loan terms', fr: 'Conditions de dette' },
  otherActions: { ar: 'إجراءات أخرى', en: 'Other actions', fr: 'Autres actions' },
  activeDebtsTab: { ar: 'الديون النشطة', en: 'Active debts', fr: 'Dettes actives' },
  paidDebtsTab: { ar: 'الديون المسددة', en: 'Paid debts', fr: 'Dettes payées' },
  allDebtsTab: { ar: 'الكل', en: 'All', fr: 'Tout' },
  ...
  paymentInsufficient: {
    ar: 'قيمة القسط لا تغطي الفائدة الشهرية، ولن يتم سداد الدين بهذه الخطة.',
    en: 'The payment does not cover monthly interest, so this plan will not repay the debt.',
    fr: 'Le paiement ne couvre pas les intérêts mensuels, ce plan ne remboursera donc pas la dette.',
  },
  strategyBlocked: {
    ar: 'بعض الديون لا تنخفض لأن الدفعة الحالية لا تغطي الفائدة الشهرية. عدّل الدفعة قبل الاعتماد على تاريخ سداد.',
    en: 'Some debts do not amortize because the current payment does not cover monthly interest. Adjust the payment before relying on a payoff date.',
    fr: 'Certaines dettes ne s’amortissent pas car le paiement actuel ne couvre pas l’intérêt mensuel. Ajustez le paiement avant de retenir une date de remboursement.',
  },
  ...
  upcomingInstallments: { ar: 'جدول الأقساط القادمة', en: 'Upcoming installments', fr: 'Échéances à venir' },
  activeMonthlyTotal: { ar: 'إجمالي الأقساط النشطة', en: 'Active monthly total', fr: 'Total mensuel actif' },
  overdue: { ar: 'متأخر', en: 'Overdue', fr: 'En retard' },
  upcoming: { ar: 'قادم', en: 'Upcoming', fr: 'À venir' },
