...
const TEXT = {
  ar: {
    ...
    simpleList: 'الوضع البسيط: لوحة القيادة، مركز القيادة، اليوم المالي، الدخل، المصروفات، الأهداف، مركز التقارير، الإشعارات، الملف الشخصي، الإعدادات.',
  ...
  en: {
    ...
    simpleList: 'Simple mode: Dashboard, Command Center, Financial Today, Income, Expenses, Goals, Reports Center, Notifications, Profile, Settings.',
  ...
  fr: {
    ...
    simpleList: 'Mode simple : Tableau de bord, centre de commande, aujourd’hui financier, revenus, dépenses, objectifs, centre des rapports, notifications, profil, paramètres.',
