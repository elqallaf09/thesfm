      ...
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {t.categories.map((cat, i) => (
            <div key={i} className="rounded-2xl p-4 text-center" style={{border: '1px solid rgba(196,163,90,0.3)', background: 'rgba(255,253,245,0.98)', boxShadow: '0 2px 12px rgba(196,163,90,0.08)'}}>
              <h3 className="text-xl font-bold" style={{color: '#7a5c1a'}}>{cat.title}</h3>
              <p className="mt-2 text-sm" style={{color: 'rgba(122,92,26,0.6)'}}>{cat.desc}</p>
            </div>
          ))}
        </div>
