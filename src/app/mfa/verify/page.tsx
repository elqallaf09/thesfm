...
export default function MfaVerifyPage() {
  ...
  return (
    <main className="mfa-page" dir={dir}>
      ...
      <style jsx global>{`
        .mfa-page{min-height:100vh;display:grid;place-items:center;padding:20px;background:radial-gradient(circle at 18% 10%,rgba(34,211,238,.16),transparent 34%),linear-gradient(160deg,#061A2E,#071B2F);font-family:Tajawal,Arial,sans-serif}.mfa-card{width:min(480px,100%);display:grid;gap:16px;background:rgba(255,255,255,.96);border:1px solid rgba(34,211,238,.18);border-radius:28px;padding:24px;box-shadow:0 28px 90px rgba(3,18,37,.36)}.mfa-top{display:flex;justify-content:flex-end}.mfa-icon{width:58px;height:58px;display:grid;place-items:center;border-radius:20px;background:rgba(34,211,238,.12);color:#0891B2}.mfa-card h1{margin:0;color:#061A2E;font-size:28px}.mfa-card p{margin:0;color:#475569;line-height:1.75;font-weight:800}.mfa-card form{display:grid;gap:14px}.mfa-card label{display:grid;gap:8px;color:#0B2748;font-weight:950}.mfa-input-wrap{height:54px;display:flex;align-items:center;gap:10px;border:1.5px solid rgba(29,140,255,.22);border-radius:16px;padding:0 13px;background:#fff;color:#1D8CFF}.mfa-input-wrap:focus-within{border-color:#22D3EE;box-shadow:0 0 0 4px rgba(34,211,238,.16)}.mfa-card input,.mfa-card select{width:100%;border:0;outline:0;background:transparent;color:#0B172A;font:950 20px Tajawal,Arial,sans-serif;text-align:center;letter-spacing:5px}.mfa-card select{height:48px;border:1.5px solid rgba(29,140,255,.18);border-radius:14px;padding:0 12px;text-align:start;letter-spacing:0}.mfa-primary{height:52px;border:0;border-radius:16px;background:linear-gradient(135deg,#061A2E,#1D8CFF,#18D4D4);color:#fff;font:950 14px Tajawal,Arial,sans-serif;cursor:pointer}.mfa-primary:disabled{opacity:.6;cursor:not-allowed}.mfa-error{border:1px solid rgba(239,68,68,.22);background:#FEF2F2;color:#B91C1C;border-radius:14px;padding:11px 12px;font-weight:900;line-height:1.6}.mfa-link{border:0;background:transparent;color:#1D8CFF;font:900 13px Tajawal,Arial,sans-serif;cursor:pointer}.dark .mfa-card{background:#0B1F35;border-color:rgba(255,255,255,.10)}.dark .mfa-card h1,.dark .mfa-card label{color:#F8FAFC}.dark .mfa-card p{color:#CBD5E1}.dark .mfa-input-wrap,.dark .mfa-card select{background:#0F2942;border-color:rgba(255,255,255,.12);color:#38BDF8}.dark .mfa-card input,.dark .mfa-card select{color:#F8FAFC}@media(max-width:640px){.mfa-page{align-items:start;padding:14px}.mfa-card{padding:20px;border-radius:22px}.mfa-primary{width:100%}}
      `}</style>
    </main>
  );
}
