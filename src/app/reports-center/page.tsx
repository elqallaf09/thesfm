...
const pageStyles = `
  .reports-center-shell{min-height:100vh;background:#F5F1E8;color:#2B1A0F;font-family:Tajawal,Arial,sans-serif}
  .reports-center-main{margin-inline-start:0;margin-inline-end:230px;padding:22px;display:grid;gap:18px;min-width:0}
  [dir="ltr"] .reports-center-main{margin-inline-end:0;margin-inline-start:230px}
  ...
  @media(max-width:1200px){.filters-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.reports-layout{grid-template-columns:1fr}.preview-panel{position:static}.reports-grid{grid-template-columns:1fr}}
  @media(max-width:1024px){.reports-center-main{margin:0;padding:14px}.reports-hero{grid-template-columns:1fr}.reports-hero button{width:100%}}
