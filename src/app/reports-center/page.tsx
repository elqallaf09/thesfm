...
const pageStyles = `
  .reports-center-shell{min-height:100vh;background:#F5F1E8;color:#2B1A0F;font-family:Tajawal,Arial,sans-serif;overflow-x:hidden}
  ...
  .loading-state{min-height:100vh;place-items:center;color:#BA7517;font-weight:900}.spin{animation:spin 1s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}
  ...
  .reports-hero{background:linear-gradient(135deg,#1A0F05,#2B1A0F 58%,#8A5514 145%);color:#FFFDF8;border-radius:30px;padding:clamp(24px,5vw,48px);display:grid;grid-template-columns:minmax(0,1fr) auto;gap:18px;align-items:end;box-shadow:0 24px 80px rgba(43,26,15,.22)}
  .hero-badge{display:inline-flex;align-items:center;gap:8px;border:1px solid rgba(250,199,117,.22);background:rgba(250,199,117,.10);border-radius:999px;padding:8px 13px;color:#FAC775;font-size:12px;font-weight:950}
  ...
  .filters-panel,.category-section,.preview-panel,.history-panel,.ready-panel{background:#FFFDF8;border:1px solid rgba(186,117,23,.14);border-radius:22px;box-shadow:0 14px 44px rgba(43,26,15,.07);min-width:0}
