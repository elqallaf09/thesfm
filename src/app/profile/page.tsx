...
export default function ProfilePage() {
  ...
  return (
    <div className="profile-page" dir={dir}>
      ...
      <style jsx global>{`
        .profile-page{min-height:100vh;background:#F7F3EA;color:#1A0F05;display:flex;font-family:Tajawal,Arial,sans-serif}.profile-main{flex:1;width:100%;max-width:1280px;margin:0 auto;padding:24px;margin-inline-start:230px}.profile-top{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;margin-bottom:20px}.profile-top span{color:#9A6C3C;font-size:12px;font-weight:900}.profile-top h1{font-size:30px;margin:4px 0 6px;font-weight:900}.profile-top p{margin:0;color:#8A7060;font-weight:700}
        .profile-card{background:#FFFDFC;border:1px solid rgba(216,174,99,.14);border-radius:24px;box-shadow:0 4px 22px rgba(90,67,51,.06);padding:20px}.profile-layout{display:grid;grid-template-columns:360px 1fr;gap:16px;margin-bottom:16px}.hero-card{background:linear-gradient(145deg,#1A0F05,#2B1A0D);color:#FFFDFC;border:1px solid rgba(216,174,99,.2);border-radius:26px;padding:24px;box-shadow:0 18px 55px rgba(45,26,10,.16)}.avatar{width:92px;height:92px;border-radius:50%;display:grid;place-items:center;background:linear-gradient(135deg,#D8AE63,#9A6C3C);color:#111;font-size:28px;font-weight:900;border:4px solid rgba(255,255,255,.12)}.premium-pill{display:inline-flex;align-items:center;gap:7px;background:rgba(216,174,99,.12);color:#D8AE63;border:1px solid rgba(216,174,99,.22);border-radius:999px;padding:7px 12px;font-size:12px;font-weight:900}.hero-actions,.section-actions{display:flex;gap:8px;flex-wrap:wrap}.ghost-btn,.gold-btn,.danger-btn{height:42px;border-radius:14px;border:0;padding:0 15px;display:inline-flex;align-items:center;justify-content:center;gap:8px;font:900 13px Tajawal,Arial,sans-serif;cursor:pointer;text-decoration:none;transition:.2s}.gold-btn{background:linear-gradient(135deg,#D8AE63,#9A6C3C);color:#111;box-shadow:0 10px 24px rgba(216,174,99,.2)}.ghost-btn{background:#F7F3EA;color:#5B4332;border:1px solid rgba(216,174,99,.18)}.danger-btn{background:#B91C1C;color:#fff}.danger-btn:disabled{opacity:.45;cursor:not-allowed}.dark-ghost{background:rgba(255,255,255,.08);color:#FFFDFC;border:1px solid rgba(255,255,255,.14)}
        .stats-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;height:100%}.stat-card{background:#FFFDFC;border:1px solid rgba(216,174,99,.14);border-radius:20px;padding:16px;display:grid;gap:9px;min-height:150px}.stat-icon{width:40px;height:40px;border-radius:14px;background:rgba(216,174,99,.12);color:#D8AE63;display:grid;place-items:center}.stat-card span,.field label,.mini-label{font-size:12px;color:#9A6C3C;font-weight:900}.stat-card strong{font-size:22px}.section-head{display:flex;align-items:center;gap:10px;margin-bottom:16px}.section-head h2{margin:0;font-size:18px;font-weight:900}.form-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}.field{display:grid;gap:7px}.input-wrap{height:52px;border:1.5px solid rgba(216,174,99,.2);border-radius:15px;background:#F7F3EA;display:flex;align-items:center;gap:9px;padding:0 12px;color:#9A6C3C}.input-wrap input,.input-wrap select{border:0;outline:0;background:transparent;width:100%;height:100%;font:800 14px Tajawal,Arial,sans-serif;color:#111}.input-wrap input[readonly]{opacity:.65}.profile-section{margin-bottom:16px}.setting-row{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:13px 0;border-bottom:1px solid rgba(216,174,99,.1)}.setting-row:last-child{border-bottom:0}.setting-row p{margin:4px 0 0;color:#8A7060;font-size:12px;font-weight:700}.toggle{width:48px;height:28px;border-radius:999px;border:0;background:#D8C8AA;padding:3px;cursor:pointer}.toggle i{display:block;width:22px;height:22px;border-radius:50%;background:white;transition:.2s}.toggle.on{background:#D8AE63}.toggle.on i{transform:translateX(-20px)}[dir="ltr"] .toggle.on i{transform:translateX(20px)}
        .pref-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}.segmented{display:flex;background:#F7F3EA;border:1px solid rgba(216,174,99,.14);border-radius:14px;padding:4px;gap:4px}.segmented button{flex:1;border:0;border-radius:11px;background:transparent;height:38px;font:900 12px Tajawal,Arial,sans-serif;color:#8A7060;cursor:pointer}.segmented button.active{background:#FFFDFC;color:#111;box-shadow:0 3px 12px rgba(90,67,51,.08)}.premium-grid,.activity-list{display:grid;gap:10px}.premium-grid{grid-template-columns:repeat(4,1fr)}.feature-card{background:#F7F3EA;border:1px solid rgba(216,174,99,.12);border-radius:16px;padding:14px;font-weight:900;color:#5B4332;display:flex;align-items:center;gap:9px}.plan-card{background:linear-gradient(135deg,#111,#2B1A0D);color:#FFFDFC;border-radius:20px;padding:18px;display:grid;gap:8px}.activity-item{display:flex;align-items:center;gap:12px;background:#F7F3EA;border:1px solid rgba(216,174,99,.1);border-radius:15px;padding:12px}.activity-item svg{color:#D8AE63}.danger-zone{border-color:rgba(185,28,28,.18);background:linear-gradient(135deg,#FFFDFC,#FFF7F4)}.profile-toast{position:fixed;z-index:100;inset-inline-end:22px;bottom:22px;background:#111;color:#D8AE63;border:1px solid rgba(216,174,99,.28);border-radius:16px;padding:13px 16px;font-weight:900;box-shadow:0 18px 45px rgba(45,26,10,.2)}
        .modal-overlay{position:fixed;inset:0;z-index:90;background:rgba(17,17,17,.45);backdrop-filter:blur(8px);display:grid;place-items:center;padding:18px}.modal-card{width:min(520px,100%);background:#FFFDFC;border:1px solid rgba(216,174,99,.18);border-radius:24px;padding:22px;box-shadow:0 24px 80px rgba(45,26,10,.28)}.modal-head{display:flex;justify-content:space-between;align-items:center;margin-bottom:14px}.modal-head h3{margin:0;font-size:19px}.modal-fields{display:grid;gap:12px}.info-box{display:flex;gap:10px;align-items:flex-start;background:#F7F3EA;border:1px solid rgba(216,174,99,.12);border-radius:16px;padding:14px;color:#5B4332;line-height:1.7;font-weight:800}.info-box.danger{background:#FEF2F2;border-color:#FCA5A5;color:#991B1B}.profile-loading{min-height:100vh;display:grid;place-items:center;background:#F7F3EA;color:#9A6C3C;font-size:34px}
  ...
  return (
    <aside className="hero-card">
      ...
      <div style={{ height: 9, background: 'rgba(255,255,255,.12)', borderRadius: 99, overflow: 'hidden', marginBottom: 16 }}>
        <div style={{ width: `${completion}%`, height: '100%', background: 'linear-gradient(90deg,#D8AE63,#9A6C3C)', borderRadius: 99 }} />
      </div>
...
function MiniInfo({ label, value }: { label: string; value: string }) {
  return <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, fontSize: 13 }}><span style={{ color: '#D8AE63', fontWeight: 900 }}>{label}</span><strong>{value}</strong></div>;
}
...
function AccountActivity({ labels, items }: { labels: Record<string, string>; items: string[] }) {
  return (
    <Section title={labels.title} icon={<Activity size={19} />}>
      <div className="activity-list">{items.length === 0 ? <p>{labels.noActivity}</p> : items.map((item, index) => <div className="activity-item" key={item}><Activity size={16} /><div><strong>{item}</strong><p style={{ margin: '3px 0 0', color: '#9A6C3C', fontSize: 12 }}>{labels.today} · {10 + index}:00</p></div></div>)}</div>
    </Section>
  );
}

function DangerZone({ labels, onExport, onDelete }: { labels: Record<string, string>; onExport: () => void; onDelete: () => void }) {
  return <Section title={labels.title} icon={<AlertTriangle size={19} />} className="danger-zone"><div className="section-actions"><button className="ghost-btn" onClick={onExport}><Download size={16} />{labels.exportData}</button><button className="danger-btn" onClick={onDelete}><Trash2 size={16} />{labels.deleteAccount}</button></div><p style={{ margin: '12px 0 0', color: '#991B1B', fontWeight: 800 }}>{labels.deleteHint}</p></Section>;
}
