  ...
  return (
    <div className="profile-page" dir={dir}>
      ...
      <style jsx global>{`
        ...
        .profile-top-brand { display: flex; align-items: center; gap: 12px; min-width: 0; }
        .profile-top span {
        ...
        .hero-card-top { display: flex; justify-content: space-between; align-items: flex-start; gap: 14px; }
        .hero-card-title { margin: 18px 0 4px; font-size: 24px; font-weight: 600; line-height: 1.35; }
        .hero-card-username { margin: 0; color: var(--hero-foreground-muted); direction: ltr; }
        .hero-meta-list { margin: 16px 0; display: grid; gap: 9px; }
        .meta-line { display: flex; justify-content: space-between; gap: 12px; font-size: 13px; }
        .meta-line span { color: var(--hero-foreground-muted); font-weight: 500; }
        .meta-line strong { color: var(--hero-foreground); font-weight: 600; }
        .profile-progress {
          height: 9px;
          margin-bottom: 16px;
          overflow: hidden;
        ...
        .profile-progress-fill { height: 100%; background: var(--accent); border-radius: var(--radius-pill); }
        .avatar {
          width: 92px;
          height: 92px;
          border-radius: var(--radius-pill);
          ...
          font-size: 28px;
          font-weight: 700;
          border: 4px solid color-mix(in srgb, var(--hero-foreground) 22%, transparent);
          overflow: hidden;
        ...
        .premium-pill {
          ...
          align-items: center;
          gap: 7px;
          background: color-mix(in srgb, var(--hero-foreground) 14%, transparent);
          color: var(--hero-foreground);
          border: 1px solid color-mix(in srgb, var(--hero-foreground) 24%, transparent);
          border-radius: var(--radius-pill);
          padding: 7px 12px;
        ...
        .hero-actions, .section-actions { display: flex; gap: 8px; flex-wrap: wrap; }
        .ghost-btn, .gold-btn, .danger-btn {
        ...
        .gold-btn { background: var(--primary); color: var(--primary-foreground); }
        .gold-btn:hover { background: var(--primary-hover); }
        .ghost-btn { background: var(--control-background); color: var(--foreground-secondary); border-color: var(--border); }
        .ghost-btn:hover { background: var(--control-hover); color: var(--foreground); border-color: var(--border-strong); }
        .danger-btn { background: var(--danger); color: var(--danger-foreground); }
        .danger-btn:hover { background: color-mix(in srgb, var(--danger) 88%, var(--foreground)); }
        .ghost-btn:focus-visible, .gold-btn:focus-visible, .danger-btn:focus-visible,
        .toggle:focus-visible, .segmented button:focus-visible, .profile-combobox-menu button:focus-visible {
          outline: 2px solid var(--focus-ring);
          outline-offset: 2px;
          box-shadow: var(--focus-shadow);
        }
        .danger-btn:disabled, .gold-btn:disabled, .ghost-btn:disabled {
          opacity: .55;
          cursor: not-allowed;
          filter: saturate(.75);
        }
        .dark-ghost {
          ...
          color: var(--hero-foreground);
          border-color: color-mix(in srgb, var(--hero-foreground) 24%, transparent);
        }
        .dark-ghost:hover {
        ...
        .stats-grid { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 12px; height: 100%; }
        .stat-card {
          background: var(--surface);
          border: 1px solid var(--border);
        ...
        .stat-card span, .field > span, .field > label, .mini-label {
          font-size: var(--type-label-size);
          line-height: var(--type-label-leading);
          color: var(--foreground-muted);
          font-weight: var(--type-label-weight);
        }
        .stat-card strong { color: var(--foreground); font-size: 22px; font-weight: 600; }
        .section-head { display: flex; align-items: center; gap: 10px; margin-bottom: 16px; color: var(--primary); }
        .section-head h2 {
          margin: 0;
          color: var(--foreground);
        ...
        .input-wrap:hover { background: var(--control-hover); }
        .input-wrap:focus-within, .profile-combobox.open {
        ...
        .input-wrap input::placeholder { color: var(--control-placeholder); opacity: 1; }
        .input-wrap input[readonly] { color: var(--foreground-muted); }
        .profile-combobox { position: relative; }
        .profile-combobox input { cursor: pointer; }
        .profile-combobox-chevron { flex: 0 0 auto; color: var(--foreground-muted); transition: transform var(--duration-fast) var(--ease), color var(--duration-fast) var(--ease); }
        .profile-combobox-chevron.open { transform: rotate(180deg); color: var(--primary); }
        .profile-combobox-menu {
          position: absolute;
          z-index: 70;
          inset-inline: 0;
          top: calc(100% + 8px);
        ...
        .profile-combobox-menu button:hover, .profile-combobox-menu button.active { background: var(--surface-hover); }
        .profile-combobox-menu button.selected { background: var(--primary-soft); color: var(--primary-active); font-weight: 600; }
        .profile-combobox-menu button svg { color: var(--accent); flex: 0 0 auto; }
        .field-icon-btn {
          border: 0;
          background: transparent;
          color: var(--foreground-muted);
        ...
        .field-icon-btn:hover { color: var(--primary); background: var(--primary-soft); }
        .field-icon-btn:focus-visible { color: var(--primary); outline: 2px solid var(--focus-ring); outline-offset: 2px; }
        ...
        .setting-row-main { display: flex; gap: 10px; align-items: center; min-width: 0; }
        .setting-row strong { color: var(--foreground); font-weight: 600; }
        .setting-row p {
          margin: 4px 0 0;
          color: var(--foreground-muted);
          font-size: var(--type-body-small-size);
        ...
        [dir="ltr"] .toggle.on i { transform: translateX(20px); }
        .pref-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 12px; }
        .preference-control-label { margin-bottom: 7px; }
        .preference-toggles { margin-top: 12px; }
        .segmented {
          display: flex;
        ...
        .segmented button:hover { background: var(--surface-hover); color: var(--foreground); }
        .segmented button.active { background: var(--surface); color: var(--primary-active); border-color: var(--border); box-shadow: var(--shadow-xs); font-weight: 600; }
        .premium-layout { grid-template-columns: 280px minmax(0, 1fr); }
        .premium-grid, .activity-list { display: grid; gap: 10px; }
        ...
        .feature-card svg { color: var(--accent); flex: 0 0 auto; }
        .plan-card {
          background: var(--surface-muted);
          color: var(--foreground-secondary);
          border: 1px solid var(--border);
        ...
        .plan-card h3 { margin: 0; color: var(--foreground); font-size: var(--type-card-title-size); font-weight: 600; }
        .plan-card p { margin: 0; color: var(--foreground-muted); }
        ...
        .activity-item > svg { color: var(--primary); flex: 0 0 auto; }
        .activity-item strong { color: var(--foreground); font-weight: 600; }
        .activity-meta { margin: 3px 0 0; color: var(--foreground-muted); font-size: var(--type-caption-size); }
        .activity-empty { display: grid; gap: 8px; color: var(--foreground-muted); font-weight: 400; }
        .activity-empty strong { color: var(--foreground); font-weight: 600; }
        .activity-empty p { margin: 0; color: var(--foreground-muted); font-size: var(--type-body-small-size); line-height: var(--type-body-small-leading); }
        .activity-empty .ghost-btn { width: max-content; }
        .activity-skeleton span, .activity-skeleton strong, .activity-skeleton p {
          display: block;
          border-radius: var(--radius-pill);
          background: var(--skeleton-base);
          animation: profileSkeleton 1.2s ease-in-out infinite alternate;
        }
        .activity-skeleton span { width: 32px; height: 32px; }
        .activity-skeleton strong { width: 160px; height: 14px; }
        .activity-skeleton p { width: 110px; height: 11px; margin-top: 8px !important; }
        @keyframes profileSkeleton { to { opacity: .46; } }
        .danger-zone { border-color: color-mix(in srgb, var(--danger) 34%, var(--border)); background: var(--danger-soft); }
        .danger-zone .section-head { color: var(--danger); }
        .danger-copy { margin: 12px 0 0; color: var(--danger); font-weight: 600; }
        .profile-toast {
          position: fixed;
          z-index: 50;
          ...
          line-height: 1.55;
          box-shadow: var(--shadow-popover);
          animation: toastSlideUp var(--duration) var(--ease);
        }
        .profile-toast p { margin: 0; min-width: 0; overflow-wrap: anywhere; }
        .profile-toast-icon {
          width: 30px;
          height: 30px;
          border-radius: var(--radius-pill);
        ...
        .profile-toast button:hover { background: var(--surface-hover); color: var(--foreground); }
        .profile-toast button:focus-visible { outline: 2px solid var(--focus-ring); outline-offset: 2px; }
        @keyframes toastSlideUp { from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); } }
        .modal-overlay {
          position: fixed;
          inset: 0;
          z-index: 90;
        ...
        .modal-head h3 { margin: 0; color: var(--foreground); font-size: var(--type-card-title-size); font-weight: 600; }
        ...
        .info-box > svg { color: var(--info); flex: 0 0 auto; }
        .info-box p { margin: 0; }
        .info-box.danger { background: var(--danger-soft); border-color: color-mix(in srgb, var(--danger) 32%, var(--border)); color: var(--danger); }
        .two-factor-panel { display: grid; gap: 14px; border: 1px solid var(--border); background: var(--surface-muted); border-radius: var(--radius-card); padding: 14px; }
        .two-factor-row { display: grid; grid-template-columns: auto minmax(0, 1fr); gap: 12px; align-items: start; }
        .two-factor-row strong { display: block; color: var(--foreground); font-size: var(--type-body-size); font-weight: 600; }
        .two-factor-row p, .two-factor-copy { margin: 4px 0 0; color: var(--foreground-muted); font-size: var(--type-body-small-size); font-weight: 400; line-height: 1.7; }
        .status-pill {
          display: inline-flex;
          width: max-content;
          margin-top: 9px;
        ...
        .status-pill.on { background: var(--success-soft); border-color: color-mix(in srgb, var(--success) 30%, var(--border)); color: var(--success); }
        .message-inline {
        ...
        .message-inline.danger { background: var(--danger-soft); border-color: color-mix(in srgb, var(--danger) 32%, var(--border)); color: var(--danger); }
        .profile-loading { min-height: 100vh; display: grid; place-items: center; background: var(--background); color: var(--foreground-muted); font-size: 34px; font-family: var(--font-ui); }
        ...
        .email-verification-card strong { display: flex; align-items: center; gap: 7px; color: var(--foreground); font-size: var(--type-body-size); font-weight: 600; line-height: 1.4; }
        .email-verification-card p { margin: 4px 0 0; color: var(--foreground-muted); font-size: var(--type-body-small-size); font-weight: 400; line-height: 1.6; }
        .email-verification-card.verified { background: var(--success-soft); border-color: color-mix(in srgb, var(--success) 30%, var(--border)); }
        .email-verification-card.verified strong { color: var(--success); }
        .email-verification-card.unverified { background: var(--warning-soft); border-color: color-mix(in srgb, var(--warning) 32%, var(--border)); }
        .email-verification-card.unverified strong { color: var(--warning); }
        .email-verification-card .ghost-btn { height: var(--control-h); white-space: nowrap; }
        @media (max-width: 1180px) {
          .profile-main { margin-inline-start: 0; }
          .profile-layout, .premium-layout { grid-template-columns: minmax(0, 1fr); }
          .stats-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
        }
        @media (max-width: 720px) {
          .profile-main { padding: 14px; }
          .profile-top { display: grid; }
          .stats-grid, .form-grid, .pref-grid, .premium-grid { grid-template-columns: minmax(0, 1fr); }
          .hero-actions .ghost-btn, .hero-actions .gold-btn, .section-actions .ghost-btn, .section-actions .gold-btn, .section-actions .danger-btn, .modal-fields .gold-btn { width: 100%; }
          .setting-row { align-items: flex-start; flex-direction: column; }
          .modal-overlay { place-items: end center; padding: 10px; }
          .modal-card { width: 100%; border-radius: var(--radius-panel) var(--radius-panel) 0 0; max-height: calc(100dvh - 20px); }
          .email-verification-card { grid-template-columns: minmax(0, 1fr); }
          .email-verification-card .ghost-btn { width: 100%; }
          .profile-toast { inset-inline: 16px; bottom: 16px; width: auto; max-width: none; }
        }
        @media (prefers-reduced-motion: reduce) {
          .profile-page *, .profile-page *::before, .profile-page *::after { scroll-behavior: auto !important; transition-duration: .01ms !important; animation-duration: .01ms !important; animation-iteration-count: 1 !important; }
        }
      `}</style>
    </div>
  );
...
function ProfileHeroCard({
  ...
  return (
    <aside className="hero-card">
      ...
      <p className="hero-card-username">@{username || 'sfm-user'}</p>
...
function PersonalInfoForm({ lang, profile, setProfile, preferences, setPreferences, saving, labels, onSave }: { lang: Lang; profile: ProfileState; setProfile: (next: ProfileState) => void; preferences: PreferencesState; setPreferences: (next: PreferencesState) => void; saving: boolean; labels: Record<string, string>; onSave: () => void }) {
  ...
  return (
    <Section title={labels.title} icon={<User size={19} />}>
      ...
      <div className="form-actions"><button className="gold-btn" onClick={onSave} disabled={saving}><Save size={16} />{saving ? '...' : labels.save}</button></div>
    </Section>
  );
}
  ...
  return (
    <Section id="preferences" title={labels.title} icon={<Palette size={19} />}>
      <div className="pref-grid">
        <div>
          <div className="mini-label preference-control-label">{labels.language}</div>
        ...
        <div><div className="mini-label preference-control-label">{labels.currency}</div><CurrencySelect value={preferences.currency} onChange={value => set({ currency: value })} lang={lang} ariaLabel={labels.currency} /></div>
...
function PremiumFeatures({ labels, onManage }: { labels: Record<string, string>; onManage: () => void }) {
  ...
  return (
    <Section title={labels.title} icon={<Crown size={19} />}>
      <div className="profile-layout premium-layout">
...
function DangerZone({ labels, onExport, onDelete }: { labels: Record<string, string>; onExport: () => void; onDelete: () => void }) {
  return <Section title={labels.title} icon={<AlertTriangle size={19} />} className="danger-zone"><div className="section-actions"><button className="ghost-btn" onClick={onExport}><Download size={16} />{labels.exportData}</button><button className="danger-btn" onClick={onDelete}><Trash2 size={16} />{labels.deleteAccount}</button></div><p className="danger-copy">{labels.deleteHint}</p></Section>;
}
...
function SettingRow({ icon, title, subtitle, action, onClick }: { icon: ReactNode; title: string; subtitle?: string; action: string; onClick: () => void }) {
  return <div className="setting-row"><div className="setting-row-main"><span className="stat-icon">{icon}</span><div><strong>{title}</strong>{subtitle && <p>{subtitle}</p>}</div></div><button className="ghost-btn" onClick={onClick}>{action}</button></div>;
}

function ToggleRow({ label, checked, onChange }: { label: string; checked: boolean; onChange: (checked: boolean) => void }) {
  return <div className="setting-row"><strong>{label}</strong><button type="button" role="switch" aria-checked={checked} className={`toggle ${checked ? 'on' : ''}`} onClick={() => onChange(!checked)}><i /></button></div>;
}

function Choice({ label, value, options, onChange }: { label: string; value: string; options: string[][]; onChange: (value: string) => void }) {
  return <div><div className="mini-label preference-control-label">{label}</div><div className="segmented">{options.map(([id, name]) => <button type="button" key={id} className={value === id ? 'active' : ''} aria-pressed={value === id} onClick={() => onChange(id)}>{name}</button>)}</div></div>;
}
...
function InfoBox({ icon, text, danger }: { icon: ReactNode; text: string; danger?: boolean }) {
  return <div className={`info-box ${danger ? 'danger' : ''}`}>{icon}<p>{text}</p></div>;
}
