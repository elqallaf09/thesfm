  ...
  return (
    <main className="login-shell" dir={dir}>
      ...
      <style jsx>{`
        ...
        .brand{text-align:center;margin-bottom:22px}.mark{width:72px;height:72px;margin:0 auto 12px;border-radius:18px;box-shadow:0 4px 18px rgba(0,0,0,.18)}.brand h1{font-size:26px;margin:0 0 8px;color:#111}.brand p{font-size:13px;color:#9A6C3C;line-height:1.7;margin:0}
