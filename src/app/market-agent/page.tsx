...
const COPY = {
  ar: {
    title: 'ÙˆÙƒÙŠÙ„ ØªØ­Ù„ÙŠÙ„ Ø§Ù„Ø£Ø³ÙˆØ§Ù‚',
    subtitle: 'Ù…Ø³Ø§Ø­Ø© ØªØ­Ù„ÙŠÙ„ Ø¢Ù„ÙŠØ© ØªÙ‚Ø±Ø£ Ø§Ù„Ø£Ø³Ù‡Ù… ÙˆØ§Ù„ÙÙˆØ±ÙƒØ³ ÙˆØ§Ù„Ù…Ø¤Ø´Ø±Ø§Øª ÙˆØ§Ù„Ù…Ø¹Ø§Ø¯Ù† ÙˆØ§Ù„Ø¹Ù…Ù„Ø§Øª Ø§Ù„Ø±Ù‚Ù…ÙŠØ© Ø¨Ø§Ø³ØªØ®Ø¯Ø§Ù… Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø³ÙˆÙ‚ Ø§Ù„Ù…ØªØ§Ø­Ø©.',
    badge: 'THE SFM AI',
    provider: 'Ù…Ø²ÙˆØ¯ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª',
    sourceReady: 'Ø¹Ù†Ø¯ ØªÙˆÙØ± Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª',
    legalTitle: 'ØªÙ†Ø¨ÙŠÙ‡ Ù…Ù‡Ù…',
    legal:
      'Ù‡Ø°Ø§ Ø§Ù„ØªØ­Ù„ÙŠÙ„ Ø¹Ø¨Ø§Ø±Ø© Ø¹Ù† Ù‚Ø±Ø§Ø¡Ø© Ø¢Ù„ÙŠØ© Ù„Ù„Ø³ÙˆÙ‚ Ù„Ø£ØºØ±Ø§Ø¶ ØªØ¹Ù„ÙŠÙ…ÙŠØ© ÙˆÙ…Ø¹Ù„ÙˆÙ…Ø§ØªÙŠØ© ÙÙ‚Ø·ØŒ ÙˆÙ„Ø§ ÙŠØ¹Ø¯ Ù†ØµÙŠØ­Ø© Ù…Ø§Ù„ÙŠØ© Ø£Ùˆ ØªÙˆØµÙŠØ© Ø¨Ø´Ø±Ø§Ø¡ Ø£Ùˆ Ø¨ÙŠØ¹ Ø£ÙŠ Ø£ØµÙ„. ØªÙ‚Ø¹ Ù‚Ø±Ø§Ø±Ø§Øª Ø§Ù„Ø§Ø³ØªØ«Ù…Ø§Ø± ÙˆØ§Ù„ØªØ¯Ø§ÙˆÙ„ Ø¹Ù„Ù‰ Ù…Ø³Ø¤ÙˆÙ„ÙŠØ© Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù….',
    symbol: 'Ø±Ù…Ø² Ø§Ù„Ø£ØµÙ„',
    symbolPlaceholder: 'Ù…Ø«Ø§Ù„: AAPL Ø£Ùˆ GOOGL Ø£Ùˆ EUR/USD',
    symbolHelp: 'Ø§ÙƒØªØ¨ Ø±Ù…Ø²Ø§Ù‹ Ù…Ø«Ù„ AAPL, NVDA, EUR/USD, XAU/USD.',
    assetType: 'Ù†ÙˆØ¹ Ø§Ù„Ø£ØµÙ„',
    timeframe: 'Ø§Ù„Ø¥Ø·Ø§Ø± Ø§Ù„Ø²Ù…Ù†ÙŠ',
    analyze: 'ØªØ­Ù„ÙŠÙ„ Ø§Ù„Ø£ØµÙ„',
    analyzing: 'Ø¬Ø§Ø±ÙŠ Ø§Ù„ØªØ­Ù„ÙŠÙ„...',
    focusSearch: 'Ø§Ù„Ø¨Ø­Ø« Ø¹Ù† Ø£ØµÙ„',
    loadingTitle: 'Ø¬Ø§Ø±ÙŠ ØªØ¬Ù‡ÙŠØ² Ø§Ù„Ù‚Ø±Ø§Ø¡Ø©',
    loadingBody: 'Ù†Ø±Ø§Ø¬Ø¹ Ø§Ù„Ø£Ø³Ø¹Ø§Ø± ÙˆØ§Ù„Ù…Ø¤Ø´Ø±Ø§Øª Ø§Ù„ÙÙ†ÙŠØ© Ø§Ù„Ù…ØªØ§Ø­Ø© Ù„Ù‡Ø°Ø§ Ø§Ù„Ø£ØµÙ„.',
    emptyTitle: 'Ø§Ø¨Ø¯Ø£ Ø¨Ø¥Ø¯Ø®Ø§Ù„ Ø±Ù…Ø² Ø£ØµÙ„',
    emptyBody: 'Ø§Ø®ØªØ± Ø£ØµÙ„Ø§Ù‹ Ù…Ø§Ù„ÙŠØ§Ù‹ ÙˆØ¥Ø·Ø§Ø±Ø§Ù‹ Ø²Ù…Ù†ÙŠØ§Ù‹ Ù„Ø¨Ø¯Ø¡ Ø§Ù„ØªØ­Ù„ÙŠÙ„.',
    examples: 'Ø£Ù…Ø«Ù„Ø© Ø³Ø±ÙŠØ¹Ø©',
    errorTitle: 'ØªØ¹Ø°Ø± Ø¥ØµØ¯Ø§Ø± Ù‚Ø±Ø§Ø¡Ø© Ù…ÙˆØ«ÙˆÙ‚Ø©',
    recentTitle: 'Ø¢Ø®Ø± Ø§Ù„ØªØ­Ù„ÙŠÙ„Ø§Øª',
    recentSubtitle: 'Ø³Ø¬Ù„ Ø§Ù„Ù‚Ø±Ø§Ø¡Ø§Øª Ø§Ù„Ù…Ø­ÙÙˆØ¸Ø© Ù…Ù† Ø§Ù„Ø­Ø³Ø§Ø¨ Ø¹Ù†Ø¯ ØªÙˆÙØ±Ù‡Ø§.',
    noHistory: 'Ù„Ø§ ØªÙˆØ¬Ø¯ ØªØ­Ù„ÙŠÙ„Ø§Øª Ù…Ø­ÙÙˆØ¸Ø© Ø¨Ø¹Ø¯.',
    currentPrice: 'Ø§Ù„Ø³Ø¹Ø± Ø§Ù„Ø­Ø§Ù„ÙŠ',
    direction: 'Ø§ØªØ¬Ø§Ù‡ Ø§Ù„Ø³ÙˆÙ‚',
    action: 'Ø§Ù„Ø¥Ø¬Ø±Ø§Ø¡ Ø§Ù„Ù…Ù‚ØªØ±Ø­',
    confidence: 'Ø§Ù„Ø«Ù‚Ø©',
    risk: 'Ø§Ù„Ù…Ø®Ø§Ø·Ø±Ø©',
    entryZone: 'Ù…Ù†Ø·Ù‚Ø© Ø§Ù„Ø¯Ø®ÙˆÙ„',
    stopLoss: 'ÙˆÙ‚Ù Ø§Ù„Ø®Ø³Ø§Ø±Ø©',
    takeProfit: 'Ø£Ù‡Ø¯Ø§Ù Ø§Ù„Ø±Ø¨Ø­',
    support: 'Ø§Ù„Ø¯Ø¹Ù…',
    resistance: 'Ø§Ù„Ù…Ù‚Ø§ÙˆÙ…Ø©',
    trends: 'Ø§Ù„Ø§ØªØ¬Ø§Ù‡Ø§Øª',
    indicators: 'Ø§Ù„Ù…Ø¤Ø´Ø±Ø§Øª Ø§Ù„ÙÙ†ÙŠØ©',
    explanation: 'Ø´Ø±Ø­ Ø§Ù„Ù‚Ø±Ø§Ø¡Ø©',
    shortTerm: 'Ù‚ØµÙŠØ±',
    mediumTerm: 'Ù…ØªÙˆØ³Ø·',
    longTerm: 'Ø·ÙˆÙŠÙ„',
    noValue: 'ØºÙŠØ± Ù…ØªØ§Ø­',
    stocks: 'Ø£Ø³Ù‡Ù…',
    forex: 'ÙÙˆØ±ÙƒØ³',
    indices: 'Ù…Ø¤Ø´Ø±Ø§Øª',
    metals: 'Ù…Ø¹Ø§Ø¯Ù†',
    ...
    market: 'Ø§Ù„Ø³ÙˆÙ‚',
    date: 'Ø§Ù„ØªØ§Ø±ÙŠØ®',
    actionColumn: 'Ø¥Ø¬Ø±Ø§Ø¡',
    reuse: 'Ø¥Ø¹Ø§Ø¯Ø© Ø§Ù„ØªØ­Ù„ÙŠÙ„',
    workspaceTitle: 'Ù…Ø³Ø§Ø­Ø© Ø§Ù„Ù‚Ø±Ø§Ø¡Ø© Ø§Ù„Ø­Ø§Ù„ÙŠØ©',
    snapshotTitle: 'Ù„Ù‚Ø·Ø© Ø§Ù„Ø³ÙˆÙ‚',
    chartTitle: 'Ù…Ø®Ø·Ø· Ù…Ø³ØªÙˆÙŠØ§Øª Ø§Ù„Ø³Ø¹Ø±',
    chartUnavailable: 'Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ø±Ø³Ù… Ø§Ù„Ø¨ÙŠØ§Ù†ÙŠ Ø§Ù„ØªØ§Ø±ÙŠØ®ÙŠØ© ØºÙŠØ± Ù…ØªØ§Ø­Ø© ÙÙŠ Ø§Ù„Ø§Ø³ØªØ¬Ø§Ø¨Ø© Ø§Ù„Ø­Ø§Ù„ÙŠØ©. ÙŠØªÙ… Ø¹Ø±Ø¶ Ù…Ø³ØªÙˆÙŠØ§Øª Ø§Ù„Ø³ÙˆÙ‚ Ø§Ù„Ù…Ø­Ø³ÙˆØ¨Ø© ÙÙ‚Ø·.',
    dataStatusTitle: 'Ø­Ø§Ù„Ø© Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª',
    connected: 'Ù…ØªØµÙ„Ø©',
    available: 'Ù…ØªØ§Ø­Ø©',
    lastUpdate: 'Ø¢Ø®Ø± ØªØ­Ø¯ÙŠØ«',
    marketLevels: 'Ù…Ø³ØªÙˆÙŠØ§Øª Ø§Ù„Ø³ÙˆÙ‚',
    confidenceBasis: 'ÙƒÙŠÙ ØªÙ… Ø§Ø­ØªØ³Ø§Ø¨ Ø§Ù„Ø«Ù‚Ø©ØŸ',
    evidenceTitle: 'Ø§Ù„Ø£Ø¯Ù„Ø© Ø§Ù„ÙÙ†ÙŠØ©',
    positiveFactors: 'Ø§Ù„Ø¹ÙˆØ§Ù…Ù„ Ø§Ù„Ø¯Ø§Ø¹Ù…Ø©',
    cautionFactors: 'Ø¹ÙˆØ§Ù…Ù„ Ø§Ù„Ø­Ø°Ø±',
    readingSummary: 'Ù…Ù„Ø®Øµ Ø§Ù„Ù‚Ø±Ø§Ø¡Ø©',
    bullishScenario: 'Ø§Ù„Ø³ÙŠÙ†Ø§Ø±ÙŠÙˆ Ø§Ù„ØµØ§Ø¹Ø¯',
    bearishScenario: 'Ø§Ù„Ø³ÙŠÙ†Ø§Ø±ÙŠÙˆ Ø§Ù„Ù‡Ø§Ø¨Ø·',
    whatChanges: 'Ù…Ø§ Ø§Ù„Ø°ÙŠ Ù‚Ø¯ ÙŠØºÙŠØ± Ø§Ù„Ù‚Ø±Ø§Ø¡Ø©ØŸ',
    currentReading: 'Ø§Ù„Ù‚Ø±Ø§Ø¡Ø© Ø§Ù„Ø­Ø§Ù„ÙŠØ©',
    potentialEntry: 'Ù†Ø·Ø§Ù‚ Ø¯Ø®ÙˆÙ„ Ù…Ø­ØªÙ…Ù„',
    invalidation: 'Ø¥Ø¨Ø·Ø§Ù„ Ø§Ù„Ù‚Ø±Ø§Ø¡Ø©',
    volume: 'Ø­Ø¬Ù… Ø§Ù„ØªØ¯Ø§ÙˆÙ„',
    pivot: 'Ø§Ù„Ù†Ù‚Ø·Ø© Ø§Ù„Ù…Ø­ÙˆØ±ÙŠØ©',
    refreshAnalysis: 'ØªØ­Ø¯ÙŠØ« Ø§Ù„ØªØ­Ù„ÙŠÙ„',
    searchHistory: 'Ø§Ø¨Ø­Ø« ÙÙŠ Ø¢Ø®Ø± Ø§Ù„ØªØ­Ù„ÙŠÙ„Ø§Øª',
    shownHistory: 'Ø§Ù„Ù…Ø¹Ø±ÙˆØ¶',
    noChartData: 'Ù„Ø§ ØªÙˆØ¬Ø¯ Ø³Ù„Ø³Ù„Ø© Ø£Ø³Ø¹Ø§Ø± ÙƒØ§ÙÙŠØ© Ù„Ø±Ø³Ù… Ø´Ù…ÙˆØ¹ Ø­Ù‚ÙŠÙ‚ÙŠØ© Ù„Ù‡Ø°Ø§ Ø§Ù„Ø£ØµÙ„ Ø­Ø§Ù„ÙŠØ§Ù‹.',
    unavailable: 'Ù„Ø§ ØªÙˆØ¬Ø¯ Ø¨ÙŠØ§Ù†Ø§Øª ÙƒØ§ÙÙŠØ© Ù„Ø¥ØµØ¯Ø§Ø± Ù‚Ø±Ø§Ø¡Ø© Ù…ÙˆØ«ÙˆÙ‚Ø© Ù„Ù‡Ø°Ø§ Ø§Ù„Ø£ØµÙ„ Ø­Ø§Ù„ÙŠØ§Ù‹.',
  },
  en: {
  ...
  fr: {
    title: 'Agent dâ€™analyse des marchÃ©s',
    subtitle: 'Un espace de recherche automatisÃ© pour actions, forex, indices, mÃ©taux et cryptos avec les donnÃ©es disponibles.',
    badge: 'THE SFM AI',
    provider: 'Fournisseur',
    sourceReady: 'lorsque les donnÃ©es sont disponibles',
    legalTitle: 'Avis important',
    legal:
      'Cette analyse est une lecture automatisÃ©e du marchÃ© Ã  des fins Ã©ducatives et informatives uniquement. Elle ne constitue pas un conseil financier ni une recommandation dâ€™achat ou de vente. Les dÃ©cisions de trading et dâ€™investissement relÃ¨vent de votre responsabilitÃ©.',
    symbol: 'Symbole',
    symbolPlaceholder: 'Exemple : AAPL, GOOGL ou EUR/USD',
    symbolHelp: 'Saisissez un symbole comme AAPL, NVDA, EUR/USD, XAU/USD.',
    assetType: 'Type dâ€™actif',
    timeframe: 'Horizon',
    analyze: 'Analyser lâ€™actif',
    analyzing: 'Analyse en cours...',
    focusSearch: 'Rechercher un actif',
    loadingTitle: 'PrÃ©paration de la lecture',
    loadingBody: 'VÃ©rification des prix et indicateurs techniques disponibles.',
    emptyTitle: 'Commencez par saisir un symbole',
    emptyBody: 'Choisissez un actif financier et un horizon pour lancer lâ€™analyse.',
    examples: 'Exemples rapides',
    errorTitle: 'Lecture fiable indisponible',
    recentTitle: 'Analyses rÃ©centes',
    recentSubtitle: 'Lectures enregistrÃ©es depuis votre compte lorsque disponibles.',
    noHistory: 'Aucune analyse enregistrÃ©e.',
    currentPrice: 'Prix actuel',
    direction: 'Direction du marchÃ©',
    action: 'Action suggÃ©rÃ©e',
    confidence: 'Confiance',
    risk: 'Niveau de risque',
    entryZone: 'Zone dâ€™entrÃ©e',
    stopLoss: 'Stop loss',
    takeProfit: 'Objectifs',
    support: 'Supports',
    resistance: 'RÃ©sistances',
    trends: 'Tendances',
    ...
    date: 'Date',
    actionColumn: 'Action',
    reuse: 'Analyser Ã  nouveau',
    workspaceTitle: 'Espace de lecture actuel',
    snapshotTitle: 'InstantanÃ© du marchÃ©',
    chartTitle: 'Graphique des niveaux',
    chartUnavailable: 'Les donnÃ©es historiques du graphique ne sont pas incluses dans la rÃ©ponse actuelle. Les niveaux calculÃ©s sont affichÃ©s.',
    dataStatusTitle: 'Ã‰tat des donnÃ©es',
    connected: 'ConnectÃ©',
    available: 'Disponible',
    lastUpdate: 'DerniÃ¨re mise Ã  jour',
    marketLevels: 'Niveaux du marchÃ©',
    confidenceBasis: 'Comment la confiance est calculÃ©e',
    evidenceTitle: 'Ã‰lÃ©ments techniques',
    positiveFactors: 'Facteurs favorables',
    cautionFactors: 'Facteurs de prudence',
    readingSummary: 'RÃ©sumÃ© de la lecture',
    bullishScenario: 'ScÃ©nario haussier',
    bearishScenario: 'ScÃ©nario baissier',
    whatChanges: 'Ce qui peut changer la lecture',
    currentReading: 'Lecture actuelle',
    potentialEntry: 'Zone dâ€™entrÃ©e potentielle',
    invalidation: 'Invalidation de la lecture',
    volume: 'Volume',
    pivot: 'Point pivot',
    refreshAnalysis: 'Actualiser lâ€™analyse',
    searchHistory: 'Rechercher dans les analyses rÃ©centes',
    shownHistory: 'AffichÃ©',
    noChartData: 'Les donnÃ©es de sÃ©rie de prix sont insuffisantes pour afficher de vraies bougies actuellement.',
    unavailable: 'Les donnÃ©es fiables sont insuffisantes pour cet actif actuellement.',
  },
} as const;
        ...
        {loading ? (
          ...
          <section className="agent-workspace" aria-labelledby="agent-workspace-title">
            <header className="agent-workspace-header">
              <div>
                <span>{successResult.symbol} Â· {labelAsset(successResult.assetType)} Â· {successResult.timeframe}</span>
                ...
                <section className="agent-section-card agent-snapshot-card">
                  <div className="agent-section-heading">
                    <div>
                      ...
                      <p>{successResult.source} Â· {formatDate(successResult.updatedAt, lang) || text.noValue}</p>
                    </div>
                  </div>
                ...
                <section className="agent-section-card agent-explanation-card">
                  ...
                  <div className="agent-analysis-notes">
                    ...
                    <article>
                      ...
                      <p>{text.resistance}: {joinLevels(successResult.resistance, text.noValue)} Â· {text.takeProfit}: {joinLevels(successResult.takeProfit, text.noValue)}</p>
                    </article>
                    <article>
                      <h3>{text.bearishScenario}</h3>
                      <p>{text.support}: {joinLevels(successResult.support, text.noValue)} Â· {text.stopLoss}: {successResult.stopLoss ? formatNumber(successResult.stopLoss) : text.noValue}</p>
                    </article>
                    <article>
                      <h3>{text.whatChanges}</h3>
                      <p>{text.risk}: {labelRisk(successResult.riskLevel)} Â· {text.confidence}: {successResult.confidence}%</p>
                    </article>
                  </div>
                </section>
              </div>
        ...
        <section className="agent-history-panel">
          <header>
            <div>
              ...
              <p>{text.recentSubtitle} Â· {text.shownHistory}: {visibleHistory.length}/{history.length}</p>
            </div>
