  ...
  return (
    <div className="subscriptions-shell" dir={dir}>
      ...
      <style jsx global>{`
        ...
        .subscriptions-primary,.subscriptions-secondary,.subscriptions-tertiary,.subscription-actions button,.subscription-actions a,.subscriptions-alert-list button{min-height:44px;border-radius:var(--r-md);border:1px solid transparent;padding:0 14px;display:inline-flex;align-items:center;justify-content:center;gap:8px;font:950 13px Tajawal,Arial,sans-serif;text-decoration:none;cursor:pointer;transition:.18s ease}
