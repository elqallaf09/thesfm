...
export default function MarketAnalysisPage() {
  ...
  const scenarioCurrency = userCurrency || 'KWD';
  const scenarioCurrencyMeta = getCurrency(scenarioCurrency);
  const scenarioCurrencySymbol = currencyDisplaySymbol(scenarioCurrencyMeta, lang);
  const scenarioAmountPlaceholder = t('market_amount_with_currency_placeholder').replace('{currency}', scenarioCurrencySymbol);
              ...
              <article className="market-panel">
                ...
                <label className="tool-input">
                  ...
                  <div className="market-currency-input">
                    ...
                    />
                    <em aria-label={t('market_amount_currency_label')}>{scenarioCurrencySymbol}</em>
                  </div>
