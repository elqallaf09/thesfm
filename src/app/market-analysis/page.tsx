        ...
        <div className="trader-tool-grid">
          <article className="trader-tool-card">
            ...
            <div className="trader-form-grid">
              ...
              />
              <ToolInput label={t('market_entry_price_optional')} helper={t('market_entry_price_hint')} prefix={currency} value={positionInput.entryPrice} onChange={value => setPositionInput(prev => ({ ...prev, entryPrice: value }))} />
              <ToolInput label={t('market_stop_price_optional')} helper={t('market_stop_price_hint')} prefix={currency} value={positionInput.stopLossPrice} onChange={value => setPositionInput(prev => ({ ...prev, stopLossPrice: value }))} />
            </div>
...
function CalendarMetric({ label, value, valueDir }: { label: string; value: string; valueDir?: 'ltr' | 'rtl' }) {
  return (
