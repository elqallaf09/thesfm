                      ...
                      >
                        <span className="market-search-result-main">
                          <span className="market-search-result-identity">
                            <AssetAvatar symbol={item.symbol} name={item.name} assetType={item.assetType} exchange={item.exchange} size="sm" decorative />
              ...
              <div className="market-panel" id="watchlist">
                ...
                <div className="watchlist">
                  {watchlist.length === 0 ? suggestedAssets.map(asset => (
                    ...
                    >
                      <AssetBadge symbol={asset.symbol} name={asset.name} assetType={asset.assetType} exchange={asset.exchange} size="xs" showName={false} symbolClassName="text-[11px]" />
                    </button>
                  )) : watchlist.map(asset => (
                    <span key={`${asset.id ?? asset.symbol}-${asset.assetType}`}>
                      <button type="button" onClick={() => void requestAnalysis(asset.providerSymbol ?? asset.symbol, asset.assetType, {
                        ...
                        <AssetBadge symbol={asset.symbol} name={asset.name ?? asset.symbol} assetType={asset.assetType} exchange={asset.exchange ?? undefined} size="xs" showName={false} symbolClassName="text-[11px]" />
                      </button>
