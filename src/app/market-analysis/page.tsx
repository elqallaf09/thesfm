  ...
  return (
    <div className="market-shell" dir={dir}>
      ...
      <style jsx>{`
        ...
        .market-main{width:100%;max-width:100%;min-width:0;margin:0;padding:24px clamp(16px,2.2vw,28px);display:grid;gap:16px;overflow-x:hidden;box-sizing:border-box}.market-main>*{width:100%;max-width:1240px;min-width:0;margin-inline:auto;box-sizing:border-box}
