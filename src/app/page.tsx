...
const landingToolCatalog: readonly LandingToolItem[] = [
  ...
  { navId: 'ai-analyst', category: 'ai', badge: 'new', description: ['مركز موحد للتحليل المالي المبني على الأدلة المتاحة.', 'One evidence-based financial analysis center.', 'Un centre unifié d’analyse financière fondée sur les preuves disponibles.'] },
