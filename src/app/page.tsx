...
const COPY: Record<Lang, Copy> = {
  ar: {
    ...
    navFaq: 'الأسئلة',
    start: 'ابدأ الآن',
    dashboard: 'افتح حسابي',
    heroKicker: 'ذكاء مالي مبني للخليج',
    heroTitle: 'أدِر أموالك وزكاتك واستثماراتك ومشاريعك من مكان واحد — بالعربي.',
    ...
    heroSecondary: 'جرّب حاسبة الزكاة',
    demoBadge: 'مثال',
    demoTitle: 'معاينة واضحة للمنتج',
    demoSubtitle: 'أرقام تجريبية معلّمة بوضوح حتى تعرف شكل التجربة قبل إضافة بياناتك الحقيقية.',
    demoIncome: 'الدخل الشهري',
    demoExpenses: 'المصروفات',
    demoProjects: 'المشاريع',
    demoZakat: 'الزكاة التقديرية',
    demoExample: 'بيانات تجريبية',
    trustTitle: 'أرقامك أنت، مو تقديرات',
    trustSubtitle: 'داخل حسابك، التحليلات تعتمد على بياناتك الفعلية. وإذا كانت البيانات ناقصة، نوضح ذلك بدل اختراع أرقام.',
    ...
    featuresTitle: 'أهم ما تحتاجه فعلاً',
    featuresSubtitle: 'نعرض القيمة الأساسية أولاً بدل إغراقك بعشرات المميزات. تقدر توسّع القائمة متى ما احتجت.',
    allFeatures: 'كل المميزات',
    lessFeatures: 'عرض أقل',
    pricingTitle: 'تسعير بسيط وواضح',
    pricingSubtitle: 'الأفراد: 5$ شهرياً أو 50$ سنوياً. الشركات: 50$ سنوياً.',
    monthly: 'شهري',
    yearly: 'سنوي',
    ...
    freeDesc: 'ابدأ بالأساسيات والحاسبات العامة.',
    proDesc: 'لإدارة أموالك واستثماراتك وزكاتك وتقاريرك وأدواتك المتقدمة.',
    businessDesc: 'للشركات والمشاريع التي تريد الظهور وخدمات الأعمال داخل المنصة.',
    subscribe: 'اشترك الآن',
    addCompany: 'أضف شركتك',
    checkoutLoading: 'جارٍ فتح الدفع...',
    checkoutError: 'تعذر فتح الدفع حالياً. حاول مرة أخرى.',
    currencyLabel: 'عرض السعر بـ',
    usdBillingNote: 'الأسعار المحلية للعرض التقريبي فقط. جلسة الدفع تستخدم سعر الاشتراك المحدد بالدولار الأمريكي في Stripe.',
    approximatePrice: 'تقريبي',
    securityKicker: 'الأمان والخصوصية',
    securityTitle: 'أمان واضح بدون كلام تسويقي مبهم',
    securitySubtitle: 'نوضح طبقات الحماية التي يعتمد عليها المنتج بدون ادعاءات غير قابلة للتحقق.',
    securityCards: ['HTTPS أثناء نقل البيانات', 'جلسات دخول وصلاحيات وصول للحساب', 'دعم المصادقة الثنائية', 'بنية بيانات مرتبطة بـ Supabase مع سياسات وصول'],
    faqTitle: 'أسئلة مهمة قبل التسجيل',
    faqSubtitle: 'أهم 6 أسئلة أولاً، والباقي عند الطلب.',
    more: 'عرض المزيد',
    less: 'عرض أقل',
    finalTitle: 'ابدأ بوضوح مالي أفضل اليوم',
    finalSubtitle: 'جرّب الأدوات العامة أو افتح حسابك وأضف بياناتك الحقيقية.',
    footer: 'THE SFM — منصة ذكاء مالي واقتصادي للأفراد والأعمال.',
  },
  en: {
    ...
    heroKicker: 'Financial intelligence built for the Gulf',
    heroTitle: 'Manage your money, zakat, investments, and projects in one place — in Arabic.',
    ...
    demoBadge: 'Example',
    demoTitle: 'A clear product preview',
    demoSubtitle: 'Clearly labeled demo values show the experience before you add your own real data.',
    demoIncome: 'Monthly income',
    demoExpenses: 'Expenses',
    demoProjects: 'Projects',
    demoZakat: 'Estimated zakat',
    demoExample: 'Demo data',
    trustTitle: 'Your numbers, not guesses',
    trustSubtitle: 'Inside your account, analysis is based on your saved data. When data is missing, THE SFM says so instead of inventing values.',
    ...
    featuresTitle: 'The six things that matter first',
    featuresSubtitle: 'We show the core value first instead of overwhelming you with dozens of features. Expand the list when you need it.',
    allFeatures: 'All features',
    lessFeatures: 'Show less',
    pricingTitle: 'Simple pricing',
    pricingSubtitle: 'Individuals: $5/month or $50/year. Companies: $50/year.',
    monthly: 'Monthly',
    yearly: 'Yearly',
    ...
    freeDesc: 'Start with essentials and public calculators.',
    proDesc: 'For personal finance, investments, zakat, reports, and advanced tools.',
    businessDesc: 'For companies and projects that want a business presence and business services.',
    subscribe: 'Subscribe',
    ...
    currencyLabel: 'Display price in',
    usdBillingNote: 'Local-currency values are approximate display amounts only. Checkout uses the subscription price configured in USD in Stripe.',
    approximatePrice: 'Approx.',
    securityKicker: 'Security & privacy',
    securityTitle: 'Security explained clearly',
    securitySubtitle: 'We describe the product protections without vague or unverifiable claims.',
    securityCards: ['HTTPS for data in transit', 'Authenticated sessions and account access controls', 'Two-factor authentication support', 'Supabase-backed data infrastructure with access policies'],
    faqTitle: 'Questions before you join',
    faqSubtitle: 'The six most useful answers first, with more available on demand.',
    more: 'Show more',
    less: 'Show less',
    finalTitle: 'Start with a clearer financial picture',
    finalSubtitle: 'Try a public tool or create your account and add your real data.',
    footer: 'THE SFM — financial and economic intelligence for individuals and businesses.',
  },
  fr: {
    ...
    heroKicker: 'Intelligence financière pensée pour le Golfe',
    heroTitle: 'Gérez argent, zakat, investissements et projets depuis un seul endroit — en arabe.',
    ...
    heroSecondary: 'Essayer la calculatrice de zakat',
    demoBadge: 'Exemple',
    demoTitle: 'Un aperçu clair du produit',
    demoSubtitle: 'Des valeurs de démonstration clairement marquées montrent l’expérience avant vos propres données réelles.',
    demoIncome: 'Revenu mensuel',
    demoExpenses: 'Dépenses',
    demoProjects: 'Projets',
    demoZakat: 'Zakat estimée',
    demoExample: 'Données démo',
    trustTitle: 'Vos chiffres, pas des suppositions',
    trustSubtitle: 'Dans votre compte, les analyses reposent sur vos données enregistrées. S’il manque des données, THE SFM le signale.',
    ...
    featuresTitle: 'Les six fonctions essentielles',
    featuresSubtitle: 'Nous montrons d’abord la valeur principale. Vous pouvez développer la liste lorsque vous en avez besoin.',
    allFeatures: 'Toutes les fonctions',
    lessFeatures: 'Afficher moins',
    pricingTitle: 'Tarification simple',
    pricingSubtitle: 'Particuliers : 5 $/mois ou 50 $/an. Entreprises : 50 $/an.',
    monthly: 'Mensuel',
    yearly: 'Annuel',
    saveTwoMonths: 'Économisez deux mois',
    free: 'Gratuit',
    pro: 'Particuliers',
    business: 'Entreprises',
    freePrice: 'Gratuit',
    yearlyOnly: 'Annuel uniquement',
    recommended: 'Recommandé',
    freeDesc: 'Commencez avec les fonctions essentielles et les calculateurs publics.',
    proDesc: 'Pour finances personnelles, investissements, zakat, rapports et outils avancés.',
    businessDesc: 'Pour les entreprises et projets qui veulent une présence et des services business.',
    subscribe: 'S’abonner',
    addCompany: 'Ajouter votre société',
    checkoutLoading: 'Ouverture du paiement...',
    checkoutError: 'Le paiement est indisponible pour le moment.',
    currencyLabel: 'Afficher le prix en',
    usdBillingNote: 'Les montants en devise locale sont uniquement indicatifs. Le paiement utilise le prix d’abonnement configuré en USD dans Stripe.',
    approximatePrice: 'Approx.',
    securityKicker: 'Sécurité et confidentialité',
    securityTitle: 'Une sécurité expliquée clairement',
    securitySubtitle: 'Nous décrivons les protections du produit sans promesses vagues ou invérifiables.',
    securityCards: ['HTTPS pour les données en transit', 'Sessions authentifiées et contrôles d’accès', 'Prise en charge de la double authentification', 'Infrastructure de données liée à Supabase avec politiques d’accès'],
    faqTitle: 'Questions avant de commencer',
    faqSubtitle: 'Les six réponses les plus utiles d’abord, puis le reste à la demande.',
    more: 'Afficher plus',
    less: 'Afficher moins',
    finalTitle: 'Commencez avec une vision financière plus claire',
    finalSubtitle: 'Essayez un outil public ou créez votre compte et ajoutez vos données réelles.',
    footer: 'THE SFM — intelligence financière et économique pour particuliers et entreprises.',
  },
};
...
const PLAN_FEATURES = {
  free: [
    ['إدارة الدخل والمصروفات', 'Income and expense basics', 'Gestion de base des revenus et dépenses'],
    ['الأهداف والمدخرات', 'Goals and savings', 'Objectifs et épargne'],
    ['الحاسبات العامة', 'Public calculators', 'Calculateurs publics'],
  ],
  premium: [
    ['المال الشخصي', 'Personal finance', 'Finances personnelles'],
    ['الاستثمارات والأسواق', 'Investments and markets', 'Investissements et marchés'],
    ['مساحة الزكاة', 'Zakat workspace', 'Espace zakat'],
    ['الذكاء والتقارير', 'AI tools and reports', 'IA et rapports'],
  ],
  company: [
    ['ظهور الشركة', 'Company presence', 'Présence de l’entreprise'],
    ['خدمات الأعمال', 'Business services', 'Services business'],
    ['مراجعة قبل النشر', 'Review before publishing', 'Révision avant publication'],
  ],
...
function localizedPrice(usdAmount: number, currency: DisplayCurrency) {
  ...
  const maximumFractionDigits = currency === 'KWD' ? 3 : 2;
  return `≈ ${converted.toLocaleString('en-US', { maximumFractionDigits, minimumFractionDigits: 0 })} ${currency}`;
}
  ...
  const startCheckout = useCallback(async (plan: PaidPlan) => {
    ...
    if (!session) {
      if (typeof window !== 'undefined') {
        window.sessionStorage.setItem('sfm_pending_checkout', JSON.stringify({ plan, billingInterval: interval }));
      }
    ...
    <main dir={dir} className="landing-page min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-50 border-b border-border/70 bg-background/90 backdrop-blur-xl">
        <div className="mx-auto flex min-h-16 w-full max-w-7xl items-center justify-between gap-3 px-4 md:px-6">
          ...
          <nav className="hidden items-center gap-1 lg:flex">
            <a className="rounded-[var(--radius-pill)] px-3 py-2 text-sm text-muted-foreground hover:bg-muted hover:text-foreground" href="#features">{text.navFeatures}</a>
            <a className="rounded-[var(--radius-pill)] px-3 py-2 text-sm text-muted-foreground hover:bg-muted hover:text-foreground" href="#pricing">{text.navPricing}</a>
            <a className="rounded-[var(--radius-pill)] px-3 py-2 text-sm text-muted-foreground hover:bg-muted hover:text-foreground" href="#security">{text.navSecurity}</a>
            <a className="rounded-[var(--radius-pill)] px-3 py-2 text-sm text-muted-foreground hover:bg-muted hover:text-foreground" href="#faq">{text.navFaq}</a>
          </nav>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              className="inline-flex h-10 w-10 items-center justify-center rounded-[var(--radius-control)] border border-border lg:hidden"
        ...
        {menuOpen ? (
          <div className="border-t border-border bg-background px-4 py-3 lg:hidden">
            <div className="mx-auto grid max-w-7xl gap-2">
              {[
                ['#features', text.navFeatures],
                ['#pricing', text.navPricing],
                ['#security', text.navSecurity],
                ['#faq', text.navFaq],
              ].map(([href, label]) => (
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-14 md:px-6 md:py-20 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:py-24">
          ...
          <aside className="rounded-[var(--radius-panel)] border border-border bg-card p-4 shadow-[var(--shadow-lg)] md:p-6" aria-label={text.demoTitle}>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                [text.demoIncome, '1,250 KWD'],
                [text.demoExpenses, '680 KWD'],
                [text.demoProjects, '3'],
                [text.demoZakat, '312.50 KWD'],
              ].map(([label, value]) => (
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 md:px-6">
        <div className="grid gap-6 lg:grid-cols-[.8fr_1.2fr] lg:items-start">
          <div>
            <h2 className="text-3xl font-bold">{text.trustTitle}</h2>
            <p className="landing-secondary mt-3 leading-7">{text.trustSubtitle}</p>
          </div>
          <div className="grid gap-3 sm:grid-cols-2">
            {text.trustItems.map(item => (
              <div key={item} className="flex items-start gap-3 rounded-[var(--radius-card)] border border-border bg-card p-4">
      ...
      <section id="features" className="border-y border-border bg-muted/25">
        <div className="mx-auto max-w-7xl px-4 py-14 md:px-6">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-bold md:text-4xl">{text.featuresTitle}</h2>
            <p className="landing-secondary mt-3 leading-7">{text.featuresSubtitle}</p>
          </div>
          ...
          <button type="button" onClick={() => setShowAllFeatures(value => !value)} className="mt-6 inline-flex min-h-11 items-center rounded-[var(--radius-control)] border border-border bg-card px-4 font-semibold hover:bg-muted">
            {showAllFeatures ? text.lessFeatures : text.allFeatures}
          </button>
        </div>
      </section>
      ...
      <section id="pricing" className="mx-auto max-w-7xl px-4 py-14 md:px-6">
        <div className="max-w-3xl">
          <h2 className="text-3xl font-bold md:text-4xl">{text.pricingTitle}</h2>
          <p className="landing-secondary mt-3 leading-7">{text.pricingSubtitle}</p>
        </div>
          ...
          <div className="inline-flex rounded-[var(--radius-control)] border border-border bg-muted/40 p-1">
            {(['monthly', 'yearly'] as const).map(interval => (
              <button
                ...
                className={`rounded-[var(--radius-sm)] px-4 py-2 text-sm font-semibold ${billing === interval ? 'bg-card shadow-[var(--shadow-xs)]' : 'text-muted-foreground'}`}
              >
                {interval === 'monthly' ? text.monthly : text.yearly}
              </button>
            ))}
          </div>
            ...
            <div className="flex flex-wrap gap-2" aria-label={text.currencyLabel}>
              {DISPLAY_CURRENCIES.map(code => (
                <button
                  ...
                  className={`rounded-[var(--radius-pill)] border px-3 py-1.5 text-sm font-semibold ${displayCurrency === code ? 'border-primary bg-primary/10 text-primary' : 'border-border text-muted-foreground hover:bg-muted'}`}
                >
                  {code}
                </button>
              ))}
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-3">
          <PricingCard
            ...
            features={PLAN_FEATURES.free.map(item => pick(item, currentLang))}
            action={<Link href={appHref} className="mt-auto inline-flex min-h-11 items-center justify-center rounded-[var(--radius-control)] border border-border font-semibold hover:bg-muted">{ctaLabel}</Link>}
          />
          <PricingCard
            featured
            badge={text.recommended}
            title={text.pro}
            price={localizedPrice(billing === 'yearly' ? 50 : 5, displayCurrency)}
            priceMeta={displayCurrency === 'USD' ? undefined : text.approximatePrice}
            description={text.proDesc}
            features={PLAN_FEATURES.premium.map(item => pick(item, currentLang))}
            action={<button type="button" disabled={loading || checkoutLoading !== null} onClick={() => void startCheckout('premium')} className="mt-auto min-h-11 rounded-[var(--radius-control)] bg-primary font-semibold text-primary-foreground disabled:opacity-60">{checkoutLoading === 'premium' ? text.checkoutLoading : text.subscribe}</button>}
          />
          <PricingCard
            title={text.business}
            price={localizedPrice(50, displayCurrency)}
            priceMeta={displayCurrency === 'USD' ? text.yearlyOnly : `${text.approximatePrice} · ${text.yearlyOnly}`}
            description={text.businessDesc}
            features={PLAN_FEATURES.company.map(item => pick(item, currentLang))}
            action={<button type="button" disabled={loading || checkoutLoading !== null} onClick={() => void startCheckout('company')} className="mt-auto min-h-11 rounded-[var(--radius-control)] border border-border font-semibold hover:bg-muted disabled:opacity-60">{checkoutLoading === 'company' ? text.checkoutLoading : text.addCompany}</button>}
          />
        </div>
      </section>
      ...
      <section id="security" className="border-y border-border bg-muted/25">
        <div className="mx-auto max-w-7xl px-4 py-14 md:px-6">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 text-primary"><LockKeyhole size={20} /><span className="font-semibold">{text.securityKicker}</span></div>
            <h2 className="mt-3 text-3xl font-bold md:text-4xl">{text.securityTitle}</h2>
            <p className="landing-secondary mt-3 leading-7">{text.securitySubtitle}</p>
          </div>
          <div className="mt-8 grid gap-4 md:grid-cols-2">
            {text.securityCards.map(item => (
              <div key={item} className="flex items-start gap-3 rounded-[var(--radius-card)] border border-border bg-card p-5">
      ...
      <section id="faq" className="mx-auto max-w-4xl px-4 py-14 md:px-6">
        <div className="text-center">
          <h2 className="text-3xl font-bold md:text-4xl">{text.faqTitle}</h2>
          <p className="landing-secondary mt-3">{text.faqSubtitle}</p>
        </div>
          ...
          {faqItems.map(([question, answer], index) => {
            ...
            return (
              <article key={question} className="overflow-hidden rounded-[var(--radius-card)] border border-border bg-card">
                <button type="button" onClick={() => setOpenFaq(open ? -1 : index)} className="flex w-full items-center justify-between gap-4 p-4 text-start font-semibold" aria-expanded={open}>
                  <span>{question}</span>
        ...
        <div className="mt-5 text-center">
          <button type="button" onClick={() => setShowAllFaq(value => !value)} className="rounded-[var(--radius-control)] border border-border bg-card px-4 py-2.5 font-semibold hover:bg-muted">{showAllFaq ? text.less : text.more}</button>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 md:px-6">
        <div className="rounded-[var(--radius-panel)] border border-primary/20 bg-primary/10 p-7 text-center md:p-10">
          ...
          <p className="landing-secondary mx-auto mt-3 max-w-2xl">{text.finalSubtitle}</p>
          <div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
            <Link href={appHref} className="inline-flex min-h-12 items-center justify-center rounded-[var(--radius-control)] bg-primary px-6 font-semibold text-primary-foreground">{ctaLabel}</Link>
            <Link href="/zakat-calculator" className="inline-flex min-h-12 items-center justify-center rounded-[var(--radius-control)] border border-border bg-card px-6 font-semibold">{text.heroSecondary}</Link>
          </div>
        </div>
      </section>

      <div className="fixed inset-x-3 bottom-3 z-40 sm:hidden">
        <Link href={appHref} className="flex min-h-12 items-center justify-center rounded-[var(--radius-control)] bg-primary px-5 font-bold text-primary-foreground shadow-[var(--shadow-lg)]">{ctaLabel}</Link>
      </div>
  ...
  return (
    <article className={`flex min-h-[430px] flex-col rounded-[var(--radius-panel)] border bg-card p-6 ${featured ? 'border-primary shadow-[var(--shadow-lg)] ring-1 ring-primary/20' : 'border-border'}`}>
      ...
      <ul className="my-6 grid gap-3">
        {features.map(item => <li key={item} className="flex items-center gap-2 text-sm"><CheckCircle2 size={16} className="text-primary" />{item}</li>)}
      </ul>
      {action}
    </article>
  );
