...
export default function AiPage() {
  ...
  return (
    <div className="ai-page" dir={dir}>
      ...
      <style jsx global>{`
        .ai-page{width:100%;min-width:0;color:var(--foreground);font-family:var(--font-ui)}
        .ai-main{width:100%;min-width:0}
        .ai-topbar{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:18px}.ai-topbar span{font-size:12px;color:var(--foreground-muted);font-weight:500}.ai-topbar h1{margin:4px 0 0;font-size:clamp(24px,3vw,30px);font-weight:600;color:var(--foreground)}
        .ai-hero{background:var(--hero-gradient);border:1px solid var(--border-strong);border-radius:var(--radius-panel);padding:clamp(22px,4vw,32px);color:var(--hero-foreground);display:grid;grid-template-columns:minmax(0,1fr) auto;gap:24px;align-items:center;box-shadow:var(--shadow-md);margin-bottom:16px}.ai-badge{display:inline-flex;align-items:center;gap:8px;color:var(--hero-foreground);background:color-mix(in srgb,var(--surface) 14%,transparent);border:1px solid color-mix(in srgb,var(--hero-foreground) 24%,transparent);border-radius:var(--radius-pill);padding:6px 12px;font-size:12px;font-weight:600;margin-bottom:14px}.ai-hero h2{font-size:clamp(30px,4vw,40px);margin:0 0 10px;font-weight:600;line-height:1.25}.ai-hero p{max-width:790px;color:var(--hero-foreground-muted);line-height:1.9;font-size:15px;margin:0 0 20px}.ai-hero-actions{display:flex;flex-wrap:wrap;gap:9px}.ai-hero-actions button,.ai-actions a,.ai-actions button,.ai-chat-row button{min-height:var(--control-h);border:1px solid var(--border);border-radius:var(--radius-control);padding:0 15px;display:inline-flex;align-items:center;justify-content:center;gap:8px;font-family:var(--font-ui);font-size:13px;font-weight:600;cursor:pointer;text-decoration:none;transition:background var(--duration-fast) ease,border-color var(--duration-fast) ease,color var(--duration-fast) ease}.ai-hero-actions button:first-child,.ai-chat-row button{border-color:var(--primary);background:var(--primary);color:var(--primary-foreground)}.ai-hero-actions button:not(:first-child){border-color:color-mix(in srgb,var(--hero-foreground) 28%,transparent);background:color-mix(in srgb,var(--surface) 12%,transparent);color:var(--hero-foreground)}.ai-hero-actions button:hover:not(:disabled),.ai-chat-row button:hover:not(:disabled){border-color:var(--primary-hover);background:var(--primary-hover);color:var(--primary-foreground)}.ai-hero-actions button:focus-visible,.ai-actions a:focus-visible,.ai-actions button:focus-visible,.ai-chat-row button:focus-visible,.ai-chips button:focus-visible,.ai-chat-row input:focus-visible,.ai-analysis-guidance a:focus-visible,.ai-analysis-empty a:focus-visible{outline:2px solid var(--focus-ring);outline-offset:2px;box-shadow:var(--focus-shadow)}.ai-score-ring{width:176px;height:176px;border:10px solid var(--accent);border-radius:var(--radius-pill);display:grid;place-items:center;justify-self:end;background:var(--accent-soft)}.ai-score-ring>div{width:136px;height:136px;border-radius:var(--radius-pill);background:var(--surface);display:grid;place-items:center;text-align:center;border:1px solid var(--border);color:var(--foreground)}.ai-score-ring strong{font-family:var(--font-data);font-size:42px;color:var(--primary);line-height:1}.ai-score-ring span,.ai-score-ring b{display:block;color:var(--foreground-secondary);font-size:12px}
        .ai-card{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-panel);box-shadow:var(--shadow-card);padding:18px;margin-bottom:14px;min-width:0}.ai-grid{display:grid;grid-template-columns:repeat(12,minmax(0,1fr));gap:14px}.span-5{grid-column:span 5}.span-6{grid-column:span 6}.span-7{grid-column:span 7}.ai-section-title{display:flex;align-items:center;gap:9px;color:var(--foreground-muted);margin-bottom:14px}.ai-section-title h2{font-size:17px;color:var(--foreground);margin:0;font-weight:600}
        .ai-health{display:grid;gap:7px;margin-bottom:12px}.ai-health-head{display:flex;align-items:center;justify-content:space-between;gap:12px}.ai-health strong{font-size:13px;font-weight:600}.ai-health span{font-family:var(--font-data);font-size:12px;color:var(--foreground-muted);font-weight:500}.ai-bar{height:10px;background:var(--surface-muted);border-radius:var(--radius-pill);overflow:hidden}.ai-bar i{display:block;height:100%;border-radius:var(--radius-pill);background:var(--accent)}.ai-health p{margin:0;color:var(--foreground-muted);font-size:12px;line-height:1.6;font-weight:400}.ai-health-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}
        .ai-insights,.ai-plan-grid,.ai-goals-grid,.ai-chart-grid,.ai-prediction-grid{display:grid;gap:12px}.ai-insights{grid-template-columns:repeat(2,minmax(0,1fr))}.ai-insight-card{border-radius:var(--radius-card);background:var(--surface-muted);border:1px solid var(--border);padding:14px}.ai-insight-top{display:flex;justify-content:space-between;gap:10px}.ai-insight-card h3{margin:0;font-size:15px;font-weight:600}.ai-pill{border-radius:var(--radius-pill);padding:5px 9px;font-size:12px;font-weight:600}.ai-pill.good{background:var(--success-soft);color:var(--success)}.ai-pill.warning{background:var(--warning-soft);color:var(--warning)}.ai-pill.danger{background:var(--danger-soft);color:var(--danger)}.ai-insight-card b{display:block;color:var(--accent);margin:10px 0 5px;font-weight:600}.ai-insight-card p{margin:0 0 8px;color:var(--foreground-muted);font-size:13px;line-height:1.7}.ai-action{color:var(--foreground)!important;font-weight:500}
        .ai-plan-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.ai-plan-card,.ai-metric,.ai-goal-card,.ai-chart-box{background:var(--surface-muted);border:1px solid var(--border);border-radius:var(--radius-card);padding:14px;min-width:0}.ai-plan-card h3{margin:0 0 10px;font-weight:600}.ai-plan-card div{display:flex;justify-content:space-between;gap:8px;font-size:12px;margin-top:6px}.ai-plan-card span,.ai-metric span{color:var(--foreground-muted);font-weight:500}.ai-plan-card strong,.ai-metric strong{color:var(--foreground);font-family:var(--font-data);font-weight:600}.ai-plan-summary{background:var(--accent-soft);border:1px solid var(--border);border-radius:var(--radius-card);padding:12px;margin:14px 0 0;color:var(--foreground-secondary);font-weight:500;line-height:1.7}.ai-hero-actions button:disabled{opacity:.66;cursor:wait}.spin{animation:spin 1s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}.ai-analysis-result{border-color:var(--accent);background:var(--surface);scroll-margin-top:18px}.ai-analysis-result.missing,.ai-analysis-result.error{border-color:var(--warning);background:var(--warning-soft)}.ai-analysis-summary{display:grid;grid-template-columns:auto minmax(0,1fr);gap:16px;align-items:center}.ai-analysis-score{width:104px;height:104px;border-radius:var(--radius-panel);background:var(--primary-soft);border:1px solid var(--primary);display:grid;place-items:center;text-align:center;color:var(--foreground)}.ai-analysis-score strong{display:block;color:var(--primary);font-family:var(--font-data);font-size:32px;font-weight:600;line-height:1}.ai-analysis-score span,.ai-analysis-score b{display:block;font-size:12px}.ai-analysis-summary p,.ai-analysis-empty p{margin:0 0 8px;color:var(--foreground-muted);font-weight:400;line-height:1.8}.ai-analysis-summary small{color:var(--foreground-muted);font-weight:400}.ai-analysis-columns{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin-top:16px}.ai-analysis-columns>div,.ai-analysis-guidance,.ai-analysis-empty{background:var(--surface-muted);border:1px solid var(--border);border-radius:var(--radius-card);padding:14px;min-width:0}.ai-analysis-columns h3{margin:0 0 8px;color:var(--foreground);font-size:14px;font-weight:600}.ai-analysis-columns ul{margin:0;padding-inline-start:20px;color:var(--foreground-muted);font-weight:400;line-height:1.8}.ai-analysis-guidance{margin-top:14px}.ai-analysis-guidance strong{display:block;margin-bottom:10px;color:var(--foreground);font-weight:600}.ai-analysis-guidance div,.ai-analysis-empty div{display:flex;flex-wrap:wrap;gap:8px}.ai-analysis-guidance a,.ai-analysis-empty a{min-height:38px;display:inline-flex;align-items:center;justify-content:center;border-radius:var(--radius-control);border:1px solid var(--border);background:var(--accent-soft);color:var(--accent-hover);padding:0 12px;text-decoration:none;font-weight:600}.ai-analysis-guidance a:hover,.ai-analysis-empty a:hover{border-color:var(--accent);background:var(--sidebar-hover)}
        .ai-chips{display:flex;flex-wrap:wrap;gap:7px;margin-bottom:12px}.ai-chips button{border:1px solid var(--border);background:var(--surface-muted);color:var(--foreground-secondary);border-radius:var(--radius-pill);padding:8px 11px;font-family:var(--font-ui);font-size:12px;font-weight:500;cursor:pointer}.ai-chat-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px}.ai-chat-row input{height:var(--control-h);min-width:0;border:1px solid var(--border);border-radius:var(--radius-control);background:var(--surface);color:var(--foreground);padding:0 12px;outline:0;font-family:var(--font-ui);font-size:13px;font-weight:400}.ai-answer{margin-top:12px;display:flex;align-items:flex-start;gap:10px;background:var(--info-soft);color:var(--foreground);border:1px solid var(--border);border-radius:var(--radius-card);padding:13px 14px;box-shadow:var(--shadow-sm)}.ai-answer svg{color:var(--info);flex:0 0 auto;margin-top:2px}.ai-answer p{margin:0;line-height:1.9;font-size:13px;font-weight:400;color:var(--foreground);overflow-wrap:anywhere}
        .ai-prediction-grid{grid-template-columns:repeat(auto-fit,minmax(170px,1fr))}.ai-compact-report-row{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px;align-items:start}.ai-compact-card{margin-bottom:14px;align-self:start}.ai-comparison-mini-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.ai-compact-metric{background:var(--surface-muted);border:1px solid var(--border);border-radius:var(--radius-card);padding:12px;display:grid;gap:6px;min-width:0}.ai-compact-metric span{color:var(--foreground-muted);font-size:12px;font-weight:500}.ai-compact-metric strong{color:var(--foreground);font-family:var(--font-data);font-size:18px;font-weight:600}.ai-compact-metric.good strong{color:var(--success)}.ai-compact-metric.warning strong{color:var(--warning)}.ai-compact-metric.danger strong{color:var(--danger)}.ai-forecast-mini-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:10px}.ai-forecast-mini-grid .ai-metric{padding:12px;border-radius:var(--radius-card)}.ai-metric{display:grid;gap:6px}.ai-metric strong{font-size:16px}.ai-disclaimer{margin:14px 0 0;border:1px solid var(--border);background:var(--surface-muted);border-radius:var(--radius-control);padding:11px 12px;color:var(--foreground-muted);font-size:12.5px;font-weight:400;line-height:1.7}.ai-goals-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.ai-goal-card h3{margin:0 0 10px;font-weight:600}.ai-goal-card p{margin:6px 0;color:var(--foreground-muted);font-size:13px;line-height:1.7}.ai-chart-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.ai-chart-box h3{margin:0 0 8px;font-size:14px;font-weight:600}.ai-chart-skeleton{min-height:248px;display:grid;gap:14px;align-content:start}.ai-chart-skeleton span{width:46%;height:14px;border-radius:var(--radius-pill);background:var(--skeleton-base)}.ai-chart-skeleton i{height:190px;border-radius:var(--radius-card);background:var(--skeleton-gradient);background-size:200% 100%;animation:ai-shimmer 1.3s infinite linear}@keyframes ai-shimmer{to{background-position:-200% 0}}.ai-actions{display:flex;flex-wrap:wrap;gap:9px}.ai-actions a,.ai-actions button{background:var(--surface-muted);color:var(--foreground-secondary);border:1px solid var(--border)}.ai-actions a:hover,.ai-actions button:hover,.ai-chips button:hover{border-color:var(--primary);background:var(--sidebar-hover);color:var(--primary-hover)}
        .ai-empty{text-align:center;padding:28px 16px;color:var(--foreground-muted)}.ai-empty h3{margin:0 0 8px;color:var(--foreground);font-weight:600}.ai-empty p{margin:0;line-height:1.7}.ai-toast{position:fixed;z-index:9999;inset-inline-end:22px;bottom:calc(22px + env(safe-area-inset-bottom));width:max-content;max-width:min(520px,calc(100vi - 32px));white-space:normal;overflow-wrap:anywhere;background:var(--surface-elevated);color:var(--foreground);border:1px solid var(--border-strong);border-radius:var(--radius-card);padding:14px 16px;font-family:var(--font-ui);font-size:13px;font-weight:500;line-height:1.7;box-shadow:var(--shadow-popover)}.ai-loading{height:180px;display:grid;place-items:center;color:var(--foreground-muted);font-size:32px}
        @media(max-width:1180px){.ai-hero{grid-template-columns:1fr}.ai-score-ring{justify-self:start}.span-5,.span-6,.span-7{grid-column:span 12}.ai-plan-grid,.ai-chart-grid,.ai-prediction-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:980px){.ai-analysis-columns{grid-template-columns:1fr}.ai-analysis-summary{grid-template-columns:1fr}.ai-analysis-score{width:96px;height:96px}}@media(max-width:860px){.ai-compact-report-row{grid-template-columns:1fr}}@media(max-width:720px){.ai-topbar{align-items:flex-start;flex-direction:column}.ai-hero{padding:22px}.ai-score-ring{width:156px;height:156px}.ai-score-ring>div{width:118px;height:118px}.ai-insights,.ai-plan-grid,.ai-health-grid,.ai-goals-grid,.ai-chart-grid,.ai-prediction-grid,.ai-comparison-mini-grid,.ai-forecast-mini-grid{grid-template-columns:1fr}.ai-chat-row{grid-template-columns:1fr}.ai-hero-actions button,.ai-actions a,.ai-actions button{width:100%}.ai-toast{inset-inline:16px;width:auto;max-width:none}}
      `}</style>
    </div>
  );
}
