...
const palette = ['#D8AE63', '#9A6C3C', '#5B4332', '#22C55E', '#3B82F6', '#BFB5A8'];
    ...
    <div className="ai-page" dir={dir}>
      ...
      <main className="ai-main">
        ...
        <section className="ai-hero">
          ...
          <div className="ai-score-ring" style={{ background: `conic-gradient(#D8AE63 ${score * 3.6}deg, rgba(255,255,255,.14) 0deg)` }}>
            <div>
              <strong>{score}</strong>
              <span>/100</span>
              ...
              <ChartBox title={`${L('income')} / ${L('expenses')}`}>
                <ResponsiveContainer width="100%" height={220}>
                  <AreaChart data={monthlyData}>
                    ...
                    <YAxis tick={{ fontSize: 11, fill: '#8A7060' }} axisLine={false} tickLine={false} />
                    <Tooltip formatter={(value: number) => money(Number(value))} />
      ...
      <style jsx global>{`
        .ai-page{min-height:100vh;background:#F7F3EA;color:#111;display:flex;font-family:Tajawal,Arial,sans-serif}.ai-main{flex:1;max-width:1320px;width:100%;margin:0 auto;padding:22px;margin-inline-start:230px}.ai-topbar{display:flex;align-items:center;justify-content:space-between;margin-bottom:18px}.ai-topbar span{font-size:12px;color:#9A6C3C;font-weight:900}.ai-topbar h1{margin:4px 0 0;font-size:26px;font-weight:900;color:#111}
        .ai-hero{background:linear-gradient(135deg,#111 0%,#2B1A0D 62%,#D8AE63 150%);border:1px solid rgba(216,174,99,.22);border-radius:28px;padding:30px;color:#FFFDFC;display:grid;grid-template-columns:1fr 220px;gap:22px;align-items:center;box-shadow:0 20px 55px rgba(45,26,10,.16);margin-bottom:16px}.ai-badge{display:inline-flex;align-items:center;gap:8px;color:#D8AE63;background:rgba(216,174,99,.12);border:1px solid rgba(216,174,99,.18);border-radius:999px;padding:6px 12px;font-size:12px;font-weight:900;margin-bottom:14px}.ai-hero h2{font-size:38px;margin:0 0 10px;font-weight:900}.ai-hero p{max-width:790px;color:rgba(255,255,255,.78);line-height:1.9;font-size:15px;margin:0 0 20px}.ai-hero-actions{display:flex;flex-wrap:wrap;gap:9px}.ai-hero-actions button,.ai-actions a,.ai-actions button,.ai-chat-row button{border:0;border-radius:14px;height:43px;padding:0 15px;display:inline-flex;align-items:center;justify-content:center;gap:8px;font:900 13px Tajawal,Arial,sans-serif;cursor:pointer;text-decoration:none;transition:.2s}.ai-hero-actions button:first-child,.ai-chat-row button{background:linear-gradient(135deg,#D8AE63,#9A6C3C);color:#111}.ai-hero-actions button:not(:first-child){background:rgba(255,255,255,.1);border:1px solid rgba(255,255,255,.18);color:#fff}.ai-score-ring{width:190px;height:190px;border-radius:50%;display:grid;place-items:center;justify-self:end}.ai-score-ring>div{width:142px;height:142px;border-radius:50%;background:linear-gradient(145deg,#1A0F05,#2B1A0D);display:grid;place-items:center;text-align:center;border:1px solid rgba(216,174,99,.22)}.ai-score-ring strong{font-size:42px;color:#D8AE63;line-height:1}.ai-score-ring span,.ai-score-ring b{display:block;color:#fff;font-size:12px}
        .ai-card{background:#FFFDFC;border:1px solid rgba(216,174,99,.14);border-radius:22px;box-shadow:0 4px 22px rgba(90,67,51,.06);padding:18px;margin-bottom:14px}.ai-grid{display:grid;grid-template-columns:repeat(12,1fr);gap:14px}.span-5{grid-column:span 5}.span-6{grid-column:span 6}.span-7{grid-column:span 7}.ai-section-title{display:flex;align-items:center;gap:9px;color:#9A6C3C;margin-bottom:14px}.ai-section-title h2{font-size:17px;color:#111;margin:0;font-weight:900}
        .ai-health{display:grid;gap:7px;margin-bottom:12px}.ai-health-head{display:flex;align-items:center;justify-content:space-between;gap:12px}.ai-health strong{font-size:13px}.ai-health span{font-size:12px;color:#9A6C3C;font-weight:900}.ai-bar{height:10px;background:#F1E8D8;border-radius:999px;overflow:hidden}.ai-bar i{display:block;height:100%;border-radius:999px;background:linear-gradient(90deg,#9A6C3C,#D8AE63)}.ai-health p{margin:0;color:#7C6A5D;font-size:12px;line-height:1.6;font-weight:800}.ai-health-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px}
        .ai-insights,.ai-plan-grid,.ai-goals-grid,.ai-chart-grid,.ai-prediction-grid{display:grid;gap:12px}.ai-insights{grid-template-columns:repeat(2,1fr)}.ai-insight-card{border-radius:18px;background:#F7F3EA;border:1px solid rgba(216,174,99,.13);padding:14px}.ai-insight-top{display:flex;justify-content:space-between;gap:10px}.ai-insight-card h3{margin:0;font-size:15px}.ai-pill{border-radius:999px;padding:5px 9px;font-size:11px;font-weight:900}.ai-pill.good{background:#DCFCE7;color:#166534}.ai-pill.warning{background:#FEF3C7;color:#92400E}.ai-pill.danger{background:#FEE2E2;color:#991B1B}.ai-insight-card b{display:block;color:#D8AE63;margin:10px 0 5px}.ai-insight-card p{margin:0 0 8px;color:#5B4332;font-size:13px;line-height:1.7}.ai-action{color:#111!important;font-weight:900}
        .ai-plan-grid{grid-template-columns:repeat(4,1fr)}.ai-plan-card,.ai-metric,.ai-goal-card,.ai-chart-box{background:#F7F3EA;border:1px solid rgba(216,174,99,.12);border-radius:18px;padding:14px}.ai-plan-card h3{margin:0 0 10px}.ai-plan-card div{display:flex;justify-content:space-between;font-size:12px;margin-top:6px}.ai-plan-card span,.ai-metric span{color:#9A6C3C;font-weight:900}.ai-plan-card strong,.ai-metric strong{color:#111}.ai-plan-summary{background:rgba(216,174,99,.1);border:1px solid rgba(216,174,99,.15);border-radius:15px;padding:12px;margin:14px 0 0;color:#5B4332;font-weight:900;line-height:1.7}
        .ai-chips{display:flex;flex-wrap:wrap;gap:7px;margin-bottom:12px}.ai-chips button{border:1px solid rgba(216,174,99,.15);background:#F7F3EA;color:#5B4332;border-radius:999px;padding:8px 11px;font:800 12px Tajawal,Arial,sans-serif;cursor:pointer}.ai-chat-row{display:grid;grid-template-columns:1fr auto;gap:8px}.ai-chat-row input{height:46px;border:1.5px solid rgba(216,174,99,.22);border-radius:14px;background:#F7F3EA;padding:0 12px;outline:0;font:800 13px Tajawal,Arial,sans-serif}.ai-answer{margin-top:12px;display:flex;gap:9px;background:#111;color:#F7F3EA;border-radius:16px;padding:12px}.ai-answer svg{color:#D8AE63;flex:0 0 auto}.ai-answer p{margin:0;line-height:1.8;font-size:13px}
        .ai-prediction-grid{grid-template-columns:repeat(5,1fr)}.ai-metric{display:grid;gap:6px}.ai-metric strong{font-size:16px}.ai-goals-grid{grid-template-columns:repeat(2,1fr)}.ai-goal-card h3{margin:0 0 10px}.ai-goal-card p{margin:6px 0;color:#5B4332;font-size:13px;line-height:1.7}.ai-chart-grid{grid-template-columns:repeat(3,1fr)}.ai-chart-box h3{margin:0 0 8px;font-size:14px}.ai-actions{display:flex;flex-wrap:wrap;gap:9px}.ai-actions a,.ai-actions button{background:#F7F3EA;color:#5B4332;border:1px solid rgba(216,174,99,.16)}.ai-actions a:hover,.ai-actions button:hover,.ai-chips button:hover{background:rgba(216,174,99,.14)}
        .ai-empty{text-align:center;padding:28px 16px;color:#9A6C3C}.ai-empty h3{margin:0 0 8px;color:#111}.ai-empty p{margin:0;line-height:1.7}.ai-toast{position:fixed;z-index:100;inset-inline-end:22px;bottom:22px;background:#111;color:#D8AE63;border:1px solid rgba(216,174,99,.28);border-radius:16px;padding:13px 16px;font:900 13px Tajawal,Arial,sans-serif;box-shadow:0 18px 45px rgba(45,26,10,.2)}.ai-loading{height:180px;display:grid;place-items:center;color:#9A6C3C;font-size:32px}
