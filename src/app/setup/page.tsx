  ...
  return (
    <div className="setup-page" dir={dir}>
      ...
      <style jsx>{`
        ...
        :global(.setup-page .progress-details li small){grid-area:state;color:var(--foreground-secondary);font-size:10px;font-weight:500}
        :global(.setup-page .progress-details li em){grid-area:badge;font-style:normal;border-radius:var(--radius-pill);background:var(--primary-soft);color:var(--primary-hover);font-size:10px;font-weight:600;padding:4px 7px;white-space:nowrap}
        ...
        .completion-summary-grid :global(.completion-summary-card p){margin:7px 0 0;color:var(--foreground-secondary);font-size:11px;font-weight:400;line-height:1.55}
