  ...
  if (!user) {
    return (
      <main className="setup-auth" dir={dir}>
        ...
        <style jsx>{`.setup-auth{min-height:100vh;display:grid;place-items:center;background:var(--sfm-background);font-family:Tajawal,Arial,sans-serif}.setup-auth section{width:min(480px,calc(100% - 32px));background:var(--sfm-card);border:1px solid rgba(29,140,255,.16);border-radius:var(--r-2xl);padding:24px;text-align:center}.setup-auth button{margin-top:16px;min-height:44px;border:0;border-radius:var(--r-md);background:var(--sfm-primary);color:var(--sfm-card);padding:0 18px;font-weight:900;cursor:pointer}`}</style>
      </main>
    );
  }
  ...
  return (
    <div className="setup-page" dir={dir}>
      ...
      <style jsx>{`
        ...
        .setup-card{background:rgba(255,255,255,.94);border:1px solid rgba(29,140,255,.16);border-radius:var(--r-2xl);padding:22px;box-shadow:0 20px 56px rgba(3,18,37,.10);min-width:0}
        ...
        .step-side{position:sticky;top:18px;align-self:start;background:linear-gradient(180deg,var(--sfm-light-card),#FFFFFF);border:1px solid rgba(29,140,255,.14);border-radius:var(--r-2xl);padding:18px;display:grid;gap:14px;box-shadow:0 12px 32px rgba(3,18,37,.06)}
        .step-side-head{display:grid;grid-template-columns:auto minmax(0,1fr);gap:12px;align-items:center}
        .step-side-head>span{width:48px;height:48px;border-radius:var(--r-lg);background:var(--sfm-midnight);color:var(--sfm-soft-cyan);display:grid;place-items:center;font-weight:950;font-size:18px}
        ...
        :global(.setup-page .progress-panel-head svg){width:38px;height:38px;border-radius:var(--r-md);background:rgba(24,212,212,.10);color:var(--sfm-primary);padding:9px}
        ...
        :global(.setup-page .progress-details summary){display:flex;align-items:center;justify-content:space-between;gap:10px;cursor:pointer;list-style:none;border:1px solid rgba(29,140,255,.12);background:#FFFFFF;border-radius:var(--r-md);padding:10px 11px;color:var(--sfm-midnight);font-weight:950}
        ...
        :global(.setup-page .progress-details li){display:grid;grid-template-columns:auto minmax(0,1fr) auto;grid-template-areas:"icon title badge" "icon state badge";gap:3px 9px;align-items:center;border:1px solid rgba(29,140,255,.10);background:#FFFFFF;border-radius:var(--r-md);padding:9px;min-width:0}
        ...
        .completion-summary-grid :global(.completion-summary-card){display:grid;grid-template-columns:auto minmax(0,1fr);gap:12px;align-items:start;border:1px solid rgba(29,140,255,.12);background:linear-gradient(180deg,#FFFFFF,#F8FBFF);border-radius:var(--r-xl);padding:15px;min-width:0;min-height:122px;box-shadow:0 12px 28px rgba(3,18,37,.055)}
        .completion-summary-grid :global(.summary-icon){width:42px;height:42px;border-radius:var(--r-lg);display:grid;place-items:center;background:rgba(29,140,255,.10);color:var(--sfm-primary);flex:0 0 auto}
        ...
        .financial-snapshot-card{display:grid;grid-template-columns:minmax(0,1fr) minmax(360px,0.95fr);gap:14px;align-items:center;border:1px solid rgba(29,140,255,.14);background:linear-gradient(135deg,#FFFFFF,#F8FBFF);border-radius:var(--r-2xl);padding:16px;box-shadow:0 12px 30px rgba(3,18,37,.055);min-width:0}
        ...
        .snapshot-metrics{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;min-width:0}.snapshot-metric{min-width:0;border:1px solid rgba(29,140,255,.10);background:#FFFFFF;border-radius:var(--r-lg);padding:12px;box-shadow:0 8px 18px rgba(3,18,37,.04)}.snapshot-metric.primary{border-color:rgba(24,212,212,.26);background:linear-gradient(135deg,rgba(24,212,212,.12),#FFFFFF)}.snapshot-metric small{display:block;color:var(--sfm-muted-readable);font-size:11px;font-weight:950;line-height:1.35}.snapshot-metric strong{display:block;margin-top:6px;color:var(--sfm-midnight);font-size:clamp(18px,2vw,23px);font-weight:950;line-height:1.16;overflow-wrap:anywhere;unicode-bidi:isolate}
        .recommendation-panel{display:grid;gap:12px;border:1px solid rgba(24,212,212,.22);background:linear-gradient(135deg,rgba(234,246,255,.96),rgba(24,212,212,.08));border-radius:var(--r-2xl);padding:16px;min-width:0;box-shadow:0 12px 30px rgba(3,18,37,.055)}
        .recommendation-head{display:grid;grid-template-columns:auto minmax(0,1fr);gap:10px;align-items:start}
        .recommendation-head>svg{width:38px;height:38px;border-radius:var(--r-md);background:var(--sfm-midnight);color:var(--sfm-soft-cyan);padding:9px}
        ...
        .recommendation-list article{display:grid;grid-template-columns:auto minmax(0,1fr);gap:9px;align-items:start;border:1px solid rgba(29,140,255,.10);background:#FFFFFF;border-radius:var(--r-md);padding:10px 12px;min-width:0}
        ...
        .recommendation-single{display:grid;grid-template-columns:auto minmax(0,1fr);gap:10px;align-items:start;border:1px solid rgba(29,140,255,.10);background:#FFFFFF;border-radius:var(--r-lg);padding:12px;min-width:0}.recommendation-single>svg{color:#10B981;margin-top:2px}.recommendation-single strong{display:block;color:var(--sfm-midnight);font-size:14px;line-height:1.55}.recommendation-single span{display:block;margin-top:4px;color:var(--sfm-muted-readable);font-size:12px;font-weight:850;line-height:1.55}
        .recommendation-surplus{display:flex;align-items:center;justify-content:space-between;gap:12px;border:1px solid rgba(16,185,129,.20);background:#ECFDF5;border-radius:var(--r-lg);padding:11px 13px;min-width:0}.recommendation-surplus small{color:#047857;font-size:12px;font-weight:950}.recommendation-surplus strong{color:#047857;font-size:clamp(18px,2vw,24px);font-weight:950;overflow-wrap:anywhere;unicode-bidi:isolate}
        .completion-actions{justify-content:flex-end;border-top:1px solid rgba(29,140,255,.10);padding-top:14px;margin-top:0}
        .completion-actions button{min-height:52px;border-radius:var(--r-lg);padding:0 18px;box-shadow:0 8px 20px rgba(3,18,37,.05)}
        ...
        .initial-report-modal{width:min(860px,100%);max-height:min(88dvh,860px);overflow:auto;background:#FFFFFF;border:1px solid rgba(29,140,255,.18);border-radius:var(--r-2xl);padding:18px;box-shadow:0 34px 90px rgba(3,18,37,.30);display:grid;gap:14px}
        .report-modal-head{display:flex;justify-content:space-between;align-items:flex-start;gap:14px}.report-modal-head span{display:block;color:var(--sfm-primary);font-size:12px;font-weight:950}.report-modal-head h3{margin:4px 0;color:var(--sfm-midnight);font-size:26px;font-weight:950}.report-modal-head p{margin:0;color:var(--sfm-muted-readable);line-height:1.7;font-weight:850}.report-modal-head button{width:40px;height:var(--control-h);border-radius:var(--r-md);border:1px solid rgba(29,140,255,.14);background:var(--sfm-light-card);color:var(--sfm-midnight);display:grid;place-items:center;cursor:pointer;flex:0 0 auto}
        .report-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.report-grid :global(.report-card){display:grid;grid-template-columns:auto minmax(0,1fr);gap:10px;border:1px solid rgba(29,140,255,.12);background:var(--sfm-light-card);border-radius:var(--r-lg);padding:13px;min-width:0}.report-grid :global(.report-card svg){width:38px;height:38px;border-radius:var(--r-md);background:rgba(29,140,255,.10);color:var(--sfm-primary);padding:9px}.report-grid :global(.report-card small){display:block;color:var(--sfm-muted-readable);font-weight:950}.report-grid :global(.report-card strong){display:block;margin-top:5px;color:var(--sfm-midnight);font-size:21px;font-weight:950;overflow-wrap:anywhere;unicode-bidi:isolate}.report-grid :global(.report-card p){margin:5px 0 0;color:var(--sfm-muted-readable);font-size:12px;font-weight:850;line-height:1.6}
        .report-recommendation{border:1px solid rgba(24,212,212,.20);background:rgba(24,212,212,.07);border-radius:var(--r-lg);padding:13px}.report-recommendation h4{margin:0 0 8px;color:var(--sfm-primary-dark);font-size:16px}.report-recommendation p{margin:6px 0 0;color:var(--sfm-midnight);font-weight:850;line-height:1.6}
        .report-actions{display:flex;justify-content:flex-end;gap:10px;flex-wrap:wrap}.report-actions button{min-height:44px;border-radius:var(--r-md);border:1px solid rgba(29,140,255,.18);background:var(--sfm-light-card);color:var(--sfm-midnight);padding:0 15px;font-weight:950;font-family:inherit;cursor:pointer}.report-actions button.primary{border:0;background:linear-gradient(135deg,var(--sfm-primary),var(--sfm-accent));color:#FFFFFF}.report-data-points{color:var(--sfm-muted-readable);font-weight:900}
        ...
        @media(max-width:720px){:global(.setup-page .sfm-dashboard-page-shell){padding-inline:16px!important}.setup-top{align-items:flex-start}.setup-hero{grid-template-columns:1fr;border-radius:var(--r-2xl);padding:20px}.setup-hero.finish-hero .progress-orb,.progress-orb{width:108px;height:108px}.setup-card{padding:14px;border-radius:var(--r-2xl)}.setup-card-final{padding:12px}.form-grid,.expense-grid,.summary-grid,.focus-grid,.setup-plan ul,.completion-summary-grid,.snapshot-metrics,.report-grid{grid-template-columns:1fr}.wizard-actions,.choice-row,.welcome-actions,.finish-actions,.report-actions{display:grid;grid-template-columns:1fr}.income-decision-actions{max-width:100%}.income-skip-link{width:100%;justify-content:center}.primary-btn,.ghost-btn,.choice-btn,.toggle-card,.finish-actions button,.income-action-btn,.report-actions button{width:100%;min-width:0}.income-decision-card{padding:22px 16px;border-radius:var(--r-2xl)}.income-decision-icon{width:68px;height:68px}.recurring-income-card{grid-template-columns:minmax(0,1fr) auto;align-items:start;padding:14px;border-radius:var(--r-xl)}.step-main{padding:14px;min-height:auto}.step-heading h2{font-size:22px}.completion-hero{grid-template-columns:1fr;text-align:center;justify-items:center;border-radius:var(--r-xl);padding:18px}.completion-copy h2{font-size:24px}.completion-summary-grid :global(.completion-summary-card){grid-template-columns:minmax(0,1fr);text-align:start}.financial-snapshot-card,.recommendation-panel{border-radius:var(--r-xl);padding:14px}.recommendation-head,.recommendation-single{grid-template-columns:minmax(0,1fr)}.recommendation-surplus{display:grid;justify-items:start}.report-modal-backdrop{align-items:end;padding:10px}.initial-report-modal{max-height:88dvh;border-radius:var(--r-2xl) var(--r-2xl) 0 0;padding:16px;padding-bottom:calc(16px + env(safe-area-inset-bottom))}.report-modal-head{display:grid}.report-modal-head button{justify-self:end}:global(.setup-page .progress-details ol){max-height:280px}:global(.setup-page .progress-details li){grid-template-columns:auto minmax(0,1fr);grid-template-areas:"icon title" "icon state" "icon badge"}:global(.setup-page .progress-details li em){justify-self:start}.report-grid :global(.report-card){grid-template-columns:minmax(0,1fr)}}
      `}</style>
    </div>
  );
  ...
  function renderStep() {
      ...
      return (
        <section className="step-panel">
          ...
          <div className="welcome-actions" style={{marginTop:'10px',display:'flex',alignItems:'center',gap:'14px',flexWrap:'wrap',minWidth:0}}>
            ...
            <button type="button" style={{minHeight:'48px',borderRadius:'var(--r-lg)',padding:'0 18px',background:'#FFFFFF',border:'1px solid rgba(29,140,255,.24)',color:'var(--sfm-midnight)',fontFamily:'Tajawal,Arial,sans-serif',fontWeight:950,cursor:'pointer',display:'inline-flex',alignItems:'center',justifyContent:'center',whiteSpace:'nowrap'}} onClick={skipSetup} disabled={saving}>
              {text.skipNow}
            </button>
          </div>
        </section>
          ...
          <div style={{display:'flex',gap:'12px',flexWrap:'wrap',marginTop:'8px'}}>
            {([
              ...
              <button key={label} type="button" onClick={toggle} aria-pressed={on}
                style={on ? {
                  minHeight:'48px',borderRadius:'var(--r-md)',padding:'0 22px',fontSize:'15px',
    ...
    return (
      <section className="step-panel completion-panel completion-dashboard completion-compact">
        <div style={{display:'grid',gridTemplateColumns:'auto minmax(0,1fr)',gap:'16px',alignItems:'center',border:'1px solid rgba(16,185,129,.2)',background:'linear-gradient(135deg,#F0FDF4,#FFFFFF 58%,#EAF6FF)',borderRadius:'var(--r-2xl)',padding:'20px 22px',boxShadow:'0 14px 34px rgba(3,18,37,.07)',minWidth:0}}>
        ...
        <section style={{display:"grid",gridTemplateColumns:"auto 1fr",gap:"18px",alignItems:"center",border:"1px solid rgba(29,140,255,.14)",background:"linear-gradient(180deg,#FFFFFF,#F4F9FF)",borderRadius:'var(--r-2xl)',padding:"20px 22px",boxShadow:"0 12px 30px rgba(3,18,37,.06)",minWidth:0}} aria-labelledby="setup-snapshot-title">
        ...
        <section style={{display:"grid",gap:"12px",border:"1px solid rgba(24,212,212,.22)",background:"rgba(24,212,212,.06)",borderRadius:'var(--r-xl)',padding:"18px 20px"}} aria-labelledby="setup-recommendation-title">
          ...
          <article style={{display:"grid",gridTemplateColumns:"auto 1fr",gap:"10px",alignItems:"start",background:"rgba(255,255,255,.7)",border:"1px solid rgba(24,212,212,.18)",borderRadius:'var(--r-md)',padding:"12px 14px"}}>
        ...
        <div style={{display:'flex',gap:'10px',flexWrap:'wrap',justifyContent:'flex-end',borderTop:'1px solid rgba(29,140,255,.10)',paddingTop:'14px',marginTop:'4px'}}>
          <button type="button" style={{minHeight:'52px',borderRadius:'var(--r-lg)',padding:'0 22px',border:0,background:'linear-gradient(135deg,var(--sfm-primary),var(--sfm-accent))',color:'#FFF',fontFamily:'Tajawal,Arial,sans-serif',fontWeight:950,fontSize:'15px',cursor:'pointer',display:'inline-flex',alignItems:'center',justifyContent:'center',gap:'8px',boxShadow:'0 16px 36px rgba(29,140,255,.22)',minWidth:'min(260px,100%)',whiteSpace:'nowrap'}} onClick={completeAndGoDashboard} disabled={saving}>
            {saving ? text.saving : text.goDashboard}
          </button>
          <button type="button" style={{minHeight:'52px',borderRadius:'var(--r-lg)',padding:'0 18px',border:'1px solid rgba(29,140,255,.24)',background:'#FFFFFF',color:'var(--sfm-midnight)',fontFamily:'Tajawal,Arial,sans-serif',fontWeight:950,cursor:'pointer',display:'inline-flex',alignItems:'center',justifyContent:'center',gap:'8px',whiteSpace:'nowrap'}} onClick={openMoreData}>{text.addMoreData}</button>
          <button type="button" style={{minHeight:'52px',borderRadius:'var(--r-lg)',padding:'0 18px',border:'1px solid rgba(29,140,255,.16)',background:'rgba(255,255,255,.62)',color:'var(--sfm-midnight)',fontFamily:'Tajawal,Arial,sans-serif',fontWeight:950,cursor:'pointer',display:'inline-flex',alignItems:'center',justifyContent:'center',gap:'8px',whiteSpace:'nowrap'}} onClick={() => setShowInitialReport(true)}>{text.viewInitialReport}</button>
        </div>
