      ...
      <style jsx global>{`
        ...
        .login-showcase:before{
          ...
          background:
            ...
            linear-gradient(0deg,color-mix(in srgb,var(--accent) 10%,transparent) 1px,transparent 1px);
        ...
        .showcase-brand img{
          ...
          height:56px;
          border-radius:var(--r-sm);
          filter:drop-shadow(0 10px 24px color-mix(in srgb,var(--shadow-color) 18%,transparent));
        }
        .showcase-copy{
          max-width:520px;
          display:grid;
        ...
        .visual-row{
          ...
          width:62%;
          border-radius:999px;
          background:linear-gradient(90deg,var(--accent),color-mix(in srgb,var(--primary) 44%,transparent));
        }
        ...
        .language-row .sfm-theme-toggle{width:40px;min-width:40px;height:40px;border-radius:var(--r-md)}
        .brand{text-align:center;display:flex;flex-direction:column;align-items:center;gap:7px}
        .brand h1{font-size:28px;line-height:1.15;font-weight:700;color:var(--foreground);margin:10px 0 0;letter-spacing:0}
        ...
        .sfm-brand-mark--auth{border-radius:var(--r-sm);box-shadow:var(--shadow-md);background:var(--hero-gradient-start)}
        .signup-steps{display:flex;gap:8px;justify-content:center;flex-wrap:wrap}
        .signup-steps span{display:flex;align-items:center;gap:6px;font-size:12px;font-weight:500;color:var(--foreground-muted);padding:7px 13px;border-radius:999px;border:1px solid var(--border);transition:all .2s}
        ...
        .eye-btn{position:absolute;inset-inline-end:10px;background:none;border:none;cursor:pointer;color:var(--foreground-muted);display:flex;align-items:center;padding:6px;border-radius:var(--r-sm)}
        ...
        .strength-bar span{flex:1;height:5px;border-radius:999px;background:var(--border);transition:background .2s}
        ...
        .country-select{height:var(--control-h-lg);border:1px solid var(--border-strong);border-radius:var(--r-sm);padding:0 14px;font:400 14px/1.5 var(--font-ui);color:var(--foreground);background:var(--control-background);outline:0;width:100%;cursor:pointer}
        .security-block{display:flex;flex-direction:column;gap:10px;padding:14px;background:var(--surface-muted);border-radius:var(--r-sm);border:1px solid var(--border)}
        ...
        .terms-error{border:1px solid var(--danger);border-radius:var(--r-sm);padding:6px 10px}
        .terms-error-msg{color:var(--danger);font-size:12px;font-weight:600;margin:0}
        .recovery-question-block{background:var(--warning-soft);border:1px solid color-mix(in srgb,var(--warning) 32%,var(--border));border-radius:var(--r-sm);padding:14px;display:flex;flex-direction:column;gap:10px}
        ...
        .auth-msg{font-size:13px;font-weight:850;margin:0;padding:10px 14px;border-radius:var(--r-sm);line-height:1.5}
        ...
        .submit-btn{height:var(--control-h-lg);border-radius:var(--r-sm);background:var(--primary);color:var(--primary-foreground);font:600 15px/1.4 var(--font-ui);border:1px solid var(--primary);cursor:pointer;transition:background-color .15s,transform .1s;width:100%;box-shadow:var(--shadow-xs)}
        ...
        .social-btn{display:flex;align-items:center;justify-content:center;gap:9px;height:var(--control-h);border:1px solid var(--border-strong);border-radius:var(--r-sm);background:var(--surface);color:var(--foreground);font:600 13px/1.4 var(--font-ui);cursor:pointer;transition:background .15s,border-color .15s;width:100%}
        ...
        @media(max-width:520px){
          ...
          .login-card{width:100%;max-width:none;min-width:0;padding:22px 16px;border-radius:var(--r-sm);gap:15px}
