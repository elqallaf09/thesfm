  ...
  return (
    <div className="income-shell" dir={dir}>
      ...
      <style jsx>{`
        ...
        .late-card{display:flex;align-items:center;justify-content:space-between;gap:12px;background:#FAEEDA;color:#854F0B;border:1px solid rgba(133,79,11,.16);border-radius:18px;padding:14px 16px}.late-card span{display:flex;align-items:center;gap:8px;font-weight:600}.late-card button,.upcoming-item button{border:1px solid rgba(133,79,11,.16);background:#fff7eb;color:#854F0B;border-radius:12px;min-height:38px;padding:0 12px;display:inline-flex;align-items:center;gap:7px;font:600 12px inherit;cursor:pointer}.upcoming-panel{display:grid;gap:10px}.upcoming-list{display:grid;gap:9px}.upcoming-item{display:grid;grid-template-columns:1fr auto auto;align-items:center;gap:10px;border:1px solid rgba(186,117,23,.14);border-radius:14px;padding:12px;background:#FBF7EE}.upcoming-item strong{display:block;color:#3D2914;font-weight:600}.upcoming-item span{display:block;margin-top:4px;color:#7b6248;font-size:12px}.upcoming-item em,.income-filters button{font-style:normal;border-radius:999px;background:#F5F1E8;color:#7b6248;padding:5px 10px;font-size:12px;white-space:nowrap}.upcoming-item .received{background:#EAF3DE;color:#27500A}.upcoming-item .pending,.upcoming-item .expected{background:#FAEEDA;color:#854F0B}.upcoming-item .late{background:#FCEBEB;color:#791F1F}.income-filters{display:flex;gap:8px;overflow-x:auto;padding:0 0 12px;margin-top:-4px;scrollbar-width:thin}.income-filters button{border:1px solid rgba(186,117,23,.14);cursor:pointer;font:600 12px inherit;background:#FBF7EE}.income-filters button.active{background:#3D2914;color:#fff;border-color:#3D2914}
        .income-list{display:grid;gap:10px}.income-row{display:flex;justify-content:space-between;gap:14px;border:1px solid rgba(186,117,23,.14);border-radius:16px;padding:14px;background:#FBF7EE}.row-main{display:flex;gap:12px;min-width:0}.row-icon{width:44px;height:44px;border-radius:14px;background:#FAEEDA;display:grid;place-items:center;font-size:21px}.row-main strong{display:block;font-size:15px;font-weight:600;color:#3D2914}.row-main span{display:block;margin-top:4px;color:#7b6248;font-size:12px}.row-meta{display:flex;flex-wrap:wrap;gap:6px;margin-top:9px}.row-meta em{font-style:normal;border-radius:999px;background:#F5F1E8;color:#7b6248;padding:4px 8px;font-size:11px;display:inline-flex;align-items:center;gap:4px}.row-meta .received{background:#EAF3DE;color:#27500A}.row-meta .pending,.row-meta .expected{background:#FAEEDA;color:#854F0B}.row-meta .late{background:#FCEBEB;color:#791F1F}.row-side{display:flex;align-items:center;gap:12px}.row-side b{white-space:nowrap;color:#3D2914}.row-side div{display:flex;gap:6px}.row-side button,.modal-head button,.mini-pop button{width:36px;height:36px;border-radius:11px;border:1px solid rgba(186,117,23,.16);background:#FFFDF8;color:#3D2914;display:grid;place-items:center;cursor:pointer}.empty{padding:24px;text-align:center;color:#7b6248;border:1px dashed rgba(186,117,23,.22);border-radius:14px;background:#FBF7EE}
        .modal-backdrop{position:fixed;inset:0;z-index:90;background:rgba(36,24,13,.42);display:grid;place-items:center;padding:18px}.income-modal{width:min(760px,100%);max-height:min(92dvh,900px);overflow:auto;background:#FFFDF8;border-radius:20px;border:1px solid rgba(186,117,23,.18);padding:20px}.modal-head{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:16px}.modal-head p{margin:0;color:#BA7517;font-size:12px}.modal-head h2{margin:4px 0 0;font-size:24px;color:#3D2914}.income-form{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:13px}.income-form label{display:grid;gap:7px;color:#3D2914;font-size:13px;font-weight:500}.income-form input,.income-form select,.income-form textarea{width:100%;border:1px solid rgba(186,117,23,.16);border-radius:12px;background:#F5F1E8;color:#3D2914;padding:0 12px;min-height:46px;font:500 14px inherit;outline:none}.income-form input[type=file]{padding:11px 12px}.income-form textarea{min-height:92px;padding-top:12px;resize:vertical}.income-form input:focus,.income-form select:focus,.income-form textarea:focus{border-color:#BA7517;box-shadow:0 0 0 3px rgba(186,117,23,.14);background:#FFFDF8}.wide,.form-actions,.form-error,.form-note,.attachment-field,.suggestion-pill{grid-column:1/-1}.suggestion-pill{display:flex;align-items:center;gap:8px;border:1px solid rgba(186,117,23,.18);border-radius:12px;background:#FAEEDA;color:#854F0B;padding:10px 12px;font-size:13px}.suggestion-pill button{margin-inline-start:auto;border:0;border-radius:10px;background:#3D2914;color:#fff;padding:7px 10px;font:600 12px inherit;cursor:pointer}.attachment-field{display:grid;gap:10px}.attachment-chip{display:flex;align-items:center;gap:8px;border:1px solid rgba(186,117,23,.16);border-radius:12px;background:#F5F1E8;color:#3D2914;padding:9px 10px;font-size:13px}.attachment-chip span{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.attachment-chip small{color:#7b6248;margin-inline-start:auto}.attachment-chip button{width:28px;height:28px;border-radius:9px;border:1px solid rgba(186,117,23,.16);background:#FFFDF8;color:#3D2914;display:grid;place-items:center;cursor:pointer}.toggle-line{align-content:end}.toggle{height:46px;border-radius:12px;border:1px solid rgba(186,117,23,.16);background:#F5F1E8;color:#3D2914;display:flex;align-items:center;gap:9px;padding:0 12px;cursor:pointer}.toggle span{width:20px;height:20px;border-radius:50%;background:#c9bea9}.toggle.on span{background:#BA7517}.form-actions{display:flex;justify-content:flex-end;gap:10px}.form-error{background:#FCEBEB;color:#791F1F;border-radius:12px;padding:10px 12px;font-size:13px}.form-note{background:#E6F1FB;color:#0C447C;border-radius:12px;padding:10px 12px;font-size:13px}
