          ...
          <head>
            ...
            <style>
              ...
              *{box-sizing:border-box}
              ...
              .stat{border:1px solid #d8e7f7;background:linear-gradient(135deg,#f8fbff,#eefaff);border-radius:16px;padding:14px;min-height:84px}.stat span{display:block;color:#64748b;font-size:12px;font-weight:900}.stat b{display:block;margin-top:7px;color:#061a2e;font-size:16px;font-weight:950;overflow-wrap:anywhere}
              h2{margin:18px 0 10px;color:#0b3558;font-size:15px;font-weight:950}.pill{border:1px solid #d8e7f7;background:#f8fbff;border-radius:14px;padding:12px;color:#334155;font-weight:850;overflow-wrap:anywhere}
              .table-wrap{border:1px solid #d8e7f7;border-radius:18px;overflow:hidden;margin-top:12px}table{width:100%;border-collapse:collapse;table-layout:fixed}th,td{border-bottom:1px solid #e3edf8;padding:11px 12px;text-align:start;font-size:11px;vertical-align:top;overflow-wrap:anywhere}th{background:#eef7ff;color:#0b3558;font-weight:950}.empty{text-align:center;color:#64748b;font-weight:850;padding:26px}
