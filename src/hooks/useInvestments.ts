  ...
  const add = useCallback(async (data: InvestmentInput) => {
    ...
    void recordAccountActivity(supabase, {
      ...
      metadata: {
        ...
        purchase_platform_id: next.purchasePlatformId || null,
        purchase_platform_type: next.purchasePlatformType || null,
      },
    }).catch(error => {
