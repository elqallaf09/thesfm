...
const TEXT = {
  ar: {
    ...
    high: 'جاهزية مرتفعة', medium: 'جاهزية متوسطة', low: 'جاهزية منخفضة', open: 'إكمال البيانات', saving: 'جاري الحفظ...',
    ...
    'trader:watchlist_missing': 'أضف أصولاً إلى قائمة المتابعة.', 'trader:alerts_missing': 'أضف تنبيهات سوقية حتى يفهم SFM ما تراقبه.', 'trader:portfolio_missing': 'أضف محفظتك الاستثمارية، أو أكد عدم وجود استثمارات.',
    'business:projects_missing': 'أضف مشروعاً واحداً على الأقل لتفعيل ذكاء الأعمال، أو أكد أنك لا تدير مشاريع حالياً.', 'business:funding_readiness_missing': 'أكمل بيانات جاهزية التمويل للمشاريع النشطة.',
  },
  en: {
    ...
    high: 'High readiness', medium: 'Medium readiness', low: 'Low readiness', open: 'Complete data', saving: 'Saving...',
    ...
    'trader:watchlist_missing': 'Add assets to your market watchlist.', 'trader:alerts_missing': 'Add market alerts so SFM knows what you actively monitor.', 'trader:portfolio_missing': 'Add your investment portfolio, or confirm that you have no investments.',
    'business:projects_missing': 'Add at least one project to activate Business intelligence, or confirm that you currently run no business projects.', 'business:funding_readiness_missing': 'Complete funding-readiness data for active projects.',
  },
  fr: {
    ...
    high: 'Préparation élevée', medium: 'Préparation moyenne', low: 'Préparation faible', open: 'Compléter les données', saving: 'Enregistrement...',
    ...
    'trader:watchlist_missing': 'Ajoutez des actifs à votre liste de suivi.', 'trader:alerts_missing': 'Ajoutez des alertes marché.', 'trader:portfolio_missing': 'Ajoutez votre portefeuille, ou confirmez que vous n’avez pas d’investissements.',
    'business:projects_missing': 'Ajoutez au moins un projet, ou confirmez que vous ne gérez actuellement aucun projet Business.', 'business:funding_readiness_missing': 'Complétez les données de préparation au financement.',
  },
} as const;
