...
const styles = `
  ...
  .load-warning{background:var(--warning-soft);border:1px solid var(--warning);color:var(--warning);border-radius:var(--radius-card);padding:12px 14px;font-weight:500;display:flex;align-items:center;justify-content:space-between;gap:12px;min-width:0}.load-warning div{display:grid;gap:4px;min-width:0}.load-warning strong,.load-warning span,.load-warning small{overflow-wrap:anywhere}.load-warning small{font-size:12px;color:var(--warning);font-weight:400}.load-warning button{border-color:var(--warning);background:var(--surface);color:var(--warning);white-space:nowrap}
  ...
  .severity{display:inline-flex;align-items:center;border:1px solid currentColor;border-radius:var(--radius-pill);padding:5px 9px;font-size:12px;font-weight:600;white-space:nowrap}.meta-row{display:flex;gap:7px;flex-wrap:wrap}.meta-row span{background:var(--surface-muted);border:1px solid var(--border);color:var(--foreground-muted);border-radius:var(--radius-pill);padding:5px 8px;font-size:12px;font-weight:500}
