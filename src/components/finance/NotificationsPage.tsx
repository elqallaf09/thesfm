...
const styles = `
  .notif-shell{min-height:100vh;background:#F5F1E8;color:#2B1A0F;font-family:Tajawal,Arial,sans-serif;overflow-x:hidden}
  ...
  .hero{background:linear-gradient(135deg,#1A0F05,#2B1A0F 58%,#8A5514 145%);color:#FFFDF8;border-radius:30px;padding:clamp(24px,5vw,44px);display:grid;grid-template-columns:minmax(0,1fr) auto;gap:18px;align-items:end;box-shadow:0 24px 80px rgba(43,26,15,.22);min-width:0;overflow:hidden}
  ...
  .toolbar{background:#FFFDF8;border:1px solid rgba(186,117,23,.14);border-radius:22px;padding:14px;display:grid;gap:12px;box-shadow:0 14px 38px rgba(43,26,15,.06);min-width:0;overflow:hidden}
  .search-field{display:flex;align-items:center;gap:8px;border:1px solid rgba(186,117,23,.18);background:#F7F3EA;border-radius:15px;padding:0 12px;min-height:44px;color:#8A5A20;min-width:0}.search-field input{width:100%;min-width:0;border:0;background:transparent;outline:0;color:#2B1A0F;font:900 13px Tajawal,Arial,sans-serif}
  .filters{display:flex;gap:8px;overflow-x:auto;max-width:100%;padding-bottom:2px;scrollbar-width:thin;overscroll-behavior-inline:contain}.filters button{flex:0 0 auto;border:1px solid rgba(186,117,23,.18);background:#FFF8EA;color:#5B4332;border-radius:999px;min-height:38px;padding:0 12px;font:950 12px Tajawal,Arial,sans-serif;cursor:pointer;white-space:nowrap}.filters button.active,.filters button:focus-visible{background:#2B1A0F;color:#FAC775;outline:none;box-shadow:0 0 0 3px rgba(239,159,39,.14)}
  .notification-list{display:grid;gap:18px;min-width:0}.group{display:grid;gap:10px;min-width:0}.group h2{margin:0;color:#3D2914;font-size:20px;font-weight:950}.cards{display:grid;gap:10px;min-width:0}
  .notice-card{display:grid;grid-template-columns:auto minmax(0,1fr);gap:12px;background:#FFFDF8;border:1px solid rgba(186,117,23,.14);border-radius:20px;padding:15px;box-shadow:0 14px 38px rgba(43,26,15,.06);min-width:0;max-width:100%;overflow:hidden}.notice-card.unread{border-color:rgba(186,117,23,.28);background:#FFF8EA}.notice-card.archived{opacity:.72;background:#F7F3EA}
