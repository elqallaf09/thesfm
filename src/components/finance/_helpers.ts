...
export const baseStyles = `
  ...
  .brand strong{display:block;font-size:15px}.brand span{display:block;font-size:12px;color:var(--sidebar-muted);margin-top:2px}
  nav{display:grid;gap:7px}nav button{display:flex;align-items:center;gap:10px;width:100%;border:0;background:transparent;color:var(--sidebar-muted);padding:11px 12px;border-radius:var(--radius-control);cursor:pointer;font:500 13px var(--font-ui);text-align:start}
  ...
  .title-wrap{display:flex;align-items:center;gap:13px}.title-wrap p{font-size:12px;color:var(--foreground-muted);font-weight:500;margin:0 0 3px}.title-wrap h1{font-size:24px;margin:0;font-weight:600}
  ...
  .icon-btn{width:40px;height:40px;border-radius:var(--radius-control);border:1px solid var(--border);background:var(--surface);color:var(--foreground-muted);display:grid;place-items:center;cursor:pointer}
  ...
  .eyebrow{display:inline-flex;padding:4px 10px;border-radius:var(--radius-pill);background:color-mix(in srgb,var(--accent) 15%,transparent);color:var(--accent);font-size:12px;font-weight:600;margin-bottom:12px}.hero h2{font-size:34px;line-height:1.05;margin:0 0 9px}.hero p{max-width:640px;margin:0;color:var(--hero-foreground-muted);line-height:1.8;font-size:14px}
...
export const expenseSmartStyles = `
  ...
  .expense-badges em{max-width:100%;overflow-wrap:anywhere;font-style:normal;border-radius:var(--radius-pill);padding:5px 9px;background:var(--surface-muted);color:var(--foreground-muted);border:1px solid var(--border);font-size:12px;font-weight:600}
  ...
  .expense-row-amount small{max-width:100%;color:var(--foreground-muted);font-size:12px;font-weight:600;line-height:1.3;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
  ...
  .monthly-grid span{display:block;color:var(--foreground-muted);font-size:12px;font-weight:600;margin-bottom:5px}
  ...
  .receipt-attach-copy em{width:fit-content;max-width:100%;font-style:normal;border-radius:var(--radius-pill);background:var(--accent-soft);border:1px solid var(--border);padding:5px 9px;color:var(--foreground);font-size:12px;font-weight:600;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
  ...
  .extracted-field-badge{border-radius:var(--radius-pill);background:var(--success-soft);border:1px solid color-mix(in srgb,var(--success) 20%,transparent);color:var(--success);padding:4px 8px;font-size:12px;font-weight:600}
  ...
  .receipt-candidate-panel button span{font-size:12px;color:var(--foreground-muted);font-weight:600}
  ...
  .receipt-detail-grid span{display:block;color:var(--foreground-muted);font-size:12px;font-weight:600;margin-bottom:5px}
