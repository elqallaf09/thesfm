  ...
  return (
    <section className="market-portfolio-card" aria-labelledby={`portfolio-comparison-${market}`}>
      ...
      <style jsx global>{`
        ...
        .market-portfolio-table-wrap{overflow-x:auto;border:1px solid var(--portfolio-border);border-radius:18px;background:rgba(255,255,255,.38)}.dark .market-portfolio-table-wrap{background:rgba(19,36,58,.42)}.market-portfolio-table{width:100%;min-width:920px;border-collapse:separate;border-spacing:0;font-size:12px;color:var(--portfolio-text)}.market-portfolio-table th,.market-portfolio-table td{padding:12px 13px;text-align:start;border-bottom:1px solid var(--portfolio-border);white-space:nowrap}.market-portfolio-table th{color:var(--portfolio-muted);font-weight:950;background:rgba(47,214,192,.06)}.market-portfolio-table td{font-weight:900}.market-portfolio-table tbody tr:hover{background:rgba(47,214,192,.06)}.market-portfolio-table tr:last-child td{border-bottom:0}.market-portfolio-symbol-cell{display:inline-flex;align-items:center;gap:8px;direction:ltr;unicode-bidi:isolate}.market-portfolio-mobile-list{display:none}.spinning{animation:portfolioSpin .9s linear infinite}
