...
export function PortfolioComparisonCard({ market, marketLabel, locale, t }: Props) {
  ...
  return (
    <section className="market-portfolio-card" aria-labelledby={`portfolio-comparison-${market}`}>
      ...
      <style jsx global>{`
        .market-portfolio-card{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-panel);padding:20px;box-shadow:var(--shadow-card);display:grid;gap:16px;min-width:0;overflow:hidden;color:var(--foreground)}
        .market-portfolio-head{display:flex;align-items:flex-start;justify-content:space-between;gap:14px;min-width:0}.market-portfolio-title{display:flex;align-items:flex-start;gap:13px;min-width:0}.market-portfolio-title>span{width:52px;height:52px;border-radius:var(--radius-card);display:grid;place-items:center;background:var(--accent-soft);border:1px solid var(--border);color:var(--accent);flex:0 0 auto}.market-portfolio-title h2{margin:0;color:var(--foreground);font-size:24px;font-weight:600;line-height:1.3}.market-portfolio-title p{margin:6px 0 0;color:var(--foreground-muted);font-size:13px;font-weight:400;line-height:1.7}.market-portfolio-actions{display:flex;align-items:center;gap:9px;flex-wrap:wrap;justify-content:flex-end}.market-portfolio-status{border-radius:var(--radius-pill);padding:7px 11px;font-size:11px;font-weight:500;border:1px solid var(--border);color:var(--foreground-muted);background:var(--surface-muted);white-space:nowrap}.market-portfolio-status.available{color:var(--success);background:var(--success-soft);border-color:var(--success)}.market-portfolio-actions button{min-height:40px;border-radius:var(--radius-control);border:1px solid var(--border);background:var(--accent-soft);color:var(--accent-hover);display:inline-flex;align-items:center;justify-content:center;gap:8px;padding:0 13px;font-family:var(--font-ui);font-size:12px;font-weight:600;cursor:pointer;transition:transform var(--duration-fast) ease,border-color var(--duration-fast) ease,background var(--duration-fast) ease}.market-portfolio-actions button:hover:not(:disabled){border-color:var(--accent);background:var(--sidebar-hover)}.market-portfolio-actions button:focus-visible{outline:2px solid var(--focus-ring);outline-offset:2px;box-shadow:var(--focus-shadow)}.market-portfolio-actions button:disabled{opacity:.65;cursor:not-allowed}.market-portfolio-context{display:flex;align-items:center;gap:10px;flex-wrap:wrap;border:1px solid var(--border);background:var(--surface-muted);border-radius:var(--radius-card);padding:11px 13px;color:var(--foreground-muted);font-size:12px;font-weight:500}.market-portfolio-context strong{color:var(--foreground)}.market-portfolio-context em{font-style:normal;color:var(--success)}.market-portfolio-loading,.market-portfolio-empty{display:grid;grid-template-columns:auto minmax(0,1fr);gap:12px;align-items:center;border:1px dashed var(--border-strong);border-radius:var(--radius-card);padding:18px;color:var(--foreground-muted);font-weight:500;line-height:1.7}.market-portfolio-loading span{width:26px;height:26px;border-radius:var(--radius-pill);border:3px solid var(--border);border-top-color:var(--accent);animation:portfolioSpin .9s linear infinite}.market-portfolio-empty svg{color:var(--accent)}.market-portfolio-empty strong{display:block;color:var(--foreground);font-size:16px;font-weight:600}.market-portfolio-empty p{margin:4px 0 0;color:var(--foreground-muted);font-size:13px;font-weight:400;line-height:1.7}@keyframes portfolioSpin{to{transform:rotate(360deg)}}
        .market-portfolio-identity{display:flex;align-items:center;justify-content:space-between;gap:14px;border:1px solid var(--border);border-radius:var(--radius-card);padding:15px;background:var(--surface-muted);min-width:0}.market-portfolio-identity div{min-width:0}.market-portfolio-identity span:not(.asset-avatar){display:inline-flex;width:max-content;border-radius:var(--radius-pill);background:var(--accent-soft);border:1px solid var(--border);color:var(--accent-hover);padding:6px 10px;font-family:var(--font-data);font-size:12px;font-weight:600}.market-portfolio-identity h3{margin:8px 0 0;color:var(--foreground);font-size:20px;font-weight:600;line-height:1.3;overflow-wrap:anywhere}.market-portfolio-identity p{margin:5px 0 0;color:var(--foreground-muted);font-size:12px;font-weight:400;line-height:1.6}.market-portfolio-risk,.market-portfolio-risk-chip{display:inline-flex;align-items:center;gap:7px;border-radius:var(--radius-pill);padding:7px 10px;font-size:12px;font-weight:600;white-space:nowrap;border:1px solid var(--border);color:var(--foreground-muted);background:var(--surface-muted)}.market-portfolio-risk.low,.market-portfolio-risk-chip.low{color:var(--success);background:var(--success-soft);border-color:var(--success)}.market-portfolio-risk.medium,.market-portfolio-risk-chip.medium{color:var(--warning);background:var(--warning-soft);border-color:var(--warning)}.market-portfolio-risk.high,.market-portfolio-risk-chip.high{color:var(--danger);background:var(--danger-soft);border-color:var(--danger)}
        .market-portfolio-metrics{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}.market-portfolio-metric{min-width:0;border:1px solid var(--border);border-radius:var(--radius-card);padding:13px;background:var(--surface-muted);display:grid;grid-template-columns:auto minmax(0,1fr);gap:10px;align-items:center}.market-portfolio-metric>span{width:38px;height:38px;border-radius:var(--radius-control);display:grid;place-items:center;background:var(--accent-soft);color:var(--accent);border:1px solid var(--border)}.market-portfolio-metric small{display:block;color:var(--foreground-muted);font-size:11px;font-weight:500;line-height:1.4}.market-portfolio-metric strong{display:block;margin-top:4px;color:var(--foreground);font-family:var(--font-data);font-size:16px;font-weight:600;line-height:1.35;overflow-wrap:anywhere}.market-portfolio-metric.success strong,.market-portfolio-table .success,.market-portfolio-mobile-list .success{color:var(--success)}.market-portfolio-metric.danger strong,.market-portfolio-table .danger,.market-portfolio-mobile-list .danger{color:var(--danger)}.market-portfolio-metric.unavailable strong{color:var(--foreground-muted)}
        .market-portfolio-table-wrap{overflow-x:auto;border:1px solid var(--border);border-radius:var(--radius-card);background:var(--surface)}.market-portfolio-table{width:100%;min-width:920px;border-collapse:separate;border-spacing:0;font-size:12px;color:var(--foreground)}.market-portfolio-table th,.market-portfolio-table td{padding:12px 13px;text-align:start;border-bottom:1px solid var(--border);white-space:nowrap}.market-portfolio-table th{color:var(--foreground-muted);font-weight:500;background:var(--surface-muted)}.market-portfolio-table td{font-weight:500}.market-portfolio-table td[dir="ltr"],.market-portfolio-symbol-cell{font-family:var(--font-data)}.market-portfolio-table tbody tr:hover{background:var(--sidebar-hover)}.market-portfolio-table tr:last-child td{border-bottom:0}.market-portfolio-symbol-cell{display:inline-flex;align-items:center;gap:8px;direction:ltr;unicode-bidi:isolate}.market-portfolio-mobile-list{display:none}.spinning{animation:portfolioSpin .9s linear infinite}
        @media(max-width:900px){.market-portfolio-head,.market-portfolio-identity{display:grid}.market-portfolio-actions{justify-content:flex-start}.market-portfolio-metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.market-portfolio-table-wrap{display:none}.market-portfolio-mobile-list{display:grid;gap:10px}.market-portfolio-mobile-list article{border:1px solid var(--border);border-radius:var(--radius-card);background:var(--surface-muted);padding:13px;display:grid;gap:11px}.market-portfolio-mobile-list article>div{display:grid;gap:4px}.market-portfolio-mobile-list strong{color:var(--foreground);font-size:15px;font-weight:600}.market-portfolio-mobile-list span{color:var(--foreground-muted);font-weight:400;line-height:1.5}.market-portfolio-mobile-list dl{margin:0;display:grid;grid-template-columns:1fr auto;gap:8px 12px}.market-portfolio-mobile-list dt{color:var(--foreground-muted);font-size:12px;font-weight:500}.market-portfolio-mobile-list dd{margin:0;color:var(--foreground);font-family:var(--font-data);font-size:12px;font-weight:600;text-align:end}}
        @media(max-width:640px){.market-portfolio-card{padding:15px;border-radius:var(--radius-card)}.market-portfolio-title h2{font-size:21px}.market-portfolio-title>span{width:46px;height:46px}.market-portfolio-actions,.market-portfolio-actions button{width:100%}.market-portfolio-status{width:100%;text-align:center}.market-portfolio-metrics{grid-template-columns:1fr}.market-portfolio-metric{padding:12px}.market-portfolio-context{display:grid}}
      `}</style>
    </section>
  );
}
