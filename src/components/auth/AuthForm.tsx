...
const FINANCIAL_WISDOM_TIPS = [
  ...
  { titleAr: 'لا تقارن نفسك بالناس', contentAr: 'ركز على خطتك لا على المظاهر.', titleEn: 'Do not compare yourself', contentEn: 'Focus on your plan, not appearances.', titleFr: 'Ne vous comparez pas', contentFr: 'Concentrez-vous sur votre plan, pas sur les apparences.' },
  { titleAr: 'ارفع دخلك بالمهارات', contentAr: 'تعلم البيع والتفاوض والإدارة.', titleEn: 'Grow income with skills', contentEn: 'Learn sales, negotiation, and management.', titleFr: 'Augmentez vos revenus', contentFr: 'Apprenez la vente, la négociation et la gestion.' },
...
export function AuthForm() {
  ...
  const t = {
    ...
    createNew: isArabic ? 'إنشاء حساب جديد' : isFrench ? 'Créer un nouveau compte' : 'Create new account',
    ...
    enterAnswer: isArabic ? 'أدخل إجابتك' : isFrench ? 'Entrez votre réponse' : 'Enter your answer',
    ...
    passwordMismatch: isArabic ? 'كلمة المرور وتأكيدها غير متطابقين' : isFrench ? 'Les mots de passe ne correspondent pas' : 'Password and confirm do not match',
    ...
    usernameRequired: isArabic ? 'اسم المستخدم مطلوب' : isFrench ? "Nom d'utilisateur requis" : 'Username is required',
    ...
    passwordRequired: isArabic ? 'كلمة المرور مطلوبة' : isFrench ? 'Mot de passe requis' : 'Password is required',
