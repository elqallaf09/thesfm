  ...
  return (
    <div className="europe-news-shell" dir={dir}>
      ...
      <style jsx global>{`
        ...
        .europe-ticker-strip{position:relative;z-index:2;display:block;width:100%;min-height:52px;border:1px solid var(--europe-border);background:linear-gradient(180deg,var(--europe-panel),var(--europe-panel-soft));border-radius:18px;overflow:hidden;box-shadow:0 16px 44px rgba(3,18,37,.12)}.europe-ticker-viewport{width:100%;overflow:hidden}.europe-ticker-track{width:max-content;display:flex;align-items:center;animation:europeTickerMarquee 42s linear infinite;will-change:transform}.europe-ticker-strip:hover .europe-ticker-track{animation-play-state:paused}.europe-ticker-set{display:flex;align-items:center;flex:0 0 auto}.europe-ticker-item{flex:0 0 auto;min-height:52px;display:flex;align-items:center;gap:9px;padding:0 16px;border-inline-end:1px solid var(--europe-border);white-space:nowrap}.europe-ticker-item strong{direction:ltr;unicode-bidi:isolate;color:var(--europe-accent);font-size:12px;font-weight:950}.europe-ticker-item span{color:var(--europe-text);font-size:12px;font-weight:950;max-width:230px;overflow:hidden;text-overflow:ellipsis}.europe-ticker-item b{direction:ltr;unicode-bidi:isolate;color:var(--europe-muted);font-size:12px;font-style:normal}.europe-ticker-item em{direction:ltr;unicode-bidi:isolate;display:inline-flex;align-items:center;gap:4px;border-radius:999px;padding:4px 7px;font-size:11px;font-weight:950;font-style:normal}.europe-ticker-item em.up{color:var(--europe-accent);background:rgba(47,214,192,.10)}.europe-ticker-item em.down{color:var(--europe-red);background:rgba(255,91,110,.10)}.europe-ticker-item em.neutral{color:var(--europe-muted);background:rgba(142,166,195,.10)}@keyframes europeTickerMarquee{from{transform:translateX(0)}to{transform:translateX(-50%)}}
        ...
        @media(max-width:720px){.europe-news-main{padding-inline:14px}.europe-news-header{display:grid}.europe-news-header-actions{justify-content:flex-start}.europe-news-title-icon{width:50px;height:50px}.europe-news-header h1{font-size:29px}.europe-news-market-grid,.europe-news-summary{grid-template-columns:1fr}.europe-news-summary-market{justify-items:start;min-width:0}.europe-news-summary-market p{text-align:start}.europe-news-card,.europe-news-search{border-radius:18px}.europe-news-meta{display:grid;gap:8px}.europe-ticker-strip{margin-inline:-2px}.europe-ticker-viewport{overflow-x:auto;scrollbar-width:thin}.europe-ticker-track{animation:none}.europe-ticker-set[aria-hidden="true"]{display:none}.europe-ticker-item span{max-width:210px}}
