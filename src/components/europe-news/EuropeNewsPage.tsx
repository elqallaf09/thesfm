  ...
  return (
    <NewsPageShell category="europe" className="europe-news-shell" dir={dir} wide>
      ...
      <style jsx global>{`
        ...
        .europe-news-main{box-sizing:border-box;width:100%;display:grid;gap:18px;overflow-x:hidden}
        ...
        @media(max-width:1024px){.europe-news-header{align-items:flex-start}.europe-news-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
        @media(max-width:720px){.europe-news-header{display:grid}.europe-news-header-actions{justify-content:flex-start}.europe-news-title-icon{width:50px;height:50px}.europe-news-header h1{font-size:29px}.europe-news-market-grid,.europe-news-summary,.europe-news-grid{grid-template-columns:1fr}.europe-news-summary-market{justify-items:start;min-width:0}.europe-news-summary-market p{text-align:start}.europe-news-card,.europe-news-search{border-radius:var(--r-xl)}.europe-news-meta{display:grid;gap:8px}.europe-ticker-strip{margin-inline:-2px}.europe-ticker-viewport{overflow-x:auto;scrollbar-width:thin;overscroll-behavior-inline:contain;-webkit-overflow-scrolling:touch}.europe-ticker-item span{max-width:210px}}
