...
export function EuropeNewsPage() {
  ...
  const load = useCallback(async (showLoader = true) => {
    ...
    setError('');
    try {
      const response = await fetch('/api/europe-news');
