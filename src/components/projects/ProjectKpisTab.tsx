...
export function ProjectKpisTab({
  ...
  return (
    <section className="project-kpis-tab" role="tabpanel" aria-label={t.kpis}>
      ...
      <style jsx global>{`
        .project-kpis-tab{display:grid;gap:16px;min-width:0}.kpi-health-card,.kpi-card,.kpi-empty-note{background:var(--sfm-card);border:1px solid rgba(29,140,255,.16);border-radius:var(--r-xl);padding:18px;box-shadow:0 14px 34px rgba(3,18,37,.07);min-width:0}.kpi-health-card{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:18px;align-items:center;background:radial-gradient(circle at 12% 10%,rgba(167,243,240,.26),transparent 30%),linear-gradient(135deg,var(--sfm-deep-navy),var(--sfm-primary-dark) 58%,var(--sfm-card-dark) 140%);color:var(--sfm-card)}.health-score-ring{width:118px;height:118px;border-radius:50%;display:grid;place-items:center;background:conic-gradient(var(--sfm-soft-cyan) var(--score-angle,0deg),rgba(234,246,255,.16) 0);box-shadow:inset 0 0 0 12px rgba(3,18,37,.92)}.health-score-ring strong{font-size:30px;color:var(--sfm-card)}.health-score-ring span{font-size:12px;color:var(--sfm-soft-cyan);font-weight:900}.health-copy span,.health-loading{color:var(--sfm-soft-cyan);font-weight:950;font-size:12px}.health-copy h2{margin:6px 0;color:var(--sfm-card);font-size:28px}.health-copy p{margin:0;color:rgba(234,246,255,.78);line-height:1.7}.health-copy small{display:block;margin-top:8px;color:rgba(234,246,255,.62);line-height:1.6}.kpi-empty-note,.kpi-hint{color:var(--sfm-muted);line-height:1.7;font-weight:900}.kpi-section-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.financial-kpi-card{grid-column:1 / -1}.kpi-section-title{display:flex;justify-content:space-between;align-items:center;gap:12px;margin-bottom:14px}.kpi-section-title h2{margin:0;color:var(--sfm-midnight);font-size:19px}.kpi-section-title svg{color:var(--sfm-primary)}.kpi-metric-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.kpi-metric-grid.compact{grid-template-columns:repeat(2,minmax(0,1fr))}.kpi-metric,.comparison-item{border:1px solid rgba(29,140,255,.12);background:var(--sfm-light-card);border-radius:var(--r-lg);padding:12px;min-width:0}.kpi-metric small,.comparison-item small{display:block;color:var(--sfm-muted);font-weight:900}.kpi-metric strong,.comparison-item strong{display:block;margin-top:6px;color:var(--sfm-primary-dark);font-size:18px;overflow-wrap:anywhere}.progress-row{display:grid;gap:8px;margin-top:12px}.progress-label{display:flex;justify-content:space-between;gap:12px;color:var(--sfm-muted);font-weight:900}.progress-track{height:11px;border-radius:999px;background:rgba(29,140,255,.10);overflow:hidden}.progress-track span{display:block;height:100%;border-radius:999px;background:linear-gradient(90deg,var(--sfm-soft-cyan),var(--sfm-primary))}.kpi-warning{margin-top:14px;border:1px solid rgba(179,38,30,.18);background:#FEF2F2;color:#B91C1C;border-radius:var(--r-md);padding:11px 12px;font-weight:900;display:flex;align-items:center;gap:8px}.actual-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.comparison-values{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:10px}.comparison-values div{border-radius:var(--r-md);background:var(--sfm-card);padding:9px}.risk-flag-list{display:flex;flex-wrap:wrap;gap:8px}.risk-flag{display:inline-flex;border-radius:999px;background:#FEF2F2;color:#B91C1C;border:1px solid rgba(179,38,30,.16);padding:7px 11px;font-size:12px;font-weight:950}.kpi-health-card.strong .health-score-ring{background:conic-gradient(#A6D785 var(--score-angle,0deg),rgba(234,246,255,.16) 0)}.kpi-health-card.good .health-score-ring{background:conic-gradient(var(--sfm-soft-cyan) var(--score-angle,0deg),rgba(234,246,255,.16) 0)}.kpi-health-card.high_risk .health-score-ring{background:conic-gradient(#FF8A80 var(--score-angle,0deg),rgba(234,246,255,.16) 0)}@media(max-width:1180px){.kpi-section-grid{grid-template-columns:1fr}.kpi-metric-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:760px){.kpi-health-card{grid-template-columns:1fr;text-align:start}.health-score-ring{width:102px;height:102px}.kpi-metric-grid,.kpi-metric-grid.compact,.actual-grid,.comparison-values{grid-template-columns:1fr}.kpi-card,.kpi-health-card{padding:16px}.risk-flag-list{display:grid}}
      `}</style>
    </section>
  );
}
