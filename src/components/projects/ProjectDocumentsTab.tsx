...
export function ProjectDocumentsTab({
  ...
  return (
    <section className="project-documents-tab" role="tabpanel" aria-label={t.documentVault}>
      ...
      <style jsx global>{`
        .project-documents-tab{display:grid;gap:16px;min-width:0}.documents-hero-card,.documents-tools-card,.project-document-card,.documents-empty{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-card);padding:18px;box-shadow:var(--shadow-card);min-width:0}.documents-hero-card{display:flex;justify-content:space-between;align-items:center;gap:16px;background:var(--primary-soft);color:var(--foreground)}.documents-hero-card span{color:var(--foreground-muted);font-size:12px;font-weight:600}.documents-hero-card h2{margin:6px 0;color:var(--foreground);font-size:26px}.documents-hero-card p{margin:0;color:var(--foreground-muted);line-height:1.75;max-width:720px}.documents-hero-card button,.documents-primary-btn{min-height:44px;border:0;border-radius:var(--radius-control);background:var(--primary);color:var(--primary-foreground);padding:0 16px;font-family:inherit;font-weight:600;display:inline-flex;align-items:center;justify-content:center;gap:8px;cursor:pointer;white-space:nowrap}.documents-notice{border:1px solid var(--border-strong);background:var(--surface-muted);color:var(--foreground);border-radius:var(--radius-card);padding:12px 14px;font-weight:600}.documents-tools-card{display:grid;grid-template-columns:minmax(0,1fr) minmax(220px,.28fr);gap:12px;align-items:end}.document-search-field,.document-filter-field,.documents-field{display:grid;gap:7px;min-width:0}.document-search-field{position:relative}.document-search-field svg{position:absolute;inset-inline-start:12px;top:50%;transform:translateY(-50%);color:var(--primary)}.document-search-field input{padding-inline-start:38px}.document-search-field input,.document-filter-field select,.documents-field input,.documents-field textarea,.documents-field select{width:100%;min-width:0;border:1px solid var(--border-strong);background:var(--surface);color:var(--foreground);border-radius:var(--radius-control);padding:11px 12px;font-family:inherit;font-weight:500;outline:none}.document-filter-field span,.documents-field span{font-weight:600;color:var(--foreground-muted)}.documents-field textarea{resize:vertical;line-height:1.6}.document-search-field input:focus,.document-filter-field select:focus,.documents-field input:focus,.documents-field textarea:focus,.documents-field select:focus,.documents-hero-card button:focus-visible,.document-card-actions button:focus-visible,.documents-modal-heading button:focus-visible,.documents-modal-actions button:focus-visible{outline:none;border-color:var(--accent);box-shadow:var(--focus-shadow)}.documents-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;min-width:0}.documents-empty{grid-column:1 / -1;display:grid;place-items:center;text-align:center;min-height:180px;color:var(--foreground-muted);font-weight:600}.documents-empty svg{color:var(--primary)}.project-document-card{display:grid;gap:14px}.document-card-heading{display:grid;grid-template-columns:auto minmax(0,1fr);gap:12px;align-items:center}.document-file-icon{width:46px;height:46px;border-radius:var(--radius-card);background:var(--surface-muted);color:var(--primary);display:grid;place-items:center;border:1px solid var(--border)}.document-card-heading h3{margin:0;color:var(--foreground);font-size:18px;overflow-wrap:anywhere}.document-card-heading span{display:inline-flex;margin-top:7px;border-radius:var(--radius-pill);background:var(--primary-soft);color:var(--primary-hover);padding:4px 9px;font-size:12px;font-weight:600}.document-meta-list{display:grid;gap:8px;margin:0}.document-meta-list div{display:grid;grid-template-columns:minmax(90px,.34fr) minmax(0,1fr);gap:10px;border-bottom:1px solid var(--primary-soft);padding-bottom:8px}.document-meta-list dt{color:var(--foreground-muted);font-weight:600}.document-meta-list dd{margin:0;color:var(--foreground);font-weight:600;overflow-wrap:anywhere}.document-notes{margin:0;color:var(--foreground-muted);line-height:1.65}.document-card-actions{display:flex;flex-wrap:wrap;gap:7px}.document-card-actions button{min-height:36px;border:1px solid var(--border);border-radius:var(--radius-control);background:var(--surface-muted);color:var(--foreground);padding:0 10px;font-family:inherit;font-weight:600;display:inline-flex;align-items:center;gap:6px;cursor:pointer}.document-card-actions button:hover{background:var(--primary-soft)}.documents-modal-backdrop{position:fixed;inset:0;z-index:150;background:var(--background-overlay);display:grid;place-items:center;padding:18px}.documents-modal{width:min(720px,100%);max-height:min(86dvh,800px);overflow:auto;background:var(--surface);border:1px solid var(--border-strong);border-radius:var(--radius-panel);padding:18px;box-shadow:var(--shadow-popover)}.documents-modal-heading{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px}.documents-modal-heading h2{margin:0;color:var(--foreground)}.documents-modal-heading button{width:38px;height:var(--control-h-sm);border:1px solid var(--border);border-radius:var(--radius-control);background:var(--surface-muted);color:var(--foreground);display:grid;place-items:center;cursor:pointer}.documents-modal-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.documents-field.wide,.selected-document-file.wide{grid-column:1 / -1}.selected-document-file{display:grid;grid-template-columns:auto minmax(0,1fr) auto auto;gap:9px;align-items:center;border:1px solid var(--border);background:var(--surface-muted);border-radius:var(--radius-control);padding:10px;color:var(--foreground);font-weight:600}.selected-document-file svg{color:var(--primary)}.selected-document-file span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.selected-document-file small{color:var(--foreground-muted);font-weight:600}.selected-document-file button{width:30px;height:var(--control-h-sm);border:1px solid var(--border);border-radius:var(--radius-sm);background:var(--surface);color:var(--foreground);display:grid;place-items:center;cursor:pointer}.documents-modal-actions{display:flex;justify-content:flex-end;gap:10px;margin-top:16px}.documents-modal-actions button{min-height:42px;border:1px solid var(--border);border-radius:var(--radius-control);background:var(--surface-muted);color:var(--foreground);padding:0 14px;font-family:inherit;font-weight:600;display:inline-flex;align-items:center;gap:8px;cursor:pointer}.documents-modal-actions .documents-primary-btn{border:0;background:var(--primary);color:var(--primary-foreground)}.documents-primary-btn:disabled{opacity:.66;cursor:not-allowed}@media(max-width:1180px){.documents-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:760px){.documents-hero-card{display:grid}.documents-hero-card button{width:100%}.documents-tools-card,.documents-grid,.documents-modal-grid{grid-template-columns:1fr}.documents-modal-backdrop{align-items:end;padding:10px}.documents-modal{max-height:88dvh;border-radius:var(--radius-card) var(--radius-card) 0 0}.documents-modal-actions{display:grid;grid-template-columns:1fr}.documents-modal-actions button{width:100%;justify-content:center}.document-meta-list div{grid-template-columns:1fr}.document-card-actions{display:grid;grid-template-columns:1fr}.document-card-actions button{width:100%;justify-content:center}.selected-document-file{grid-template-columns:auto minmax(0,1fr) auto}.selected-document-file small{grid-column:2 / 3}}
      `}</style>
    </section>
  );
}
