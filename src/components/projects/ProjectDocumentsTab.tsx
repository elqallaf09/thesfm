...
export function ProjectDocumentsTab({
  ...
  return (
    <section className="project-documents-tab" role="tabpanel" aria-label={t.documentVault}>
      ...
      <style jsx global>{`
        .project-documents-tab{display:grid;gap:16px;min-width:0}.documents-hero-card,.documents-tools-card,.project-document-card,.documents-empty{background:#FFFDF8;border:1px solid rgba(186,117,23,.16);border-radius:20px;padding:18px;box-shadow:0 14px 34px rgba(61,41,20,.07);min-width:0}.documents-hero-card{display:flex;justify-content:space-between;align-items:center;gap:16px;background:radial-gradient(circle at 12% 0%,rgba(250,199,117,.32),transparent 28%),linear-gradient(135deg,#2B1A0F,#3D2914 60%,#8A5514 138%);color:#FFFDF8}.documents-hero-card span{color:#FAC775;font-size:12px;font-weight:950}.documents-hero-card h2{margin:6px 0;color:#FFFDF8;font-size:26px}.documents-hero-card p{margin:0;color:rgba(255,253,248,.78);line-height:1.75;max-width:720px}.documents-hero-card button,.documents-primary-btn{min-height:44px;border:0;border-radius:14px;background:linear-gradient(135deg,#FAC775,#EF9F27);color:#251407;padding:0 16px;font-family:inherit;font-weight:950;display:inline-flex;align-items:center;justify-content:center;gap:8px;cursor:pointer;white-space:nowrap}.documents-notice{border:1px solid rgba(186,117,23,.2);background:#FFF8EA;color:#3D2914;border-radius:15px;padding:12px 14px;font-weight:900}.documents-tools-card{display:grid;grid-template-columns:minmax(0,1fr) minmax(220px,.28fr);gap:12px;align-items:end}.document-search-field,.document-filter-field,.documents-field{display:grid;gap:7px;min-width:0}.document-search-field{position:relative}.document-search-field svg{position:absolute;inset-inline-start:12px;top:50%;transform:translateY(-50%);color:#BA7517}.document-search-field input{padding-inline-start:38px}.document-search-field input,.document-filter-field select,.documents-field input,.documents-field textarea,.documents-field select{width:100%;min-width:0;border:1px solid rgba(186,117,23,.2);background:#FFFDF8;color:#1A1A1A;border-radius:13px;padding:11px 12px;font-family:inherit;font-weight:800;outline:none}.document-filter-field span,.documents-field span{font-weight:900;color:#5B4332}.documents-field textarea{resize:vertical;line-height:1.6}.document-search-field input:focus,.document-filter-field select:focus,.documents-field input:focus,.documents-field textarea:focus,.documents-field select:focus,.documents-hero-card button:focus-visible,.document-card-actions button:focus-visible,.documents-modal-heading button:focus-visible,.documents-modal-actions button:focus-visible{outline:none;border-color:#EF9F27;box-shadow:0 0 0 3px rgba(239,159,39,.15)}.documents-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px;min-width:0}.documents-empty{grid-column:1 / -1;display:grid;place-items:center;text-align:center;min-height:180px;color:#7A6A55;font-weight:900}.documents-empty svg{color:#BA7517}.project-document-card{display:grid;gap:14px}.document-card-heading{display:grid;grid-template-columns:auto minmax(0,1fr);gap:12px;align-items:center}.document-file-icon{width:46px;height:46px;border-radius:15px;background:#FFF8EA;color:#BA7517;display:grid;place-items:center;border:1px solid rgba(186,117,23,.12)}.document-card-heading h3{margin:0;color:#2B1A0F;font-size:18px;overflow-wrap:anywhere}.document-card-heading span{display:inline-flex;margin-top:7px;border-radius:999px;background:#FAEEDA;color:#854F0B;padding:4px 9px;font-size:12px;font-weight:950}.document-meta-list{display:grid;gap:8px;margin:0}.document-meta-list div{display:grid;grid-template-columns:minmax(90px,.34fr) minmax(0,1fr);gap:10px;border-bottom:1px solid rgba(186,117,23,.08);padding-bottom:8px}.document-meta-list dt{color:#7A6A55;font-weight:900}.document-meta-list dd{margin:0;color:#2B1A0F;font-weight:900;overflow-wrap:anywhere}.document-notes{margin:0;color:#5B4332;line-height:1.65}.document-card-actions{display:flex;flex-wrap:wrap;gap:7px}.document-card-actions button{min-height:36px;border:1px solid rgba(186,117,23,.16);border-radius:11px;background:#FFF8EA;color:#3D2914;padding:0 10px;font-family:inherit;font-weight:900;display:inline-flex;align-items:center;gap:6px;cursor:pointer}.document-card-actions button:hover{background:#FAEEDA}.documents-modal-backdrop{position:fixed;inset:0;z-index:150;background:rgba(26,15,5,.48);display:grid;place-items:center;padding:18px}.documents-modal{width:min(720px,100%);max-height:min(86dvh,800px);overflow:auto;background:#FFFDF8;border:1px solid rgba(186,117,23,.2);border-radius:22px;padding:18px;box-shadow:0 24px 70px rgba(26,15,5,.25)}.documents-modal-heading{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px}.documents-modal-heading h2{margin:0;color:#3D2914}.documents-modal-heading button{width:38px;height:38px;border:1px solid rgba(186,117,23,.16);border-radius:12px;background:#FFF8EA;color:#3D2914;display:grid;place-items:center;cursor:pointer}.documents-modal-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.documents-field.wide,.selected-document-file.wide{grid-column:1 / -1}.selected-document-file{display:grid;grid-template-columns:auto minmax(0,1fr) auto auto;gap:9px;align-items:center;border:1px solid rgba(186,117,23,.14);background:#FFF8EA;border-radius:14px;padding:10px;color:#3D2914;font-weight:900}.selected-document-file svg{color:#BA7517}.selected-document-file span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.selected-document-file small{color:#7A6A55;font-weight:900}.selected-document-file button{width:30px;height:30px;border:1px solid rgba(186,117,23,.16);border-radius:10px;background:#FFFDF8;color:#3D2914;display:grid;place-items:center;cursor:pointer}.documents-modal-actions{display:flex;justify-content:flex-end;gap:10px;margin-top:16px}.documents-modal-actions button{min-height:42px;border:1px solid rgba(186,117,23,.18);border-radius:13px;background:#FFF8EA;color:#3D2914;padding:0 14px;font-family:inherit;font-weight:950;display:inline-flex;align-items:center;gap:8px;cursor:pointer}.documents-modal-actions .documents-primary-btn{border:0;background:linear-gradient(135deg,#FAC775,#EF9F27);color:#251407}.documents-primary-btn:disabled{opacity:.66;cursor:not-allowed}@media(max-width:1180px){.documents-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:760px){.documents-hero-card{display:grid}.documents-hero-card button{width:100%}.documents-tools-card,.documents-grid,.documents-modal-grid{grid-template-columns:1fr}.documents-modal-backdrop{align-items:end;padding:10px}.documents-modal{max-height:88dvh;border-radius:20px 20px 0 0}.documents-modal-actions{display:grid;grid-template-columns:1fr}.documents-modal-actions button{width:100%;justify-content:center}.document-meta-list div{grid-template-columns:1fr}.document-card-actions{display:grid;grid-template-columns:1fr}.document-card-actions button{width:100%;justify-content:center}.selected-document-file{grid-template-columns:auto minmax(0,1fr) auto}.selected-document-file small{grid-column:2 / 3}}
      `}</style>
    </section>
  );
}
