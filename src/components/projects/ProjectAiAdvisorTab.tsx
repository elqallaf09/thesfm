...
export function ProjectAiAdvisorTab({ projectId, lang, onNavigateTab }: Props) {
  ...
  return (
    <section className="project-ai-advisor" dir={isRtl ? 'rtl' : 'ltr'} aria-label={t.aiAdvisor}>
      ...
      <style jsx>{`
        .project-ai-advisor{display:grid;gap:16px;min-width:0;text-align:start}.ai-status-card,.ai-card,.ai-disclaimer{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-card);box-shadow:var(--shadow-card);min-width:0}.ai-status-card{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:16px;align-items:start;padding:20px;background:var(--primary-soft);color:var(--foreground);overflow:visible}.ai-status-icon{width:58px;height:58px;min-width:58px;border-radius:var(--radius-card);background:var(--surface-muted);display:grid;place-items:center;color:var(--foreground-muted)}.ai-status-copy,.ai-source-stack,.ai-card,.chat-answer,.chip-list,.report-section{min-width:0}.ai-status-copy span,.ai-source-badge{color:var(--foreground-muted);font-weight:600;font-size:12px;line-height:1.5}.ai-status-copy h2{margin:6px 0;color:var(--foreground);font-size:26px;line-height:1.35;overflow-wrap:anywhere;white-space:normal}.ai-status-copy p{margin:0;color:var(--foreground-muted);line-height:1.8;overflow-wrap:anywhere;white-space:normal}.ai-status-copy small{display:block;margin-top:8px;color:var(--foreground-muted);line-height:1.75;overflow-wrap:anywhere}.ai-source-stack{display:grid;gap:8px;justify-items:end;align-content:start}.ai-status-badge,.ai-source-badge{max-width:100%;border-radius:var(--radius-pill);padding:8px 12px;font-weight:600;font-size:12px;line-height:1.35;white-space:normal;text-align:center}.ai-status-badge.strong{background:var(--success-soft);color:var(--success)}.ai-status-badge.needs_review,.ai-status-badge.incomplete{background:var(--warning-soft);color:var(--warning)}.ai-status-badge.high_risk{background:var(--danger-soft);color:var(--danger)}.ai-toolbar{display:flex;flex-wrap:wrap;gap:10px}.ai-toolbar button,.missing-item button,.ask-row button{min-height:44px;border-radius:var(--radius-control);border:1px solid var(--border);background:var(--surface);color:var(--foreground);padding:8px 14px;display:inline-flex;align-items:center;justify-content:center;gap:8px;font-family:inherit;font-weight:600;line-height:1.35;cursor:pointer;white-space:normal;text-align:center}.ai-toolbar button svg,.missing-item button svg,.ask-row button svg{flex:0 0 auto}.ai-toolbar button.primary,.ask-row button{background:var(--primary);color:var(--primary-foreground);border:0}.ai-toolbar button.disabled{cursor:not-allowed;color:var(--foreground-muted);background:var(--surface-muted)}.ai-toolbar button:focus-visible,.missing-item button:focus-visible,.ask-row button:focus-visible{outline:none;box-shadow:var(--focus-shadow)}.ai-toolbar button:disabled,.ask-row button:disabled{opacity:.65;cursor:not-allowed}.spin{animation:spin 1s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}.ai-error{border:1px solid var(--danger-soft);background:var(--danger-soft);color:var(--danger);border-radius:var(--radius-control);padding:12px;font-weight:600;line-height:1.7;overflow-wrap:anywhere}.ai-live-region{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0 0 0 0)}.ai-main-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.ai-card{padding:18px;display:grid;gap:14px;align-content:start;overflow:visible}.section-title{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;min-width:0}.section-title h2{margin:0;color:var(--foreground);font-size:19px;line-height:1.45;overflow-wrap:anywhere}.section-title svg{color:var(--primary);flex:0 0 auto;margin-top:2px}.risk-list,.action-list,.plan-list,.missing-list,.report-grid{display:grid;gap:10px;min-width:0}.risk-item,.action-item,.plan-period,.missing-item,.report-section{border:1px solid var(--border);background:var(--surface-muted);border-radius:var(--radius-card);padding:12px;min-width:0;overflow:visible}.risk-item span,.action-item span{display:inline-flex;border-radius:var(--radius-pill);padding:5px 9px;font-size:12px;font-weight:600;line-height:1.35}.risk-item.low span,.action-item.low span{background:var(--success-soft);color:var(--success)}.risk-item.medium span,.action-item.medium span{background:var(--warning-soft);color:var(--warning)}.risk-item.high span,.action-item.high span{background:var(--danger-soft);color:var(--danger)}.risk-item h3,.action-item h3,.plan-period h3,.missing-item h3,.report-section h3{margin:8px 0 6px;color:var(--foreground);font-size:16px;line-height:1.45;overflow-wrap:anywhere}.risk-item p,.action-item p,.missing-item p,.report-section p,.ai-empty{margin:0;color:var(--foreground-muted);line-height:1.8;overflow-wrap:anywhere;white-space:normal}.risk-item strong,.action-item small{display:block;margin-top:8px;color:var(--foreground);line-height:1.75;overflow-wrap:anywhere}.plan-period ul,.report-section ul{margin:0;padding-inline-start:20px;color:var(--foreground-muted);line-height:1.85;overflow-wrap:anywhere}.plan-period li,.report-section li{margin-block:4px}.missing-item{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:start}.missing-item button{background:var(--primary-soft);color:var(--primary-hover);min-height:38px}.ask-card label{font-weight:600;color:var(--foreground-muted);line-height:1.6}.ask-row{display:grid;grid-template-columns:minmax(0,1fr) minmax(170px,auto);gap:10px;align-items:stretch;min-width:0}.ask-row textarea{width:100%;min-width:0;min-height:112px;border:1px solid var(--border-strong);background:var(--surface);color:var(--foreground);border-radius:var(--radius-control);padding:14px 15px;font-family:inherit;font-weight:500;font-size:14px;line-height:1.75;resize:vertical;outline:none;overflow:auto;white-space:pre-wrap;overflow-wrap:anywhere}.ask-row textarea::placeholder{color:var(--foreground-muted);opacity:.78;line-height:1.75}.ask-row textarea:focus{border-color:var(--accent);box-shadow:var(--focus-shadow)}.ask-row button{height:auto;min-width:170px;align-self:stretch}.chat-answer{display:grid;gap:14px;border:1px solid var(--border);background:var(--surface-muted);border-radius:var(--radius-card);padding:16px;align-content:start}.chat-answer-main,.chip-list,.chat-disclaimer{min-width:0}.chat-answer-main{padding-bottom:2px}.chat-answer p{margin:0;color:var(--foreground);line-height:1.9;font-weight:500;overflow-wrap:anywhere;white-space:pre-wrap}.chat-answer small,.ai-disclaimer p{color:var(--foreground-muted);line-height:1.8;overflow-wrap:anywhere}.chat-disclaimer{display:block;border-top:1px solid var(--border);padding-top:12px;font-size:12px;font-weight:500}.chip-list{display:grid;gap:9px;border-top:1px solid var(--primary-soft);padding-top:12px}.chip-list h3{margin:0;color:var(--foreground);font-size:14px;line-height:1.45;font-weight:600}.chip-list ul{display:grid;gap:8px;margin:0;padding:0;list-style:none}.chip-list li{border-radius:var(--radius-control);background:var(--primary-soft);border:1px solid var(--primary-soft);color:var(--primary-hover);padding:9px 11px;font-size:12px;font-weight:600;line-height:1.65;white-space:normal;overflow-wrap:anywhere}.report-card{grid-column:1 / -1}.report-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.ai-disclaimer{padding:15px;border-color:var(--border-strong);background:var(--surface-muted)}.ai-disclaimer strong{color:var(--foreground);line-height:1.5}.ai-disclaimer p{margin:6px 0 0;font-weight:600}@media(max-width:980px){.ai-main-grid,.report-grid{grid-template-columns:1fr}.ai-status-card{grid-template-columns:1fr}.ai-source-stack{justify-items:start}.ask-row{grid-template-columns:1fr}.ask-row button{width:100%;min-width:0;min-height:46px}}@media(max-width:640px){.ai-toolbar{display:grid}.ai-toolbar button{width:100%}.missing-item{grid-template-columns:1fr}.ai-status-copy h2{font-size:22px}.ai-card,.ai-status-card{padding:16px}.chat-answer{padding:14px}.section-title{display:grid;grid-template-columns:minmax(0,1fr) auto}.ask-row textarea{min-height:124px}}
      `}</style>
    </section>
  );
}
