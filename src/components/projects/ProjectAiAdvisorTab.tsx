...
export function ProjectAiAdvisorTab({ projectId, lang, onNavigateTab }: Props) {
  ...
  return (
    <section className="project-ai-advisor" dir={isRtl ? 'rtl' : 'ltr'} aria-label={t.aiAdvisor}>
      ...
      <style jsx>{`
        .project-ai-advisor{display:grid;gap:16px;min-width:0}.ai-status-card,.ai-card,.ai-disclaimer{background:var(--sfm-card);border:1px solid rgba(29,140,255,.16);border-radius:20px;box-shadow:0 14px 34px rgba(3,18,37,.07);min-width:0}.ai-status-card{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:16px;align-items:center;padding:20px;background:radial-gradient(circle at 12% 10%,rgba(167,243,240,.28),transparent 30%),linear-gradient(135deg,var(--sfm-deep-navy),var(--sfm-primary-dark) 58%,var(--sfm-card-dark) 140%);color:var(--sfm-card)}.ai-status-icon{width:58px;height:58px;border-radius:18px;background:rgba(234,246,255,.1);display:grid;place-items:center;color:var(--sfm-soft-cyan)}.ai-status-copy span,.ai-source-badge{color:var(--sfm-soft-cyan);font-weight:950;font-size:12px}.ai-status-copy h2{margin:6px 0;color:var(--sfm-card);font-size:26px;line-height:1.2}.ai-status-copy p{margin:0;color:rgba(234,246,255,.78);line-height:1.7}.ai-status-copy small{display:block;margin-top:8px;color:rgba(234,246,255,.68);line-height:1.6}.ai-source-stack{display:grid;gap:8px;justify-items:end}.ai-status-badge{border-radius:999px;padding:8px 12px;font-weight:950;font-size:12px}.ai-status-badge.strong{background:#ECFDF5;color:#047857}.ai-status-badge.needs_review,.ai-status-badge.incomplete{background:#FFF7ED;color:#B45309}.ai-status-badge.high_risk{background:#FEF2F2;color:#B91C1C}.ai-toolbar{display:flex;flex-wrap:wrap;gap:10px}.ai-toolbar button,.missing-item button,.ask-row button{min-height:42px;border-radius:13px;border:1px solid rgba(29,140,255,.18);background:var(--sfm-card);color:var(--sfm-midnight);padding:0 14px;display:inline-flex;align-items:center;justify-content:center;gap:8px;font-family:inherit;font-weight:950;cursor:pointer}.ai-toolbar button.primary,.ask-row button{background:linear-gradient(135deg,var(--sfm-primary),var(--sfm-accent));color:#FFFFFF;border:0}.ai-toolbar button.disabled{cursor:not-allowed;color:var(--sfm-muted);background:var(--sfm-light-card)}.ai-toolbar button:focus-visible,.missing-item button:focus-visible,.ask-row button:focus-visible{outline:none;box-shadow:0 0 0 3px rgba(24,212,212,.16)}.ai-toolbar button:disabled,.ask-row button:disabled{opacity:.65;cursor:not-allowed}.spin{animation:spin 1s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}.ai-error{border:1px solid rgba(179,38,30,.18);background:#FEF2F2;color:#B91C1C;border-radius:14px;padding:12px;font-weight:900}.ai-live-region{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0 0 0 0)}.ai-main-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.ai-card{padding:18px;display:grid;gap:14px}.section-title{display:flex;align-items:center;justify-content:space-between;gap:12px}.section-title h2{margin:0;color:var(--sfm-midnight);font-size:19px}.section-title svg{color:var(--sfm-primary)}.risk-list,.action-list,.plan-list,.missing-list,.report-grid{display:grid;gap:10px}.risk-item,.action-item,.plan-period,.missing-item,.report-section{border:1px solid rgba(29,140,255,.12);background:var(--sfm-light-card);border-radius:15px;padding:12px;min-width:0}.risk-item span,.action-item span{display:inline-flex;border-radius:999px;padding:5px 9px;font-size:12px;font-weight:950}.risk-item.low span,.action-item.low span{background:#ECFDF5;color:#047857}.risk-item.medium span,.action-item.medium span{background:#FFF7ED;color:#B45309}.risk-item.high span,.action-item.high span{background:#FEF2F2;color:#B91C1C}.risk-item h3,.action-item h3,.plan-period h3,.missing-item h3,.report-section h3{margin:8px 0 6px;color:var(--sfm-primary-dark);font-size:16px}.risk-item p,.action-item p,.missing-item p,.report-section p,.ai-empty{margin:0;color:var(--sfm-muted);line-height:1.7}.risk-item strong,.action-item small{display:block;margin-top:8px;color:var(--sfm-midnight);line-height:1.6}.plan-period ul,.report-section ul{margin:0;padding-inline-start:20px;color:var(--sfm-muted);line-height:1.8}.missing-item{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:center}.missing-item button{background:rgba(29,140,255,.10);color:var(--sfm-primary-hover);min-height:36px}.ask-card label{font-weight:900;color:var(--sfm-muted)}.ask-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:10px;align-items:stretch}.ask-row textarea{width:100%;min-width:0;border:1px solid rgba(29,140,255,.2);background:var(--sfm-card);color:var(--sfm-foreground);border-radius:14px;padding:12px;font-family:inherit;font-weight:800;line-height:1.6;resize:vertical;outline:none}.ask-row textarea:focus{border-color:var(--sfm-accent);box-shadow:0 0 0 3px rgba(24,212,212,.15)}.chat-answer{display:grid;gap:12px;border:1px solid rgba(29,140,255,.12);background:var(--sfm-light-card);border-radius:15px;padding:14px}.chat-answer p{margin:0;color:var(--sfm-midnight);line-height:1.7;font-weight:900}.chat-answer small,.ai-disclaimer p{color:var(--sfm-muted);line-height:1.7}.chip-list h3{margin:0 0 8px;color:var(--sfm-midnight);font-size:14px}.chip-list div{display:flex;flex-wrap:wrap;gap:7px}.chip-list span{border-radius:999px;background:rgba(29,140,255,.10);color:var(--sfm-primary-hover);padding:6px 10px;font-size:12px;font-weight:950}.report-card{grid-column:1 / -1}.report-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.ai-disclaimer{padding:15px;border-color:rgba(29,140,255,.2);background:var(--sfm-light-card)}.ai-disclaimer strong{color:var(--sfm-midnight)}.ai-disclaimer p{margin:6px 0 0;font-weight:900}@media(max-width:980px){.ai-main-grid,.report-grid{grid-template-columns:1fr}.ai-status-card{grid-template-columns:1fr}.ai-source-stack{justify-items:start}.ask-row{grid-template-columns:1fr}.ask-row button{width:100%}}@media(max-width:640px){.ai-toolbar{display:grid}.ai-toolbar button{width:100%}.missing-item{grid-template-columns:1fr}.ai-status-copy h2{font-size:22px}.ai-card,.ai-status-card{padding:16px}}
      `}</style>
    </section>
  );
}
