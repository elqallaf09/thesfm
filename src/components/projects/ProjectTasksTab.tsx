...
export function ProjectTasksTab({
  ...
  return (
    <section className="project-tasks-tab" role="tabpanel" aria-label={t.taskBoard}>
      ...
      <style jsx global>{`
        .project-tasks-tab{display:grid;gap:16px;min-width:0}.tasks-summary-grid{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:12px}.summary-card,.tasks-card{background:#FFFDF8;border:1px solid rgba(186,117,23,.16);border-radius:20px;padding:18px;box-shadow:0 14px 34px rgba(61,41,20,.07);min-width:0}.summary-card{background:#FFF8EA;display:flex;align-items:center;justify-content:space-between;gap:12px}.summary-card small{display:block;color:#7A6A55;font-weight:900}.summary-card strong{display:block;margin-top:6px;color:#2B1A0F;font-size:20px}.summary-card svg,.tasks-section-title svg{color:#BA7517}.tasks-progress-bar{height:11px;border-radius:999px;background:#FAEEDA;overflow:hidden}.tasks-progress-bar span{display:block;height:100%;border-radius:999px;background:linear-gradient(90deg,#FAC775,#BA7517)}.tasks-notice{border:1px solid rgba(186,117,23,.2);background:#FFF8EA;color:#3D2914;border-radius:15px;padding:12px 14px;font-weight:900}.tasks-actions{display:flex;gap:10px;flex-wrap:wrap}.tasks-actions button,.primary-modal-btn{min-height:42px;border:0;border-radius:13px;background:linear-gradient(135deg,#FAC775,#EF9F27);color:#251407;padding:0 14px;font-family:inherit;font-weight:950;display:inline-flex;align-items:center;justify-content:center;gap:8px;cursor:pointer}.tasks-section-title{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px}.tasks-section-title h2{margin:0;color:#3D2914;font-size:20px}.task-board{display:grid;grid-template-columns:repeat(5,minmax(220px,1fr));gap:12px;overflow-x:auto;padding-bottom:4px}.task-column{background:#FFF8EA;border:1px solid rgba(186,117,23,.12);border-radius:16px;padding:12px;min-width:220px}.task-column h3{margin:0 0 10px;color:#3D2914;font-size:15px}.task-card-list{display:grid;gap:10px}.task-card{background:#FFFDF8;border:1px solid rgba(186,117,23,.14);border-radius:15px;padding:12px;display:grid;gap:9px}.task-card h4{margin:0;color:#2B1A0F}.task-card p{margin:0;color:#5B4332;line-height:1.55}.badge-row{display:flex;gap:6px;flex-wrap:wrap}.status-badge,.priority-badge,.phase-badge{display:inline-flex;border-radius:999px;padding:4px 8px;font-size:11px;font-weight:950}.status-badge.todo,.status-badge.planned{background:#FAEEDA;color:#854F0B}.status-badge.in_progress{background:#E7F0FF;color:#244F8F}.status-badge.done,.status-badge.completed{background:#EAF3DE;color:#27500A}.status-badge.late{background:#FCEBEB;color:#791F1F}.status-badge.cancelled{background:#EFEAE2;color:#6E6258}.priority-badge.low{background:#EAF3DE;color:#27500A}.priority-badge.medium{background:#FFF4DE;color:#9A5E0D}.priority-badge.high{background:#FCEBEB;color:#791F1F}.priority-badge.urgent{background:#3D2914;color:#FAC775}.phase-badge{background:#F5F1E8;color:#5B4332}.task-meta{display:grid;gap:4px;color:#7A6A55;font-size:12px;font-weight:800}.card-actions{display:flex;gap:6px;flex-wrap:wrap}.card-actions button{min-height:34px;border:1px solid rgba(186,117,23,.16);border-radius:10px;background:#FFF8EA;color:#3D2914;padding:0 9px;font-family:inherit;font-weight:900;display:inline-flex;align-items:center;gap:5px;cursor:pointer}.tasks-layout{display:grid;grid-template-columns:minmax(0,1.35fr) minmax(300px,.8fr);gap:16px}.empty-copy{margin:0;color:#7A6A55;line-height:1.7}.gantt-view{display:grid;gap:12px}.timeline-lane{display:grid;grid-template-columns:minmax(150px,.34fr) minmax(0,1fr);gap:12px;align-items:center}.timeline-meta strong{display:block;color:#2B1A0F}.timeline-meta small{display:block;color:#7A6A55;margin-top:4px}.timeline-track{position:relative;height:28px;border-radius:999px;background:#FAEEDA;overflow:hidden}.timeline-bar{position:absolute;top:6px;height:16px;border-radius:999px;background:#BA7517}.timeline-bar.in_progress{background:#3B73C8}.timeline-bar.done{background:#3E7B22}.timeline-bar.late{background:#B3261E}.timeline-bar.cancelled{background:#7A6A55}.milestone-marker{position:absolute;top:5px;width:18px;height:18px;border-radius:50%;background:#BA7517;border:3px solid #FFFDF8;transform:translateX(-50%)}[dir="rtl"] .milestone-marker{transform:translateX(50%)}.milestone-list{display:grid;gap:10px}.milestone-card{display:grid;gap:8px;background:#FFF8EA;border:1px solid rgba(186,117,23,.12);border-radius:15px;padding:12px}.milestone-card div:first-child{display:flex;justify-content:space-between;gap:10px;align-items:center}.milestone-card strong{color:#2B1A0F}.milestone-card p{margin:0;color:#5B4332;line-height:1.55}.milestone-card small{color:#7A6A55;font-weight:800}.milestone-progress{height:8px;background:#FAEEDA;border-radius:999px;overflow:hidden}.milestone-progress span{display:block;height:100%;background:linear-gradient(90deg,#FAC775,#BA7517)}.tasks-modal-backdrop{position:fixed;inset:0;z-index:140;background:rgba(26,15,5,.48);display:grid;place-items:center;padding:18px}.tasks-modal{width:min(760px,100%);max-height:min(86dvh,820px);overflow:auto;background:#FFFDF8;border:1px solid rgba(186,117,23,.2);border-radius:22px;padding:18px;box-shadow:0 24px 70px rgba(26,15,5,.25)}.modal-heading{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px}.modal-heading h2{margin:0;color:#3D2914}.modal-heading button{width:38px;height:38px;border:1px solid rgba(186,117,23,.16);border-radius:12px;background:#FFF8EA;color:#3D2914;display:grid;place-items:center;cursor:pointer}.modal-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.tasks-field{display:grid;gap:7px;min-width:0}.tasks-field span{font-weight:900;color:#5B4332}.tasks-field input,.tasks-field textarea,.tasks-field select{width:100%;min-width:0;border:1px solid rgba(186,117,23,.2);background:#FFFDF8;color:#1A1A1A;border-radius:13px;padding:11px 12px;font-family:inherit;font-weight:800;outline:none}.tasks-field textarea{resize:vertical;line-height:1.6}.tasks-field input:focus,.tasks-field textarea:focus,.tasks-field select:focus,.tasks-actions button:focus-visible,.card-actions button:focus-visible,.modal-heading button:focus-visible,.modal-actions button:focus-visible{outline:none;box-shadow:0 0 0 3px rgba(239,159,39,.16);border-color:#EF9F27}.modal-actions{display:flex;justify-content:flex-end;gap:10px;margin-top:16px}.modal-actions button{min-height:42px;border:1px solid rgba(186,117,23,.18);border-radius:13px;background:#FFF8EA;color:#3D2914;padding:0 14px;font-family:inherit;font-weight:950;display:inline-flex;align-items:center;gap:8px;cursor:pointer}.modal-actions .primary-modal-btn{border:0;background:linear-gradient(135deg,#FAC775,#EF9F27);color:#251407}@media(max-width:1280px){.tasks-summary-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.tasks-layout{grid-template-columns:1fr}}@media(max-width:760px){.tasks-summary-grid,.modal-grid{grid-template-columns:1fr}.task-board{grid-template-columns:1fr;overflow:visible}.task-column{min-width:0}.timeline-lane{grid-template-columns:1fr}.timeline-track{height:22px}.tasks-actions,.modal-actions{display:grid;grid-template-columns:1fr}.tasks-actions button,.modal-actions button{width:100%}.tasks-card,.summary-card{padding:16px}.tasks-modal-backdrop{align-items:end;padding:10px}.tasks-modal{max-height:88dvh;border-radius:20px 20px 0 0}}
      `}</style>
    </section>
  );
}
