...
export function ProjectTasksTab({
  ...
  return (
    <section className="project-tasks-tab" role="tabpanel" aria-label={t.taskBoard}>
      ...
      <style jsx global>{`
        .project-tasks-tab{display:grid;gap:16px;min-width:0}.tasks-summary-grid{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:12px}.summary-card,.tasks-card{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-card);padding:18px;box-shadow:var(--shadow-card);min-width:0}.summary-card{background:var(--surface-muted);display:flex;align-items:center;justify-content:space-between;gap:12px}.summary-card small{display:block;color:var(--foreground-muted);font-weight:600}.summary-card strong{display:block;margin-top:6px;color:var(--foreground);font-family:var(--font-data);font-size:20px}.summary-card svg,.tasks-section-title svg{color:var(--primary)}.tasks-progress-bar{height:11px;border-radius:var(--radius-pill);background:var(--primary-soft);overflow:hidden}.tasks-progress-bar span{display:block;height:100%;border-radius:var(--radius-pill);background:var(--primary)}.tasks-notice{border:1px solid var(--border-strong);background:var(--surface-muted);color:var(--foreground);border-radius:var(--radius-card);padding:12px 14px;font-weight:600}.tasks-actions{display:flex;gap:10px;flex-wrap:wrap}.tasks-actions button,.primary-modal-btn{min-height:42px;border:0;border-radius:var(--radius-control);background:var(--primary);color:var(--primary-foreground);padding:0 14px;font-family:inherit;font-weight:600;display:inline-flex;align-items:center;justify-content:center;gap:8px;cursor:pointer}.tasks-section-title{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px}.tasks-section-title h2{margin:0;color:var(--foreground);font-size:20px}.task-board{display:grid;grid-template-columns:repeat(5,minmax(220px,1fr));gap:12px;overflow-x:auto;padding-bottom:4px}.task-column{background:var(--surface-muted);border:1px solid var(--border);border-radius:var(--radius-card);padding:12px;min-width:220px}.task-column h3{margin:0 0 10px;color:var(--foreground);font-size:15px}.task-card-list{display:grid;gap:10px}.task-card{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-card);padding:12px;display:grid;gap:9px}.task-card h4{margin:0;color:var(--foreground)}.task-card p{margin:0;color:var(--foreground-muted);line-height:1.55}.badge-row{display:flex;gap:6px;flex-wrap:wrap}.status-badge,.priority-badge,.phase-badge{display:inline-flex;border-radius:var(--radius-pill);padding:4px 8px;font-size:12px;font-weight:600}.status-badge.todo,.status-badge.planned{background:var(--primary-soft);color:var(--primary-hover)}.status-badge.in_progress{background:var(--primary-soft);color:var(--primary-hover)}.status-badge.done,.status-badge.completed{background:var(--success-soft);color:var(--success)}.status-badge.late{background:var(--danger-soft);color:var(--danger)}.status-badge.cancelled{background:var(--surface-muted);color:var(--foreground-muted)}.priority-badge.low{background:var(--success-soft);color:var(--success)}.priority-badge.medium{background:var(--warning-soft);color:var(--warning)}.priority-badge.high{background:var(--danger-soft);color:var(--danger)}.priority-badge.urgent{background:var(--foreground);color:var(--foreground-inverse)}.phase-badge{background:var(--background);color:var(--foreground-muted)}.task-meta{display:grid;gap:4px;color:var(--foreground-muted);font-size:12px;font-weight:500}.card-actions{display:flex;gap:6px;flex-wrap:wrap}.card-actions button{min-height:34px;border:1px solid var(--border);border-radius:var(--radius-sm);background:var(--surface-muted);color:var(--foreground);padding:0 9px;font-family:inherit;font-weight:600;display:inline-flex;align-items:center;gap:5px;cursor:pointer}.tasks-layout{display:grid;grid-template-columns:minmax(0,1.35fr) minmax(300px,.8fr);gap:16px}.empty-copy{margin:0;color:var(--foreground-muted);line-height:1.7}.gantt-view{display:grid;gap:12px}.timeline-lane{display:grid;grid-template-columns:minmax(150px,.34fr) minmax(0,1fr);gap:12px;align-items:center}.timeline-meta strong{display:block;color:var(--foreground)}.timeline-meta small{display:block;color:var(--foreground-muted);margin-top:4px}.timeline-track{position:relative;height:28px;border-radius:var(--radius-pill);background:var(--primary-soft);overflow:hidden}.timeline-bar{position:absolute;top:6px;height:16px;border-radius:var(--radius-pill);background:var(--primary)}.timeline-bar.in_progress{background:var(--primary)}.timeline-bar.done{background:var(--success)}.timeline-bar.late{background:var(--danger)}.timeline-bar.cancelled{background:var(--foreground-muted)}.milestone-marker{position:absolute;top:5px;width:18px;height:18px;border-radius:var(--radius-pill);background:var(--primary);border:3px solid var(--surface);transform:translateX(-50%)}[dir="rtl"] .milestone-marker{transform:translateX(50%)}.milestone-list{display:grid;gap:10px}.milestone-card{display:grid;gap:8px;background:var(--surface-muted);border:1px solid var(--border);border-radius:var(--radius-card);padding:12px}.milestone-card div:first-child{display:flex;justify-content:space-between;gap:10px;align-items:center}.milestone-card strong{color:var(--foreground)}.milestone-card p{margin:0;color:var(--foreground-muted);line-height:1.55}.milestone-card small{color:var(--foreground-muted);font-weight:500}.milestone-progress{height:8px;background:var(--primary-soft);border-radius:var(--radius-pill);overflow:hidden}.milestone-progress span{display:block;height:100%;background:var(--primary)}.tasks-modal-backdrop{position:fixed;inset:0;z-index:140;background:var(--background-overlay);display:grid;place-items:center;padding:18px}.tasks-modal{width:min(760px,100%);max-height:min(86dvh,820px);overflow:auto;background:var(--surface);border:1px solid var(--border-strong);border-radius:var(--radius-panel);padding:18px;box-shadow:var(--shadow-popover)}.modal-heading{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px}.modal-heading h2{margin:0;color:var(--foreground)}.modal-heading button{width:38px;height:var(--control-h-sm);border:1px solid var(--border);border-radius:var(--radius-control);background:var(--surface-muted);color:var(--foreground);display:grid;place-items:center;cursor:pointer}.modal-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.tasks-field{display:grid;gap:7px;min-width:0}.tasks-field span{font-weight:600;color:var(--foreground-muted)}.tasks-field input,.tasks-field textarea,.tasks-field select{width:100%;min-width:0;border:1px solid var(--border-strong);background:var(--surface);color:var(--foreground);border-radius:var(--radius-control);padding:11px 12px;font-family:inherit;font-weight:500;outline:none}.tasks-field textarea{resize:vertical;line-height:1.6}.tasks-field input:focus,.tasks-field textarea:focus,.tasks-field select:focus,.tasks-actions button:focus-visible,.card-actions button:focus-visible,.modal-heading button:focus-visible,.modal-actions button:focus-visible{outline:none;box-shadow:var(--focus-shadow);border-color:var(--accent)}.modal-actions{display:flex;justify-content:flex-end;gap:10px;margin-top:16px}.modal-actions button{min-height:42px;border:1px solid var(--border);border-radius:var(--radius-control);background:var(--surface-muted);color:var(--foreground);padding:0 14px;font-family:inherit;font-weight:600;display:inline-flex;align-items:center;gap:8px;cursor:pointer}.modal-actions .primary-modal-btn{border:0;background:var(--primary);color:var(--primary-foreground)}@media(max-width:1280px){.tasks-summary-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.tasks-layout{grid-template-columns:1fr}}@media(max-width:760px){.tasks-summary-grid,.modal-grid{grid-template-columns:1fr}.task-board{grid-template-columns:1fr;overflow:visible}.task-column{min-width:0}.timeline-lane{grid-template-columns:1fr}.timeline-track{height:22px}.tasks-actions,.modal-actions{display:grid;grid-template-columns:1fr}.tasks-actions button,.modal-actions button{width:100%}.tasks-card,.summary-card{padding:16px}.tasks-modal-backdrop{align-items:end;padding:10px}.tasks-modal{max-height:88dvh;border-radius:var(--radius-card) var(--radius-card) 0 0}}
      `}</style>
    </section>
  );
}
