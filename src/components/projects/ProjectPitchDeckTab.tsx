...
export function ProjectPitchDeckTab({ projectId, lang, onNavigateTab }: Props) {
  ...
  const printDeck = () => {
    if (!deck) return;
    setMessage(lang === 'ar' ? 'سيتم فتح نافذة الطباعة لحفظ العرض كملف PDF.' : lang === 'fr' ? 'La fenêtre d’impression va s’ouvrir pour enregistrer le PDF.' : 'The print dialog will open so you can save the deck as a PDF.');
    ...
    <section className="project-pitch-deck" dir={lang === 'ar' ? 'rtl' : 'ltr'} aria-label={t.pitchDeck}>
      <article className="pitch-hero">
        ...
        <div
          ...
          role="img"
          aria-label={`${t.readiness}: ${deck?.completionPercent ?? 0}/100`}
        >
      ...
      {!deck || !selectedSlide ? (
        ...
        <div className="pitch-layout">
          ...
          <section className="slide-stage" aria-label={t.slidePreview}>
      ...
      <style jsx>{`
        .project-pitch-deck{display:grid;gap:16px;min-width:0}.pitch-hero,.pitch-empty,.pitch-disclaimer,.slide-list,.slide-stage,.slide-insights,.edit-panel{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius-card);box-shadow:var(--shadow-card);min-width:0}.pitch-hero{display:grid;grid-template-columns:minmax(0,1fr) auto auto;gap:18px;align-items:center;padding:20px;background:var(--primary-soft);color:var(--foreground)}.pitch-hero span,.pitch-source span{color:var(--foreground-muted);font-weight:600;font-size:12px}.pitch-hero h2{margin:6px 0;color:var(--foreground);font-size:28px}.pitch-hero p{margin:0;color:var(--foreground-muted);line-height:1.7}.readiness-ring{width:104px;height:104px;border-radius:var(--radius-pill);display:grid;place-items:center;background:var(--surface);border:3px solid var(--primary);box-shadow:var(--shadow-xs)}.readiness-ring strong{font-family:var(--font-data);font-size:28px;color:var(--foreground)}.readiness-ring span{margin-top:-20px}.pitch-source{border:1px solid var(--border);background:var(--surface-muted);border-radius:var(--radius-pill);padding:9px 12px}.pitch-actions{display:flex;gap:10px;flex-wrap:wrap}.pitch-actions button,.stage-heading button,.edit-actions button,.insight-item button{min-height:42px;border-radius:var(--radius-control);border:1px solid var(--border);background:var(--surface);color:var(--foreground);padding:0 14px;display:inline-flex;align-items:center;justify-content:center;gap:8px;font-family:inherit;font-weight:600;cursor:pointer}.pitch-actions button:first-child,.edit-actions .primary{background:var(--primary);color:var(--primary-foreground);border:0}.pitch-actions button.disabled{background:var(--surface-muted);color:var(--foreground-muted);cursor:not-allowed}.pitch-actions button.disabled span{border-radius:var(--radius-pill);background:var(--primary-soft);color:var(--primary-hover);padding:3px 7px;font-size:12px}.pitch-actions button:disabled{opacity:.7;cursor:not-allowed}.pitch-message{border:1px solid var(--border-strong);background:var(--surface-muted);color:var(--foreground);border-radius:var(--radius-card);padding:12px;font-weight:600}.pitch-empty{min-height:260px;display:grid;place-items:center;text-align:center;color:var(--foreground-muted);padding:22px}.pitch-empty svg{color:var(--primary)}.pitch-layout{display:grid;grid-template-columns:minmax(220px,.55fr) minmax(0,1.5fr) minmax(270px,.75fr);gap:16px;align-items:start}.slide-list,.slide-stage,.slide-insights,.edit-panel{padding:16px}.slide-list{display:grid;gap:9px;position:sticky;top:14px}.slide-list h3,.stage-heading h3{margin:0;color:var(--foreground)}.slide-list button{border:1px solid var(--border);background:var(--surface-muted);border-radius:var(--radius-control);padding:10px;text-align:start;display:grid;gap:4px;font-family:inherit;cursor:pointer}.slide-list button.active{background:var(--foreground);color:var(--foreground-inverse);border-color:var(--foreground)}.slide-list button.active span{color:var(--foreground-inverse)}.slide-list button span{font-size:12px;color:var(--primary);font-weight:600}.slide-list button strong{font-size:14px}.slide-list button small{width:max-content;border-radius:var(--radius-pill);padding:3px 8px;font-size:12px;font-weight:600}.slide-list button small.complete{background:var(--success-soft);color:var(--success)}.slide-list button small.needs_data{background:var(--warning-soft);color:var(--warning)}.slide-list button small.not_ready{background:var(--danger-soft);color:var(--danger)}.slide-stage{display:grid;gap:14px}.stage-heading{display:flex;align-items:center;justify-content:space-between;gap:12px}.pitch-slide-preview{aspect-ratio:16/9;border-radius:var(--radius-panel);overflow:hidden;background:var(--background);border:1px solid var(--border);box-shadow:var(--shadow-card);display:grid;grid-template-rows:auto minmax(0,1fr) auto;min-width:0}.pitch-slide-preview header{background:var(--primary);color:var(--primary-foreground);padding:18px 22px;display:flex;justify-content:space-between;align-items:center;gap:12px}.pitch-slide-preview header span{color:var(--hero-foreground-muted);font-weight:600}.pitch-slide-preview header small{border-radius:var(--radius-pill);background:var(--surface-muted);padding:5px 9px}.slide-body{padding:24px;min-width:0}.slide-body h2{margin:0 0 18px;color:var(--foreground);font-size:clamp(24px,3vw,38px);line-height:1.15}.slide-content-grid{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(190px,.65fr);gap:18px;align-items:start}.slide-body ul{margin:0;padding-inline-start:22px;color:var(--foreground);line-height:1.8;font-weight:600}.metric-stack{display:grid;gap:10px}.slide-metric{border:1px solid var(--border);background:var(--surface);border-radius:var(--radius-card);padding:12px}.slide-metric small{display:block;color:var(--foreground-muted);font-weight:600}.slide-metric strong{display:block;margin-top:6px;color:var(--foreground);font-family:var(--font-data);font-size:18px}.metric-stack p{margin:0;color:var(--foreground-muted);line-height:1.6}.pitch-slide-preview footer{padding:10px 22px;background:var(--surface);color:var(--foreground-muted);font-size:12px;font-weight:600}.edit-panel{display:grid;gap:9px}.edit-panel label{font-weight:600;color:var(--foreground-muted)}.edit-panel input,.edit-panel textarea{width:100%;min-width:0;border:1px solid var(--border-strong);background:var(--surface);color:var(--foreground);border-radius:var(--radius-control);padding:11px 12px;font-family:inherit;font-weight:500;line-height:1.6;outline:none}.edit-panel input:focus,.edit-panel textarea:focus,.pitch-actions button:focus-visible,.stage-heading button:focus-visible,.edit-actions button:focus-visible,.slide-list button:focus-visible,.insight-item button:focus-visible{outline:none;box-shadow:var(--focus-shadow);border-color:var(--accent)}.edit-actions{display:flex;justify-content:flex-end;gap:10px}.slide-insights{display:grid;gap:14px;position:sticky;top:14px}.insight-card{display:grid;gap:9px}.insight-card h3{margin:0;color:var(--foreground);font-size:16px}.insight-item{display:grid;gap:8px;border:1px solid var(--border);background:var(--surface-muted);border-radius:var(--radius-control);padding:10px}.insight-item span,.suggestion{color:var(--foreground-muted);line-height:1.6;font-weight:600}.insight-item button{min-height:34px;background:var(--primary-soft);color:var(--primary-hover);width:max-content}.pitch-disclaimer{display:flex;gap:10px;align-items:flex-start;padding:14px;background:var(--surface-muted);color:var(--foreground-muted);font-weight:600;line-height:1.7}.pitch-disclaimer svg{color:var(--primary);flex:0 0 auto}.pitch-disclaimer p{margin:0}.spin{animation:spin 1s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}.print-deck{display:none}@media(max-width:1180px){.pitch-layout{grid-template-columns:1fr}.slide-list,.slide-insights{position:static}.slide-list{grid-template-columns:repeat(2,minmax(0,1fr))}.slide-list h3{grid-column:1 / -1}}@media(max-width:760px){.pitch-hero{grid-template-columns:1fr}.readiness-ring{width:92px;height:92px}.pitch-actions{display:grid}.pitch-actions button{width:100%}.slide-list{display:flex;overflow-x:auto}.slide-list h3{display:none}.slide-list button{min-width:190px}.slide-content-grid{grid-template-columns:1fr}.pitch-slide-preview{aspect-ratio:auto;min-height:420px}.stage-heading,.edit-actions{display:grid}.stage-heading button,.edit-actions button{width:100%}.slide-body{padding:18px}.pitch-slide-preview header{padding:14px 16px}}@media print{body *{visibility:hidden!important}.project-pitch-deck,.project-pitch-deck *{visibility:hidden!important}.print-deck,.print-deck *{visibility:visible!important}.print-deck{display:block!important;position:absolute;inset:0;background:var(--print-background)}.print-slide{page-break-after:always;width:100%;min-height:100vh;padding:42px;background:var(--print-background);color:var(--print-foreground);display:block}.print-slide header{background:var(--print-foreground);color:var(--print-background);padding:18px 24px;border-radius:var(--radius-card);display:flex;gap:18px;align-items:center}.print-slide h2{font-size:34px;line-height:1.2;margin:28px 0 18px}.print-slide li{font-size:20px;line-height:1.7;margin-bottom:8px}.print-metrics{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-top:22px}.print-metrics div{background:var(--print-surface);border:1px solid var(--print-border);border-radius:var(--radius-card);padding:14px}.print-metrics small{display:block;color:var(--print-foreground-muted)}.print-metrics b{display:block;color:var(--print-foreground);font-size:24px;margin-top:6px}.print-missing{background:var(--print-surface);border:1px solid var(--print-border);border-radius:var(--radius-control);padding:12px;color:var(--print-foreground-secondary)}.print-slide footer{position:absolute;bottom:30px;color:var(--print-foreground-muted);font-weight:600}}
        .slide-list,.slide-insights{top:calc(var(--global-header-height) + 14px)}
      `}</style>
      <style jsx global>{`
        @media print {
          @page { size: 13.333in 7.5in; margin: 0; }
          .print-deck { background:var(--print-surface)!important; color:var(--print-foreground)!important; }
          .print-slide {
