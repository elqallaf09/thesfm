...
export function ProjectPitchDeckTab({ projectId, lang, onNavigateTab }: Props) {
  ...
  return (
    <section className="project-pitch-deck" dir={lang === 'ar' ? 'rtl' : 'ltr'} aria-label={t.pitchDeck}>
      ...
      <style jsx>{`
        .project-pitch-deck{display:grid;gap:16px;min-width:0}.pitch-hero,.pitch-empty,.pitch-disclaimer,.slide-list,.slide-stage,.slide-insights,.edit-panel{background:#FFFDF8;border:1px solid rgba(186,117,23,.16);border-radius:20px;box-shadow:0 14px 34px rgba(61,41,20,.07);min-width:0}.pitch-hero{display:grid;grid-template-columns:minmax(0,1fr) auto auto;gap:18px;align-items:center;padding:20px;background:radial-gradient(circle at 12% 10%,rgba(250,199,117,.28),transparent 30%),linear-gradient(135deg,#1A0F05,#2B1A0F 58%,#8A5514 140%);color:#FFFDF8}.pitch-hero span,.pitch-source span{color:#FAC775;font-weight:950;font-size:12px}.pitch-hero h2{margin:6px 0;color:#FFFDF8;font-size:28px}.pitch-hero p{margin:0;color:rgba(255,253,248,.78);line-height:1.7}.readiness-ring{width:104px;height:104px;border-radius:50%;display:grid;place-items:center;background:conic-gradient(#FAC775 var(--score-angle,0deg),rgba(255,253,248,.16) 0);box-shadow:inset 0 0 0 11px rgba(26,15,5,.92)}.readiness-ring strong{font-size:28px;color:#FFFDF8}.readiness-ring span{margin-top:-20px}.pitch-source{border:1px solid rgba(250,199,117,.2);background:rgba(255,253,248,.08);border-radius:999px;padding:9px 12px}.pitch-actions{display:flex;gap:10px;flex-wrap:wrap}.pitch-actions button,.stage-heading button,.edit-actions button,.insight-item button{min-height:42px;border-radius:13px;border:1px solid rgba(186,117,23,.18);background:#FFFDF8;color:#3D2914;padding:0 14px;display:inline-flex;align-items:center;justify-content:center;gap:8px;font-family:inherit;font-weight:950;cursor:pointer}.pitch-actions button:first-child,.edit-actions .primary{background:linear-gradient(135deg,#FAC775,#EF9F27);color:#251407;border:0}.pitch-actions button.disabled{background:#FFF8EA;color:#7A6A55;cursor:not-allowed}.pitch-actions button.disabled span{border-radius:999px;background:#FAEEDA;color:#854F0B;padding:3px 7px;font-size:11px}.pitch-actions button:disabled{opacity:.7;cursor:not-allowed}.pitch-message{border:1px solid rgba(186,117,23,.2);background:#FFF8EA;color:#3D2914;border-radius:15px;padding:12px;font-weight:900}.pitch-empty{min-height:260px;display:grid;place-items:center;text-align:center;color:#5B4332;padding:22px}.pitch-empty svg{color:#BA7517}.pitch-layout{display:grid;grid-template-columns:minmax(220px,.55fr) minmax(0,1.5fr) minmax(270px,.75fr);gap:16px;align-items:start}.slide-list,.slide-stage,.slide-insights,.edit-panel{padding:16px}.slide-list{display:grid;gap:9px;position:sticky;top:14px}.slide-list h3,.stage-heading h3{margin:0;color:#3D2914}.slide-list button{border:1px solid rgba(186,117,23,.12);background:#FFF8EA;border-radius:14px;padding:10px;text-align:start;display:grid;gap:4px;font-family:inherit;cursor:pointer}.slide-list button.active{background:#3D2914;color:#FAC775}.slide-list button span{font-size:11px;color:#BA7517;font-weight:950}.slide-list button strong{font-size:14px}.slide-list button small{width:max-content;border-radius:999px;padding:3px 8px;font-size:11px;font-weight:950}.slide-list button small.complete{background:#EAF3DE;color:#27500A}.slide-list button small.needs_data{background:#FFF4DE;color:#9A5E0D}.slide-list button small.not_ready{background:#FCEBEB;color:#791F1F}.slide-stage{display:grid;gap:14px}.stage-heading{display:flex;align-items:center;justify-content:space-between;gap:12px}.pitch-slide-preview{aspect-ratio:16/9;border-radius:22px;overflow:hidden;background:#F5F1E8;border:1px solid rgba(61,41,20,.16);box-shadow:0 18px 36px rgba(61,41,20,.1);display:grid;grid-template-rows:auto minmax(0,1fr) auto;min-width:0}.pitch-slide-preview header{background:linear-gradient(135deg,#2B1A0F,#3D2914);color:#FFFDF8;padding:18px 22px;display:flex;justify-content:space-between;align-items:center;gap:12px}.pitch-slide-preview header span{color:#FAC775;font-weight:950}.pitch-slide-preview header small{border-radius:999px;background:rgba(255,253,248,.12);padding:5px 9px}.slide-body{padding:24px;min-width:0}.slide-body h2{margin:0 0 18px;color:#2B1A0F;font-size:clamp(24px,3vw,38px);line-height:1.15}.slide-content-grid{display:grid;grid-template-columns:minmax(0,1.2fr) minmax(190px,.65fr);gap:18px;align-items:start}.slide-body ul{margin:0;padding-inline-start:22px;color:#3D2914;line-height:1.8;font-weight:900}.metric-stack{display:grid;gap:10px}.slide-metric{border:1px solid rgba(186,117,23,.18);background:#FFFDF8;border-radius:16px;padding:12px}.slide-metric small{display:block;color:#7A6A55;font-weight:900}.slide-metric strong{display:block;margin-top:6px;color:#2B1A0F;font-size:18px}.metric-stack p{margin:0;color:#7A6A55;line-height:1.6}.pitch-slide-preview footer{padding:10px 22px;background:#FFFDF8;color:#7A6A55;font-size:12px;font-weight:900}.edit-panel{display:grid;gap:9px}.edit-panel label{font-weight:900;color:#5B4332}.edit-panel input,.edit-panel textarea{width:100%;min-width:0;border:1px solid rgba(186,117,23,.2);background:#FFFDF8;color:#1A1A1A;border-radius:13px;padding:11px 12px;font-family:inherit;font-weight:800;line-height:1.6;outline:none}.edit-panel input:focus,.edit-panel textarea:focus,.pitch-actions button:focus-visible,.stage-heading button:focus-visible,.edit-actions button:focus-visible,.slide-list button:focus-visible,.insight-item button:focus-visible{outline:none;box-shadow:0 0 0 3px rgba(239,159,39,.16);border-color:#EF9F27}.edit-actions{display:flex;justify-content:flex-end;gap:10px}.slide-insights{display:grid;gap:14px;position:sticky;top:14px}.insight-card{display:grid;gap:9px}.insight-card h3{margin:0;color:#3D2914;font-size:16px}.insight-item{display:grid;gap:8px;border:1px solid rgba(186,117,23,.12);background:#FFF8EA;border-radius:14px;padding:10px}.insight-item span,.suggestion{color:#5B4332;line-height:1.6;font-weight:900}.insight-item button{min-height:34px;background:#FAEEDA;color:#854F0B;width:max-content}.pitch-disclaimer{display:flex;gap:10px;align-items:flex-start;padding:14px;background:#FFF8EA;color:#5B4332;font-weight:900;line-height:1.7}.pitch-disclaimer svg{color:#BA7517;flex:0 0 auto}.pitch-disclaimer p{margin:0}.spin{animation:spin 1s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}.print-deck{display:none}@media(max-width:1180px){.pitch-layout{grid-template-columns:1fr}.slide-list,.slide-insights{position:static}.slide-list{grid-template-columns:repeat(2,minmax(0,1fr))}.slide-list h3{grid-column:1 / -1}}@media(max-width:760px){.pitch-hero{grid-template-columns:1fr}.readiness-ring{width:92px;height:92px}.pitch-actions{display:grid}.pitch-actions button{width:100%}.slide-list{display:flex;overflow-x:auto}.slide-list h3{display:none}.slide-list button{min-width:190px}.slide-content-grid{grid-template-columns:1fr}.pitch-slide-preview{aspect-ratio:auto;min-height:420px}.stage-heading,.edit-actions{display:grid}.stage-heading button,.edit-actions button{width:100%}.slide-body{padding:18px}.pitch-slide-preview header{padding:14px 16px}}@media print{body *{visibility:hidden!important}.project-pitch-deck,.project-pitch-deck *{visibility:hidden!important}.print-deck,.print-deck *{visibility:visible!important}.print-deck{display:block!important;position:absolute;inset:0;background:#F5F1E8}.print-slide{page-break-after:always;width:100vw;min-height:100vh;padding:42px;background:#F5F1E8;color:#2B1A0F;display:block}.print-slide header{background:#2B1A0F;color:#FAC775;padding:18px 24px;border-radius:18px;display:flex;gap:18px;align-items:center}.print-slide h2{font-size:34px;line-height:1.2;margin:28px 0 18px}.print-slide li{font-size:20px;line-height:1.7;margin-bottom:8px}.print-metrics{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-top:22px}.print-metrics div{background:#FFFDF8;border:1px solid rgba(186,117,23,.2);border-radius:16px;padding:14px}.print-metrics small{display:block;color:#7A6A55}.print-metrics b{display:block;color:#2B1A0F;font-size:24px;margin-top:6px}.print-missing{background:#FFF4DE;border-radius:14px;padding:12px;color:#9A5E0D}.print-slide footer{position:absolute;bottom:30px;color:#7A6A55;font-weight:900}}
      `}</style>
    </section>
  );
}
