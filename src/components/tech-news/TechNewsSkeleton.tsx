...
// Mirrors the real populated layout (quick filters -> unified editorial feed
// + side panel) at the same grid class names/column counts used by
    ...
    <div aria-hidden="true" className="tech-news-skeleton-root">
      ...
      <section className="tech-news-layout">
        <div className="tech-news-content-column">
          <section className="tech-news-feed tech-news-unified-feed">
            ...
            <div className="tech-news-standard-results grid">
