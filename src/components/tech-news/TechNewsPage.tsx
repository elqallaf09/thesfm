  ...
  return (
    <div className="tech-news-shell" dir={dir}>
      ...
      <style jsx global>{`
        ...
        .tech-news-main{width:calc(100% - var(--sidebar-w,230px));max-width:1280px;margin-left:auto;margin-right:auto;padding:18px 22px 32px;display:grid;gap:20px;overflow-x:hidden;min-width:0;box-sizing:border-box}
        [dir="rtl"].tech-news-shell .tech-news-main{margin-right:var(--sidebar-w,230px);margin-left:auto}
        [dir="ltr"].tech-news-shell .tech-news-main{margin-left:var(--sidebar-w,230px);margin-right:auto}
