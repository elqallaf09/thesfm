  ...
  return (
    <div className="tech-news-shell" dir={dir}>
      ...
      <style jsx global>{`
        ...
        .tech-news-main{width:100%;max-width:min(1280px,100%);margin:0 auto;padding:18px 22px 32px;margin-inline-start:230px;display:grid;gap:18px;overflow-x:hidden;min-width:0;box-sizing:border-box}
        ...
        .tech-news-controls{width:100%;max-width:100%;background:transparent;border:0;padding:0;display:grid;grid-template-columns:1fr;gap:12px;min-width:0;overflow-x:hidden}
        ...
        .tech-news-chip-row{width:100%;min-width:0;max-width:100%;display:flex;gap:9px;overflow-x:auto;overflow-y:hidden;padding-bottom:8px;scrollbar-width:none;overscroll-behavior-inline:contain;-webkit-overflow-scrolling:touch}
