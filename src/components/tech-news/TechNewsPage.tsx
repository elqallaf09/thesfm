  ...
  return (
    <div className="tech-news-shell" dir={dir}>
      ...
      <style jsx global>{`
        ...
        .tech-ticker-viewport{width:100%;overflow-x:auto;scrollbar-width:none;overscroll-behavior-inline:contain;-webkit-overflow-scrolling:touch}.tech-ticker-viewport::-webkit-scrollbar{display:none}.tech-ticker-track{width:max-content;display:flex;align-items:center;animation:techTickerMarquee 34s linear infinite;will-change:transform}.tech-ticker-strip:hover .tech-ticker-track,.tech-ticker-strip:focus-within .tech-ticker-track,.tech-ticker-strip:active .tech-ticker-track,.tech-ticker-strip.is-paused .tech-ticker-track{animation-play-state:paused}.tech-ticker-set{display:flex;align-items:center;flex:0 0 auto}@keyframes techTickerMarquee{from{transform:translateX(0)}to{transform:translateX(-50%)}}
        ...
        .tech-news-title-row{display:flex;align-items:center;gap:14px;min-width:0;max-width:100%}.tech-news-title-row>div:last-child{min-width:0;max-width:100%}
        ...
        .tech-news-chip-row{display:flex;gap:9px;overflow-x:auto;max-width:100%;padding-bottom:8px;scrollbar-width:thin;overscroll-behavior-inline:contain;-webkit-overflow-scrolling:touch}
        ...
        .tech-news-more-menu{position:relative;flex:0 0 auto}.tech-news-more-menu summary{list-style:none;border:1px solid var(--tech-border);background:var(--tech-panel);color:var(--tech-muted);border-radius:999px;min-height:40px;padding:0 14px;display:inline-flex;align-items:center;font:950 12px Tajawal,Arial,sans-serif;cursor:pointer;white-space:nowrap}.tech-news-more-menu summary::-webkit-details-marker{display:none}.tech-news-more-menu[open] summary,.tech-news-more-menu:has(button.active) summary{background:#CCFBF1;border-color:rgba(15,118,110,.25);color:#0F766E}.tech-news-more-menu div{position:absolute;z-index:40;inset-inline-start:0;top:calc(100% + 8px);width:250px;max-width:min(82vw,280px);max-height:300px;overflow:auto;padding:8px;display:grid;gap:7px;border:1px solid var(--tech-border-strong);border-radius:16px;background:var(--tech-panel);box-shadow:0 20px 50px rgba(3,18,37,.18)}.tech-news-more-menu div button{width:100%;justify-content:flex-start;text-align:start;border-radius:12px;min-height:38px}
        ...
        .dark .tech-news-more-menu[open] summary,.dark .tech-news-more-menu:has(button.active) summary{background:#2FD6C0;border-color:#2FD6C0;color:#061A2E}.dark .tech-news-more-menu div{background:#0F1D31;border-color:#1D3050;box-shadow:0 22px 56px rgba(0,0,0,.38)}
        ...
        @media(max-width:720px){.tech-news-main{padding-inline:14px;gap:14px}.tech-news-header{display:grid;gap:12px;min-width:0;max-width:100%}.tech-news-header-actions{justify-content:flex-start}.tech-news-title-row{align-items:flex-start;min-width:0}.tech-news-title-icon{width:50px;height:50px}.tech-news-header h1{font-size:28px;line-height:1.2}.tech-news-header p{font-size:12.5px;align-items:flex-start}.tech-news-card,.tech-news-search{border-radius:18px}.tech-news-card{padding:16px;gap:14px}.tech-news-card-top{display:grid;grid-template-columns:1fr;gap:12px}.tech-news-company-wrap{align-items:flex-start;gap:7px}.tech-news-ticker,.tech-news-translation-badge{font-size:11px;padding:5px 9px}.tech-news-card-price{justify-items:start;min-width:0}.tech-news-card h2{font-size:17px;line-height:1.5}.tech-news-card p{font-size:13px;line-height:1.7}.tech-news-meta{display:grid;gap:8px;justify-content:start}.tech-ticker-strip{margin-inline:-2px}.tech-ticker-viewport{overflow-x:auto;scrollbar-width:thin;overscroll-behavior-inline:contain;-webkit-overflow-scrolling:touch}}
        @media(max-width:640px){.tech-news-shell{overflow-x:hidden}.tech-news-main{max-width:100%;padding-inline:12px;padding-top:84px}.tech-news-controls,.tech-news-grid{width:100%;max-width:100%;min-width:0}.tech-news-chip-row{gap:8px;margin-inline:-12px;padding-inline:12px;scrollbar-width:none}.tech-news-chip-row::-webkit-scrollbar{display:none}.tech-news-chip-row button,.tech-news-more-menu summary{min-height:38px;padding:0 12px;font-size:11.5px}.tech-news-more-menu[open]{width:min(78vw,280px)}.tech-news-more-menu[open] div{position:static;margin-top:8px;width:min(78vw,280px);max-width:100%;max-height:260px}.tech-news-filter-icon{width:38px!important}.tech-news-search{min-height:52px;padding-inline:13px}.tech-news-title-row{display:grid;grid-template-columns:auto minmax(0,1fr);gap:10px}.tech-news-header h1{font-size:25px}.tech-news-title-icon{width:44px;height:44px;border-radius:15px}.tech-news-card{border-radius:18px;padding:15px}.tech-news-company{flex-basis:100%;font-size:12.5px}.tech-news-ticker,.tech-news-translation-badge{min-height:30px;padding:6px 9px;font-size:11px}.tech-news-card-price strong{font-size:14px}.tech-news-change{font-size:11px;padding:5px 8px}.tech-news-meta{font-size:11.5px}.tech-news-disclaimer{font-size:11.5px;padding-inline:4px}}
