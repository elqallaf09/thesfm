  ...
  return (
    <div className="tech-news-shell" dir={dir}>
      ...
      <style jsx global>{`
        ...
        @media(max-width:720px){.tech-news-main{padding-inline:14px}.tech-news-header{display:grid}.tech-news-header-actions{justify-content:flex-start}.tech-news-title-icon{width:50px;height:50px}.tech-news-header h1{font-size:29px}.tech-news-card,.tech-news-search{border-radius:18px}.tech-news-card-top{display:grid}.tech-news-card-price{justify-items:start}.tech-news-meta{display:grid;gap:8px}.tech-ticker-strip{margin-inline:-2px}.tech-ticker-viewport{overflow-x:auto;scrollbar-width:thin;overscroll-behavior-inline:contain;-webkit-overflow-scrolling:touch}}
