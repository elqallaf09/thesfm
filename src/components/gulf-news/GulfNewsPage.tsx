  ...
  return (
    <div className="gulf-news-shell" dir={dir}>
      ...
      <style jsx global>{`
        ...
        .gulf-ticker-viewport{width:100%;overflow-x:auto;scrollbar-width:none;overscroll-behavior-inline:contain;-webkit-overflow-scrolling:touch}.gulf-ticker-viewport::-webkit-scrollbar{display:none}.gulf-ticker-track{width:max-content;display:flex;align-items:center;animation:gulfTickerMarquee 38s linear infinite;will-change:transform}.gulf-ticker-strip:hover .gulf-ticker-track,.gulf-ticker-strip:focus-within .gulf-ticker-track,.gulf-ticker-strip:active .gulf-ticker-track{animation-play-state:paused}.gulf-ticker-set{display:flex;align-items:center;flex:0 0 auto}.gulf-ticker-item{flex:0 0 auto;min-height:52px;display:flex;align-items:center;gap:9px;padding:0 16px;border-inline-end:1px solid var(--gulf-border);white-space:nowrap}.gulf-ticker-item strong{direction:ltr;unicode-bidi:isolate;color:var(--gulf-accent);font-size:12px;font-weight:950}.gulf-ticker-item span{color:var(--gulf-text);font-size:12px;font-weight:950;max-width:230px;overflow:hidden;text-overflow:ellipsis}.gulf-ticker-item b{direction:ltr;unicode-bidi:isolate;color:var(--gulf-muted);font-size:12px;font-style:normal}.gulf-ticker-item em{direction:ltr;unicode-bidi:isolate;display:inline-flex;align-items:center;gap:4px;border:1px solid transparent;border-radius:999px;padding:5px 9px;font-size:12px;font-weight:950;font-style:normal;line-height:1.2}.gulf-ticker-item em.up{color:#047857;background:#CCFBF1;border-color:rgba(15,118,110,.20)}.gulf-ticker-item em.down{color:#DC2626;background:#FEE2E2;border-color:rgba(220,38,38,.20)}.gulf-ticker-item em.neutral{color:var(--gulf-muted);background:rgba(142,166,195,.10);border-color:var(--gulf-border)}@keyframes gulfTickerMarquee{from{transform:translateX(0)}to{transform:translateX(-50%)}}
