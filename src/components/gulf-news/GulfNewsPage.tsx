  ...
  return (
    <div className="gulf-news-shell" dir={dir}>
      ...
      <style jsx global>{`
        ...
        .gulf-ticker-strip{border:1px solid var(--gulf-border);background:linear-gradient(180deg,var(--gulf-panel),var(--gulf-panel-soft));border-radius:18px;overflow:hidden;box-shadow:0 16px 44px rgba(3,18,37,.12)}
        .gulf-ticker-track{display:flex;gap:0;overflow-x:auto;scrollbar-width:thin}.gulf-ticker-item{flex:0 0 auto;min-height:48px;display:flex;align-items:center;gap:9px;padding:0 15px;border-inline-end:1px solid var(--gulf-border);white-space:nowrap}.gulf-ticker-item strong{direction:ltr;unicode-bidi:isolate;color:var(--gulf-accent);font-size:12px;font-weight:950}.gulf-ticker-item span{color:var(--gulf-text);font-size:12px;font-weight:950}.gulf-ticker-item b{direction:ltr;unicode-bidi:isolate;color:var(--gulf-muted);font-size:12px;font-style:normal}.gulf-ticker-item em{direction:ltr;unicode-bidi:isolate;display:inline-flex;align-items:center;gap:4px;border-radius:999px;padding:4px 7px;font-size:11px;font-weight:950;font-style:normal}.gulf-ticker-item em.up{color:var(--gulf-accent);background:rgba(47,214,192,.10)}.gulf-ticker-item em.down{color:var(--gulf-red);background:rgba(255,91,110,.10)}.gulf-ticker-item em.neutral{color:var(--gulf-muted);background:rgba(142,166,195,.10)}
        ...
        @media(max-width:720px){.gulf-news-main{padding-inline:14px}.gulf-news-header{display:grid}.gulf-news-header-actions{justify-content:flex-start}.gulf-news-title-icon{width:50px;height:50px}.gulf-news-header h1{font-size:29px}.gulf-news-exchange-grid,.gulf-news-summary{grid-template-columns:1fr}.gulf-news-summary-market{justify-items:start;min-width:0}.gulf-news-summary-market p{text-align:start}.gulf-news-card,.gulf-news-search{border-radius:18px}.gulf-news-meta{display:grid;gap:8px}.gulf-ticker-strip{margin-inline:-2px}}
      `}</style>
    </div>
  );
}
