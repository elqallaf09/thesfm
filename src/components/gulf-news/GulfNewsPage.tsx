  ...
  return (
    <NewsPageShell category="gulf" className="gulf-news-shell" dir={dir} wide>
      ...
      <style jsx global>{`
        ...
        .gulf-news-main{box-sizing:border-box;width:100%;display:grid;gap:18px;overflow-x:hidden}
        .gulf-ticker-strip{position:relative;z-index:2;display:block;width:100%;min-height:52px;border:1px solid var(--gulf-border);background:linear-gradient(180deg,var(--gulf-panel),var(--gulf-panel-soft));border-radius:var(--r-xl);overflow:hidden;box-shadow:0 16px 44px rgba(3,18,37,.12)}
        ...
        .gulf-news-state{display:grid;place-items:center;gap:10px;text-align:center;padding:58px 20px;color:var(--gulf-muted);background:linear-gradient(180deg,var(--gulf-panel),var(--gulf-panel-soft));border:1px dashed var(--gulf-border-strong);border-radius:var(--r-2xl)}.gulf-news-state svg{color:var(--gulf-accent)}.gulf-news-state strong{display:block;color:var(--gulf-text);font-size:19px;font-weight:950}.gulf-news-state p{margin:0;max-width:620px;color:var(--gulf-muted);font-weight:850;line-height:1.75}.gulf-news-state button{border:0;border-radius:var(--r-md);background:var(--gulf-accent);color:#061A2E;display:inline-flex;align-items:center;gap:8px;min-height:44px;padding:0 13px;font:950 12px Tajawal,Arial,sans-serif;cursor:pointer}.gulf-news-disclaimer{margin:2px auto 0;text-align:center;color:var(--gulf-muted);font-size:12px;font-weight:820;line-height:1.7}
        .gulf-news-skeleton span,.gulf-news-skeleton i,.gulf-news-skeleton b,.gulf-news-skeleton small{display:block;border-radius:999px;background:linear-gradient(90deg,rgba(142,166,195,.10),rgba(47,214,192,.20),rgba(142,166,195,.10));background-size:220% 100%;animation:gulfNewsShimmer 1.2s linear infinite}.gulf-news-skeleton span{width:42%;height:18px}.gulf-news-skeleton i{width:100%;height:15px}.gulf-news-skeleton i:nth-child(3){width:76%}.gulf-news-skeleton b{width:58%;height:38px;border-radius:var(--r-md)}.gulf-news-skeleton small{width:35%;height:14px}@keyframes gulfNewsShimmer{to{background-position:-220% 0}}
        ...
        @media(max-width:720px){.gulf-news-header{display:grid}.gulf-news-header-actions{justify-content:flex-start}.gulf-news-title-icon{width:50px;height:50px}.gulf-news-header h1{font-size:29px}.gulf-news-exchange-grid,.gulf-news-summary,.gulf-news-grid{grid-template-columns:1fr}.gulf-news-summary-market{justify-items:start;min-width:0}.gulf-news-summary-market p{text-align:start}.gulf-news-card,.gulf-news-search{border-radius:var(--r-xl)}.gulf-news-meta{display:grid;gap:8px}.gulf-ticker-strip{margin-inline:-2px}.gulf-ticker-viewport{overflow-x:auto;scrollbar-width:thin;overscroll-behavior-inline:contain;-webkit-overflow-scrolling:touch}.gulf-ticker-item span{max-width:210px}}
        .gulf-news-main{gap:20px}
        .gulf-news-header{position:relative;overflow:hidden;padding:24px;border:1px solid var(--gulf-border);border-radius:var(--r-2xl);background:linear-gradient(135deg,#071C31 0%,#0B2F44 58%,rgba(47,214,192,.28) 100%);box-shadow:0 20px 54px rgba(3,18,37,.14)}
        ...
        .gulf-news-status-bar{border-radius:var(--r-lg);padding:12px 16px;justify-content:space-between}
        .gulf-news-provider-state{min-height:44px;display:flex;align-items:center;gap:10px;flex-wrap:wrap;border:1px solid rgba(47,214,192,.24);border-radius:var(--r-lg);background:rgba(47,214,192,.08);color:var(--gulf-text);padding:10px 14px;font-size:13px;font-weight:850}.gulf-news-provider-state.warning{border-color:rgba(245,185,66,.34);background:rgba(245,185,66,.10)}.gulf-news-provider-state.warning>svg{color:var(--gulf-amber);flex:0 0 auto}.gulf-news-provider-state strong{margin-inline-start:auto;color:var(--gulf-muted);font-size:12px}
        ...
        .gulf-news-exchange-grid button{min-width:180px;min-height:104px;padding:14px;border-radius:var(--r-xl);box-shadow:0 14px 34px rgba(3,18,37,.08)}
        .gulf-news-exchange-code{width:48px;height:48px;border-radius:var(--r-lg);font-size:17px}
        .gulf-news-exchange-name{font-size:14px}
        .gulf-news-exchange-value{font-size:15px}
        .gulf-news-summary{border-radius:var(--r-2xl);padding:18px 20px;box-shadow:0 16px 40px rgba(3,18,37,.08)}
        .gulf-news-market-pulse{display:grid;grid-template-columns:minmax(240px,.65fr) 1fr;gap:16px;align-items:stretch;border:1px solid var(--gulf-border);border-radius:var(--r-2xl);background:linear-gradient(180deg,var(--gulf-panel),var(--gulf-panel-soft));padding:18px;box-shadow:0 16px 40px rgba(3,18,37,.08)}
        ...
        .gulf-news-section-heading>span{width:42px;height:42px;border-radius:var(--r-md);display:grid;place-items:center;background:rgba(47,214,192,.12);border:1px solid rgba(47,214,192,.24);color:var(--gulf-accent);flex:0 0 auto}
        ...
        .gulf-news-pulse-grid div{min-width:0;border:1px solid var(--gulf-border);border-radius:var(--r-lg);background:rgba(255,255,255,.46);padding:14px;display:grid;gap:5px}
        ...
        .gulf-news-controls{background:linear-gradient(180deg,var(--gulf-panel),var(--gulf-panel-soft));border:1px solid var(--gulf-border);border-radius:var(--r-2xl);padding:16px;box-shadow:0 16px 40px rgba(3,18,37,.08)}
        .gulf-news-search{min-height:52px;border-radius:var(--r-lg);box-shadow:none;background:rgba(255,255,255,.68)}
        ...
        .gulf-news-filter-row select{width:100%;min-height:46px;border:1px solid var(--gulf-border);border-radius:var(--r-md);background:rgba(255,255,255,.72);color:var(--gulf-text);font:900 13px Tajawal,Arial,sans-serif;padding-inline:12px;outline:none}
        ...
        .gulf-news-results-toolbar{display:flex;align-items:center;justify-content:space-between;gap:14px;border:1px solid var(--gulf-border);border-radius:var(--r-xl);background:linear-gradient(180deg,var(--gulf-panel),var(--gulf-panel-soft));padding:14px 16px;box-shadow:0 14px 34px rgba(3,18,37,.06)}
        ...
        .gulf-news-card{min-height:100%;padding:18px;border-radius:var(--r-xl);box-shadow:0 16px 40px rgba(3,18,37,.09)}
        ...
        .gulf-news-evidence{display:flex;align-items:flex-start;gap:9px;border:1px solid var(--gulf-border);border-radius:var(--r-md);background:rgba(142,166,195,.07);padding:10px;color:var(--gulf-muted)}.gulf-news-evidence>svg{flex:0 0 auto;margin-top:2px;color:var(--gulf-accent)}.gulf-news-evidence>div{display:grid;gap:2px;min-width:0}.gulf-news-evidence strong{color:var(--gulf-text);font-size:12px;font-weight:950}.gulf-news-evidence span{font-size:12px;font-weight:760;line-height:1.55}.gulf-news-evidence.official{border-color:rgba(47,214,192,.28);background:rgba(47,214,192,.08)}.gulf-news-evidence.conflicting{border-color:rgba(245,185,66,.34);background:rgba(245,185,66,.10)}.gulf-news-evidence.conflicting>svg{color:var(--gulf-amber)}
        ...
        @media(max-width:720px){.gulf-news-main{overflow-x:hidden}.gulf-news-header{padding:18px;border-radius:var(--r-xl)}.gulf-news-title-row{min-width:0}.gulf-news-header-actions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));width:100%;justify-content:stretch}.gulf-news-icon-btn{width:100%;min-height:44px}.gulf-news-status-bar{justify-content:flex-start}.gulf-news-exchange-grid{display:flex;overflow-x:auto;scroll-padding-inline:12px}.gulf-news-exchange-grid button{min-width:min(82vw,260px);min-height:112px}.gulf-news-pulse-grid{grid-template-columns:1fr}.gulf-news-summary{padding:16px}.gulf-news-summary-identity{align-items:flex-start}.gulf-news-summary-code{width:52px;height:52px}.gulf-news-results-toolbar h2{font-size:18px}.gulf-news-card{padding:15px}.gulf-news-card h2{font-size:17px;overflow-wrap:anywhere}.gulf-news-card p{font-size:13px}.gulf-news-meta{display:grid}.gulf-news-read-link{justify-content:center;min-height:44px}.gulf-news-filter-row select{min-height:44px}.gulf-news-state{padding:22px 14px;border-radius:var(--r-xl)}.gulf-news-state button{min-height:44px}.gulf-news-view-toggle button{min-height:44px}.gulf-ticker-item span{max-width:68vw;overflow:hidden;text-overflow:ellipsis}.gulf-news-market-pulse{padding:14px;border-radius:var(--r-xl)}}
