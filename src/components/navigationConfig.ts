...
export const NAV_GROUPS: NavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'metals-news', icon: CircleDollarSign, href: '/metals-news', labelKey: 'nav_metals_news' },
      { id: 'healthcare-stocks-news', icon: Activity, href: '/healthcare-stocks-news', labelKey: 'nav_healthcare_stocks_news' },
      { id: 'new-stocks-news', icon: Sparkles, href: '/new-stocks-news', labelKey: 'nav_new_stocks_news' },
      { id: 'stocks-under-one', icon: CircleDollarSign, href: '/stocks-under-1', labelKey: 'nav_stocks_under_one' },
      { id: 'earnings-news', icon: BarChart3, href: '/earnings-news', labelKey: 'nav_earnings_news' },
      { id: 'analyst-ratings-news', icon: Radar, href: '/analyst-ratings-news', labelKey: 'nav_analyst_ratings_news' },
      { id: 'mergers-acquisitions-news', icon: BriefcaseBusiness, href: '/mergers-acquisitions-news', labelKey: 'nav_mergers_acquisitions_news' },
      { id: 'unusual-moves-news', icon: TrendingUp, href: '/unusual-moves-news', labelKey: 'nav_unusual_moves_news' },
