    ...
    >
      ...
      <style jsx global>{`
        ...
        .sfm-workspace-tabs {
          ...
          /* Snapping may choose a neighbouring tab after scrollIntoView and
             leave the requested destination clipped in RTL. Keep the rail
             freely scrollable; active-tab positioning is handled above. */
