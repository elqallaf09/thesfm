  ...
  return (
    <div ref={layerRef} className={`sfm-mobile-layer${open ? ' open' : ''}`} aria-hidden={!open} dir={dir}>
      ...
      <style jsx global>{`
        ...
        .sfm-mobile-panel-head{min-height:52px;justify-content:space-between;gap:8px;padding:5px 6px;border:1px solid color-mix(in srgb,var(--sidebar-glass-border) 74%,transparent);flex:0 0 auto;background:var(--sidebar-glass-bg-elevated);border-radius:var(--radius-card);box-shadow:var(--sidebar-glass-inner-shadow),0 8px 20px color-mix(in srgb,var(--sidebar-active) 7%,transparent)}
