  ...
  return (
    <div ref={layerRef} className={`sfm-mobile-layer${open ? ' open' : ''}`} aria-hidden={!open} dir={dir}>
      ...
      <style jsx global>{`
        ...
        .sfm-mobile-group-label{margin:0;padding-inline:8px;color:var(--foreground-secondary);font-size:var(--type-label-size);font-weight:var(--type-label-weight);line-height:var(--type-label-leading);overflow-wrap:anywhere}
        ...
        .sfm-mobile-nav-item,.sfm-mobile-parent-item,.sfm-mobile-subitem,.sfm-mobile-support-links button,.sfm-mobile-support-links a{position:relative;width:100%;min-width:0;min-height:var(--control-h);display:flex;align-items:center;gap:10px;padding:8px 10px;border:1px solid transparent;border-radius:var(--radius-control);background:transparent;color:var(--foreground-secondary);text-align:start;text-decoration:none;font:var(--type-navigation-weight) var(--type-navigation-size)/var(--type-navigation-leading) var(--font-ui);cursor:pointer;transition:background-color .15s ease,color .15s ease,border-color .15s ease}
        ...
        .sfm-mobile-nav-item.active,.sfm-mobile-subitem.active,.sfm-mobile-support-links button.active,.sfm-mobile-support-links a.active{background:var(--sidebar-active);color:var(--sidebar-active-foreground);font-weight:var(--type-navigation-active-weight)}
        ...
        .sfm-mobile-subitems{padding-inline-start:18px;margin-top:2px}.sfm-mobile-subitem{font-size:var(--type-navigation-size)}
        .sfm-mobile-global-group{display:grid;gap:4px;padding-top:2px}
        .sfm-mobile-global-toggle{width:100%;min-height:var(--control-h);display:flex;align-items:center;gap:8px;padding:7px 9px;border:0;border-radius:var(--radius-control);background:transparent;color:var(--foreground-secondary);text-align:start;font:var(--type-label-weight) var(--type-label-size)/var(--type-label-leading) var(--font-ui);cursor:pointer}
        ...
        .sfm-mobile-support-links{display:grid;gap:3px}.sfm-mobile-support-links button,.sfm-mobile-support-links a{min-height:var(--control-h);font-size:var(--type-navigation-size)}
