  ...
  return (
    <div ref={layerRef} className={`sfm-mobile-layer${open ? ' open' : ''}`} aria-hidden={!open} dir={dir}>
      ...
      <style jsx global>{`
        ...
        .sfm-mobile-panel{position:fixed;inset-block:0;inset-inline-start:0;z-index:9999;width:min(408px,92vw);max-width:100%;height:100vh;height:100dvh;display:flex;flex-direction:column;min-height:0;overflow:hidden;isolation:isolate;padding:calc(12px + env(safe-area-inset-top)) 12px calc(12px + env(safe-area-inset-bottom));background-color:var(--sidebar-glass-bg-fallback)!important;background-image:var(--sidebar-glass-bg)!important;border-inline-end:1px solid var(--sidebar-glass-border)!important;border-radius:0 var(--radius-panel) var(--radius-panel) 0;box-shadow:var(--sidebar-glass-shadow),var(--sidebar-glass-inner-shadow);color:var(--sidebar-item-text)!important;-webkit-backdrop-filter:var(--sidebar-mobile-glass-filter);backdrop-filter:var(--sidebar-mobile-glass-filter);transform:translateX(-102%);transition:transform var(--duration) var(--ease)}
        .sfm-mobile-panel::before{content:"";position:absolute;z-index:-1;inset-block-start:0;inset-inline:0;height:34%;border-radius:inherit;background:var(--sidebar-glass-reflection);pointer-events:none}
        ...
        .sfm-mobile-panel-head{min-height:56px;justify-content:space-between;gap:10px;padding:7px;border:1px solid var(--sidebar-glass-border);flex:0 0 auto;background:var(--sidebar-glass-bg-elevated);border-radius:var(--radius-card);box-shadow:var(--sidebar-glass-inner-shadow),var(--sidebar-glass-glow)}
        .sfm-mobile-head-actions{gap:6px;flex:0 0 auto}
        .sfm-mobile-logo{min-width:0;gap:10px}.sfm-mobile-logo img{width:38px;height:38px;flex:0 0 38px;padding:3px;border:1px solid var(--sidebar-glass-border);border-radius:var(--radius-control);background:var(--sidebar-search-bg);box-shadow:var(--sidebar-item-shadow);object-fit:cover}.sfm-mobile-logo strong{display:block;color:var(--sidebar-item-text);font-size:15px;font-weight:600;line-height:1.45}.sfm-mobile-logo span{display:block;color:var(--sidebar-item-text-muted);font-size:var(--type-caption-size);font-weight:var(--type-caption-weight);line-height:var(--type-caption-leading);margin-top:1px;overflow-wrap:anywhere}
        .sfm-mobile-close{width:var(--control-h);height:var(--control-h);min-width:var(--control-h);display:grid;place-items:center;border:1px solid var(--sidebar-search-border);border-radius:var(--radius-control);background:var(--sidebar-search-bg);color:var(--sidebar-icon);box-shadow:var(--sidebar-search-shadow);cursor:pointer;transition:background-color var(--duration-fast) var(--ease),border-color var(--duration-fast) var(--ease),color var(--duration-fast) var(--ease),transform var(--duration-fast) var(--ease)}
        ...
        .sfm-mobile-search{padding:9px 2px;border-bottom:1px solid var(--sidebar-divider);flex:0 0 auto}
        ...
        .sfm-mobile-group{display:grid;gap:6px;min-width:0;padding:7px;border:1px solid var(--sidebar-item-border);border-radius:var(--radius-card);background:var(--sidebar-item-bg);box-shadow:var(--sidebar-item-shadow)}
        ...
        .sfm-mobile-nav-item,.sfm-mobile-parent-item,.sfm-mobile-subitem,.sfm-mobile-support-link{position:relative;width:100%;min-width:0;min-height:var(--control-h);display:flex;align-items:center;gap:9px;padding:6px 8px;border:1px solid var(--sidebar-item-border);border-radius:var(--radius-control);background:var(--sidebar-item-bg);color:var(--sidebar-item-text);box-shadow:var(--sidebar-item-shadow);text-align:start;text-decoration:none;font:var(--type-navigation-weight) var(--type-navigation-size)/var(--type-navigation-leading) var(--font-ui);cursor:pointer;transition:background-color var(--duration-fast) var(--ease),color var(--duration-fast) var(--ease),border-color var(--duration-fast) var(--ease),box-shadow var(--duration-fast) var(--ease),transform var(--duration-fast) var(--ease)}
        ...
        .sfm-mobile-nav-icon,.sfm-mobile-subitem-icon,.sfm-mobile-support-icon{width:30px;height:30px;display:grid;place-items:center;flex:0 0 30px;border:1px solid var(--sidebar-item-border);border-radius:var(--radius-control);background:var(--sidebar-search-bg);color:var(--sidebar-icon);box-shadow:var(--sidebar-glass-inner-shadow);transition:background-color var(--duration-fast) var(--ease),color var(--duration-fast) var(--ease)}
        ...
        .sfm-mobile-subitems{padding-inline-start:12px;margin-inline-start:14px;margin-top:3px;border-inline-start:1px solid var(--sidebar-divider)}
        .sfm-mobile-subitem{font-size:var(--type-navigation-size)}
        .sfm-mobile-utilities{flex:0 1 auto;min-height:0;max-height:min(43dvh,360px);display:grid;grid-template-rows:minmax(0,1fr) auto;gap:8px;padding:8px;border:1px solid var(--sidebar-glass-border);border-radius:var(--radius-card);background:var(--sidebar-footer-bg);box-shadow:var(--sidebar-glass-inner-shadow),var(--sidebar-glass-glow)}
