...
function CryptoTickerStrip({
  ...
  return (
    <div className="crypto-live-ticker" dir="ltr">
      ...
      <div className="crypto-ticker-viewport">
        <div className="crypto-ticker-track">
          <div className="crypto-ticker-set">
            {items.map(coin => {
              ...
              return (
                ...
                >
                  ...
                  <b title={labels.price}>{formatPrice(coin.price)}</b>
                  <em className={tone} title={labels.change24h}>
                    <Icon size={12} />
