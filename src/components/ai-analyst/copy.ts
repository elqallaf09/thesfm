...
export const AI_ANALYST_COPY = {
  ar: {
    ...
    navigation: {
      ...
      items: {
        overview: 'نظرة عامة', analysis: 'التحليل الذكي', assistant: 'المساعد الذكي', compare: 'المقارنة', agent: 'وكيل السوق الذكي', path: 'مسار التحليل', history: 'السجل والدقة', future: 'الفرص القادمة',
    ...
    assetType: {
      label: 'نوع الأصل',
      loading: 'جارٍ التحقق من نوع الأصل…',
      unresolved: 'نوع غير محدد',
      whatIsThis: 'ما هذا؟',
      whatIsThisAria: 'اعرف المزيد عن تصنيف نوع الأصل',
      popoverTitle: 'ما المقصود بتصنيف نوع الأصل؟',
      popoverBodyResolved: 'يصف هذا التصنيف نوع الأداة المالية المتداولة تحت هذا الرمز، بحسب البيانات الموثقة من مزود السوق. هذا وصف لنوع الأداة فقط، وليس توصية بالشراء أو البيع. يحدد هذا النوع أيضاً البيانات وأدوات التحليل المتاحة لهذا الأصل تحديداً.',
      popoverBodyUnresolved: 'تعذّر التحقق من نوع هذه الأداة المالية من مزودي البيانات المتصلين حالياً، لذلك لا يُعرض تصنيف افتراضي. لا يُستخدم اسم الرمز وحده لتخمين النوع.',
      close: 'إغلاق',
    },
    chat: {
      title: 'المساعد الذكي',
      subtitle: 'اسأل عن الأصل المحدد حالياً أو عن أسئلة مالية عامة. تُستخدم بيانات السوق الموثقة فقط، ولا تُختلق أي بيانات.',
      welcomeGeneric: 'مرحباً، أنا مساعد إس إف إم للأسواق. اسألني عن أي رمز مالي متاح، وسأجيبك بالاعتماد على البيانات الموثقة فقط.',
      welcomeWithAsset: 'مرحباً، أرى أنك تعرض {name} ({symbol})، المصنّف كـ{assetType}. اسألني عنه أو عن أي سؤال مالي آخر.',
      placeholder: 'اكتب سؤالك عن هذا الأصل أو عن الأسواق…',
      send: 'إرسال',
      disclaimer: 'هذا تحليل تعليمي مبني على البيانات المتاحة، وليس توصية استثمارية أو ضماناً لأي عائد.',
      loading: 'جارٍ الرد…',
      unavailable: 'الخدمة غير متاحة حالياً. حاول مرة أخرى بعد قليل.',
      fallback: 'وصلتني رسالتك، لكن لم أستطع توليد رد الآن.',
  ...
  en: {
    ...
    navigation: {
      ...
      items: {
        overview: 'Overview', analysis: 'Intelligent analysis', assistant: 'AI Assistant', compare: 'Compare', agent: 'AI market agent', path: 'Analysis path', history: 'History and accuracy', future: 'Future opportunities',
    ...
    assetType: {
      label: 'Asset type',
      loading: 'Checking asset type…',
      unresolved: 'Type not resolved',
      whatIsThis: 'What is this?',
      whatIsThisAria: 'Learn more about this asset-type classification',
      popoverTitle: 'What does the asset-type classification mean?',
      popoverBodyResolved: 'This label describes the type of financial instrument traded under this symbol, based on verified market-provider data. It only describes the instrument type — it is not a recommendation to buy or sell. This type also determines which data and analysis tools are available for this specific asset.',
      popoverBodyUnresolved: 'This financial instrument’s type could not be verified against the currently connected data providers, so no default classification is shown. The symbol name alone is never used to guess the type.',
      close: 'Close',
    },
    chat: {
      title: 'AI Assistant',
      subtitle: 'Ask about the currently selected asset or general financial questions. Only verified market data is used — nothing is invented.',
      welcomeGeneric: 'Hi, I’m the SFM markets assistant. Ask me about any available financial symbol and I’ll answer using verified data only.',
      welcomeWithAsset: 'Hi, I can see you’re viewing {name} ({symbol}), classified as {assetType}. Ask me about it or any other financial question.',
      placeholder: 'Type your question about this asset or the markets…',
      send: 'Send',
      disclaimer: 'This is educational analysis based on available data, not investment advice or a guarantee of any return.',
      loading: 'Replying…',
      unavailable: 'The service is unavailable right now. Please try again shortly.',
      fallback: 'I received your message, but could not generate a reply right now.',
  ...
  fr: {
    ...
    navigation: {
      ...
      items: {
        overview: 'Vue d’ensemble', analysis: 'Analyse intelligente', assistant: 'Assistant IA', compare: 'Comparer', agent: 'Agent de marché IA', path: 'Parcours d’analyse', history: 'Historique et précision', future: 'Opportunités futures',
    ...
    assetType: {
      label: 'Type d’actif',
      loading: 'Vérification du type d’actif…',
      unresolved: 'Type non déterminé',
      whatIsThis: 'Qu’est-ce que c’est ?',
      whatIsThisAria: 'En savoir plus sur cette classification de type d’actif',
      popoverTitle: 'Que signifie la classification du type d’actif ?',
      popoverBodyResolved: 'Cette étiquette décrit le type d’instrument financier négocié sous ce symbole, d’après des données vérifiées du fournisseur de marché. Elle décrit uniquement le type d’instrument — ce n’est pas une recommandation d’achat ou de vente. Ce type détermine également les données et outils d’analyse disponibles pour cet actif précis.',
      popoverBodyUnresolved: 'Le type de cet instrument financier n’a pas pu être vérifié auprès des fournisseurs de données actuellement connectés ; aucune classification par défaut n’est donc affichée. Le nom du symbole seul n’est jamais utilisé pour deviner le type.',
      close: 'Fermer',
    },
    chat: {
      title: 'Assistant IA',
      subtitle: 'Posez des questions sur l’actif actuellement sélectionné ou des questions financières générales. Seules des données de marché vérifiées sont utilisées — rien n’est inventé.',
      welcomeGeneric: 'Bonjour, je suis l’assistant marchés de SFM. Posez-moi vos questions sur tout symbole financier disponible ; je répondrai uniquement à partir de données vérifiées.',
      welcomeWithAsset: 'Bonjour, je vois que vous consultez {name} ({symbol}), classé comme {assetType}. Posez-moi vos questions à ce sujet ou toute autre question financière.',
      placeholder: 'Écrivez votre question sur cet actif ou sur les marchés…',
      send: 'Envoyer',
      disclaimer: 'Ceci est une analyse éducative fondée sur les données disponibles, et non un conseil d’investissement ni une garantie de rendement.',
      loading: 'Réponse en cours…',
      unavailable: 'Le service est indisponible pour l’instant. Veuillez réessayer dans quelques instants.',
      fallback: 'J’ai reçu votre message, mais je n’ai pas pu générer une réponse pour l’instant.',
