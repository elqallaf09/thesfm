...
export const AI_ANALYST_COPY = {
  ar: {
    ...
    tabs: { overview: 'نظرة عامة', analysis: 'التحليل', timeline: 'المسار', history: 'السجل', compare: 'المقارنة', agent: 'الوكيل', future: 'ميزات قادمة' },
    navigation: {
    ...
    analysis: {
      ...
      normalRefresh: 'تحديث العرض',
      refresh: 'تحديث التحليل',
      signInRefresh: 'سجّل الدخول لتحديث التحليل',
      lastRefresh: 'آخر تحديث',
      retryAvailable: 'يتاح التحديث مجدداً بعد',
      disclaimer: 'هذا التحليل معلوماتي ولا يمثل أمراً بتنفيذ صفقة أو ضماناً للنتائج.',
    ...
    agent: {
      ...
      guardrail: 'هذا التحليل معلوماتي ولا يمثل أمراً بتنفيذ صفقة أو ضماناً للنتائج.',
    },
    future: {
      title: 'ميزات قادمة',
  ...
  en: {
    ...
    tabs: { overview: 'Overview', analysis: 'Analysis', timeline: 'Timeline', history: 'History', compare: 'Compare', agent: 'Agent', future: 'Upcoming features' },
    navigation: {
    ...
    analysis: {
      ...
      normalRefresh: 'Refresh view',
      refresh: 'Refresh analysis',
      signInRefresh: 'Sign in to refresh analysis',
      lastRefresh: 'Last refresh',
      retryAvailable: 'Refresh becomes available after',
      disclaimer: 'This analysis is informational and does not execute trades or guarantee results.',
    ...
    agent: {
      ...
      guardrail: 'This analysis is informational and does not execute trades or guarantee results.',
    },
    future: {
  ...
  fr: {
    ...
    tabs: { overview: 'Vue d’ensemble', analysis: 'Analyse', timeline: 'Chronologie', history: 'Historique', compare: 'Comparer', agent: 'Agent', future: 'Fonctionnalités à venir' },
    navigation: {
    ...
    analysis: {
      ...
      normalRefresh: 'Actualiser l’affichage',
      refresh: 'Actualiser l’analyse',
      signInRefresh: 'Connectez-vous pour actualiser l’analyse',
      lastRefresh: 'Dernière actualisation',
      retryAvailable: 'Actualisation disponible après',
      disclaimer: 'Cette analyse est informative et n’exécute aucune transaction ni ne garantit les résultats.',
    ...
    agent: {
      ...
      guardrail: 'Cette analyse est informative et n’exécute aucune transaction ni ne garantit les résultats.',
    },
    future: {
