...
const MARKET_SURFACE_COPY: Record<AiAnalystMarketSurfaceLocale, MarketSurfaceCopy> = {
  ar: {
    ...
    mapUnavailable: 'خريطة الأسواق غير متاحة بعد',
    mapUnavailableBody: 'لا توجد تغطية موثقة كافية لرسم خريطة سوق حالياً. لم يتم إنشاء خريطة بديلة.',
    news: 'أخبار الأسواق',
  ...
  en: {
    ...
    mapUnavailable: 'Market map is not available yet',
    mapUnavailableBody: 'There is not enough verified coverage to draw a market map right now. No substitute map has been created.',
    news: 'Market news',
  ...
  fr: {
    ...
    mapUnavailable: 'La carte des marchés n’est pas encore disponible',
    mapUnavailableBody: 'La couverture vérifiée est insuffisante pour dessiner une carte des marchés actuellement. Aucune carte de remplacement n’a été créée.',
