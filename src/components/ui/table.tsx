...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("bg-[var(--table-header)] [&_tr]:border-b", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t bg-[var(--table-header)] font-medium text-foreground [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors hover:bg-[var(--table-row-hover)] focus-within:bg-[var(--table-row-hover)] data-[state=selected]:bg-[var(--table-row-selected)] aria-selected:bg-[var(--table-row-selected)] motion-reduce:transition-none",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn("mt-4 text-sm leading-6 text-muted-foreground", className)}
    {...props}
  />
))
