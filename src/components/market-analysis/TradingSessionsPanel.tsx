  ...
  return (
    <section className="market-panel trading-sessions-dashboard">
      ...
      <style jsx global>{`
        ...
        .session-overlap-card small{display:inline-flex;margin-top:9px;border-radius:var(--radius-pill);border:1px solid color-mix(in srgb, var(--accent) 16%, transparent);background:var(--surface-muted);color:var(--foreground);padding:6px 9px;font-family:var(--font-data);font-size:11px;font-weight:700;line-height:1.2;font-variant-numeric:tabular-nums}
        .session-overlap-card b{grid-column:1/-1;width:max-content;max-width:100%;border-radius: var(--radius-pill);border:1px solid color-mix(in srgb, var(--warning) 22%, transparent);background:color-mix(in srgb, var(--warning) 10%, transparent);color:var(--warning);padding:6px 10px;font-size:11px;font-weight: 700;line-height:1.2}
        ...
        .session-hour-row span{position:absolute;top:0;transform:translateX(-50%);color:var(--foreground-muted);font-family:var(--font-data);font-size:11px;font-weight:700;font-variant-numeric:tabular-nums}
        ...
        .session-row-label small{color:var(--foreground-muted);font-family:var(--font-data);font-size:11px;font-weight:700;line-height:1.2;font-variant-numeric:tabular-nums}
        .session-row-label .session-badge{width:max-content;border-radius: var(--radius-pill);padding:6px 9px;background:color-mix(in srgb, var(--foreground-muted) 12%, transparent);color:var(--foreground-muted);font-size:11px;font-weight: 700;line-height:1.2}
