...
function MarketNewsWorkspaceStyles() {
  return (
    <style jsx global>{`
      ...
      .market-news-sentiment-pills span{display:grid;gap:2px;border:1px solid color-mix(in srgb, var(--accent) 12%, transparent);background:var(--surface);border-radius:var(--radius-control);padding:9px;color:var(--foreground-muted);font-size:11px;font-weight: 700;line-height:1.3}
      ...
      .market-news-sentiment-meter>small{color:var(--foreground-muted);font-size:11px;font-weight: 500;line-height:1.7}
      ...
      .market-news-card-meta{display:flex;gap:7px;align-items:center;flex-wrap:wrap;color:var(--foreground-muted);font-size:11px;font-weight: 700}
      ...
      .market-news-asset-panel span{color:var(--foreground-muted);font-size:11px;font-weight: 700}
