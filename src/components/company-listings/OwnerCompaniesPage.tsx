  ...
  return (
    <>
      ...
      <style>{`
        ...
        .owner-modal-overlay{position:fixed;inset:0;z-index:240;background:rgba(3,18,37,.56);display:flex;align-items:center;justify-content:center;padding:1rem}
        .owner-modal{width:min(920px,100%);max-height:92vh;overflow:auto;border-radius:24px;background:#fff;color:#0b2138;box-shadow:0 24px 70px rgba(0,0,0,.28)}
        .owner-modal-head{position:sticky;top:0;background:linear-gradient(135deg,#f8fcff,#e8fbfb);border-bottom:1px solid rgba(47,214,192,.18);padding:1rem 1.25rem;display:flex;align-items:center;justify-content:space-between;gap:1rem;z-index:1}
        ...
        .owner-form{padding:1.25rem;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem}
        .owner-field{display:flex;flex-direction:column;gap:.4rem}.owner-field.full{grid-column:1/-1}.owner-field label{font-size:.82rem;font-weight:950;color:#334155}.owner-field input,.owner-field select,.owner-field textarea{width:100%;box-sizing:border-box;border:1.5px solid #dbeafe;background:#f8fbff;border-radius:14px;min-height:46px;padding:.7rem .85rem;font:800 .9rem Tajawal,Arial,sans-serif;color:#0b2138}.owner-field textarea{min-height:92px;resize:vertical}.owner-field input:focus,.owner-field select:focus,.owner-field textarea:focus{outline:none;border-color:#18d4d4;box-shadow:0 0 0 4px rgba(47,214,192,.14)}
        .owner-modal-actions{position:sticky;bottom:0;background:rgba(255,255,255,.94);border-top:1px solid rgba(47,214,192,.18);padding:1rem 1.25rem;display:flex;gap:.75rem;justify-content:flex-start;flex-wrap:wrap}
