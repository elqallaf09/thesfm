...
export const assetAliases: AssetAlias[] = [
  ...
  {
    aliases: ['أجيليتي', 'اجيليتي', 'Agility', 'Agility Public Warehousing', 'AGLTY', 'MKHZN'],
    symbol: 'MKHZN',
    symbolCandidates: ['MKHZN.KW', 'MKHZN', 'MKHZN:KSE', 'AGLTY.KW', 'AGLTY'],
    nameAr: 'أجيليتي',
    nameEn: 'Agility Public Warehousing',
    marketAr: 'بورصة الكويت',
    marketEn: 'Boursa Kuwait',
    assetType: 'stock',
    currency: 'KWD',
