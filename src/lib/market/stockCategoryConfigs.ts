...
export const STOCK_CATEGORY_CONFIGS: StockCategoryConfig[] = [
  {
    ...
    rssQuery: 'defense stocks OR aerospace defense stocks OR defense contractors OR cybersecurity defense stocks OR military technology stocks',
    filters: [
      commonFilterAll,
      { key: 'defense_contractors', labelKey: 'defensive_news_category_consumer_staples', keywords: ['defense contractor', 'defense contracts', 'military contract', 'pentagon'] },
      { key: 'aerospace', labelKey: 'defensive_news_category_healthcare', keywords: ['aerospace', 'aircraft', 'aviation', 'missile', 'space defense'] },
      { key: 'cybersecurity', labelKey: 'defensive_news_category_utilities', keywords: ['cybersecurity', 'cyber security', 'ransomware', 'data breach', 'zero trust'] },
      { key: 'government_services', labelKey: 'defensive_news_category_telecom', keywords: ['government services', 'federal contract', 'intelligence contract'] },
      { key: 'defense_systems', labelKey: 'defensive_news_category_food_beverage', keywords: ['radar', 'weapons system', 'missile defense', 'surveillance'] },
      { key: 'defense_etfs', labelKey: 'defensive_news_category_essential_retail', keywords: ['defense ETF', 'aerospace ETF', 'defense fund'] },
    ],
    watchlist: [
      { symbol: 'LMT', name: 'Lockheed Martin', filter: 'defense_contractors', filters: ['defense_contractors', 'defense_systems'], aliases: ['Lockheed'] },
      { symbol: 'NOC', name: 'Northrop Grumman', filter: 'defense_contractors', filters: ['defense_contractors', 'aerospace'], aliases: ['Northrop'] },
      { symbol: 'RTX', name: 'RTX Corporation', filter: 'defense_contractors', filters: ['defense_contractors', 'aerospace'], aliases: ['Raytheon', 'Pratt Whitney'] },
      { symbol: 'GD', name: 'General Dynamics', filter: 'defense_contractors', filters: ['defense_contractors', 'government_services'] },
      { symbol: 'HII', name: 'Huntington Ingalls Industries', filter: 'defense_contractors', filters: ['defense_contractors', 'defense_systems'] },
      { symbol: 'LHX', name: 'L3Harris Technologies', filter: 'defense_systems', filters: ['defense_systems', 'government_services'], aliases: ['L3Harris'] },
      { symbol: 'BA', name: 'Boeing', filter: 'aerospace', filters: ['aerospace', 'defense_contractors'] },
      { symbol: 'TDG', name: 'TransDigm Group', filter: 'aerospace', filters: ['aerospace'] },
      { symbol: 'HEI', name: 'HEICO', filter: 'aerospace', filters: ['aerospace'] },
      { symbol: 'KTOS', name: 'Kratos Defense & Security Solutions', filter: 'defense_systems', aliases: ['Kratos'] },
      { symbol: 'PLTR', name: 'Palantir', filter: 'government_services', filters: ['government_services', 'cybersecurity'] },
      { symbol: 'PANW', name: 'Palo Alto Networks', filter: 'cybersecurity', aliases: ['Palo Alto'] },
      { symbol: 'CRWD', name: 'CrowdStrike', filter: 'cybersecurity' },
      { symbol: 'ZS', name: 'Zscaler', filter: 'cybersecurity' },
      { symbol: 'FTNT', name: 'Fortinet', filter: 'cybersecurity' },
      { symbol: 'ITA', name: 'iShares U.S. Aerospace & Defense ETF', filter: 'defense_etfs', aliases: ['Aerospace Defense ETF'] },
      { symbol: 'XAR', name: 'SPDR S&P Aerospace & Defense ETF', filter: 'defense_etfs' },
      { symbol: 'PPA', name: 'Invesco Aerospace & Defense ETF', filter: 'defense_etfs' },
    ],
  },
  {
    id: 'growth',
    ...
    sourcesTitleKey: 'stock_category_sources_title',
    sectorGuideTitleKey: 'stock_category_sectors_guide',
    noNewsMessage: 'No recent growth stocks news found from configured real data sources.',
    rssQuery: 'growth stocks OR revenue growth stocks OR cloud software stocks OR fintech stocks OR e-commerce growth stocks',
    filters: [
      commonFilterAll,
      { key: 'technology', labelKey: 'stock_category_filter_technology', keywords: ['technology', 'tech stocks', 'software platform'] },
      ...
      { key: 'small_mid_growth', labelKey: 'stock_category_filter_small_mid_growth', keywords: ['small cap growth', 'mid cap growth', 'emerging growth'] },
    ],
    watchlist: [
      { symbol: 'AMZN', name: 'Amazon', filter: 'ecommerce', filters: ['ecommerce', 'cloud'] },
      { symbol: 'TSLA', name: 'Tesla', filter: 'technology' },
      ...
      { symbol: 'PLTR', name: 'Palantir', filter: 'software' },
  ...
  },
  {
    ...
    rssQuery: 'dividend stocks OR dividend yield OR dividend growth OR dividend aristocrats OR REIT income stocks',
    filters: [
      commonFilterAll,
      { key: 'high_yield', labelKey: 'stock_category_filter_high_yield', keywords: ['high dividend yield', 'high yield'] },
      { key: 'dividend_growth', labelKey: 'stock_category_filter_dividend_growth', keywords: ['dividend growth', 'raised dividend', 'dividend increase'] },
      { key: 'stable_dividends', labelKey: 'stock_category_filter_stable_dividends', keywords: ['stable dividend', 'income stock'] },
      { key: 'aristocrats', labelKey: 'stock_category_filter_aristocrats', keywords: ['dividend aristocrat', 'aristocrats'] },
      ...
      { key: 'consumer_staples', labelKey: 'defensive_news_category_consumer_staples', keywords: ['consumer staples', 'staples'] },
      { key: 'reits', labelKey: 'stock_category_filter_reits', keywords: ['REIT', 'real estate investment trust'] },
    ],
    metricCards: [
    ...
    watchlist: [
      { symbol: 'KO', name: 'Coca-Cola', filter: 'aristocrats', filters: ['consumer_staples', 'aristocrats'] },
      { symbol: 'PEP', name: 'PepsiCo', filter: 'dividend_growth', filters: ['consumer_staples', 'dividend_growth'] },
      { symbol: 'PG', name: 'Procter & Gamble', filter: 'aristocrats', filters: ['consumer_staples', 'aristocrats'] },
      { symbol: 'JNJ', name: 'Johnson & Johnson', filter: 'stable_dividends' },
      { symbol: 'MCD', name: "McDonald's", filter: 'dividend_growth' },
      ...
      { symbol: 'MO', name: 'Altria', filter: 'high_yield' },
      { symbol: 'PM', name: 'Philip Morris International', filter: 'stable_dividends' },
      { symbol: 'XOM', name: 'Exxon Mobil', filter: 'stable_dividends' },
      { symbol: 'CVX', name: 'Chevron', filter: 'dividend_growth' },
      ...
      { symbol: 'ABBV', name: 'AbbVie', filter: 'dividend_growth' },
      { symbol: 'IBM', name: 'IBM', filter: 'stable_dividends' },
      { symbol: 'MMM', name: '3M', filter: 'aristocrats' },
    ],
  },
  {
    id: 'cyclical',
    ...
    titleKey: 'stock_category_cyclical_title',
    subtitleKey: 'stock_category_cyclical_subtitle',
    badgeKey: 'stock_category_cyclical_badge',
    explanationTitleKey: 'stock_category_cyclical_explanation_title',
    explanationBodyKey: 'stock_category_cyclical_explanation',
    disclaimerTitleKey: 'defensive_news_disclaimer_title',
    disclaimerBodyKey: 'stock_category_standard_disclaimer',
    searchPlaceholderKey: 'stock_category_search_placeholder',
    filterLabelKey: 'stock_category_filter_label',
    ...
    filters: [
      ...
      { key: 'airlines_travel', labelKey: 'stock_category_filter_airlines_travel', keywords: ['airline', 'travel', 'passenger traffic'] },
      { key: 'hotels_entertainment', labelKey: 'stock_category_filter_hotels_entertainment', keywords: ['hotel', 'resort', 'entertainment'] },
      { key: 'industrials', labelKey: 'stock_category_filter_industrials', keywords: ['industrial', 'machinery', 'aerospace'] },
      { key: 'construction_materials', labelKey: 'stock_category_filter_construction_materials', keywords: ['construction', 'housing', 'materials'] },
      { key: 'luxury_goods', labelKey: 'stock_category_filter_luxury_goods', keywords: ['luxury', 'premium goods'] },
      { key: 'shipping_transport', labelKey: 'stock_category_filter_shipping_transport', keywords: ['shipping', 'transport', 'freight'] },
    ...
    watchlist: [
      ...
      { symbol: 'HD', name: 'Home Depot', filter: 'construction_materials' },
      { symbol: 'LOW', name: "Lowe's", filter: 'construction_materials' },
