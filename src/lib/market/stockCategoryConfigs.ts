...
export const STOCK_CATEGORY_CONFIGS: StockCategoryConfig[] = [
  {
    ...
    filters: [
      ...
      { key: 'insurance_stable', labelKey: 'defensive_news_category_insurance_stable', keywords: ['insurance', 'managed care', 'health insurer'] },
    ],
    watchlist: [
      ...
      { symbol: 'UNH', name: 'UnitedHealth Group', filter: 'insurance_stable', filters: ['healthcare', 'insurance_stable'], aliases: ['UnitedHealth'] },
  ...
  },
  {
    ...
    rssQuery: 'Sharia compliant stocks OR Islamic finance stocks OR halal investing stocks OR sukuk stocks OR Islamic ETF',
    shariaCaution: true,
    filters: [
      commonFilterAll,
      { key: 'permissible_activity', labelKey: 'stock_category_filter_permissible_activity', keywords: ['permissible activity', 'halal business'] },
      { key: 'needs_review', labelKey: 'stock_category_filter_needs_review', keywords: ['needs review', 'screening review'] },
      { key: 'unclear', labelKey: 'stock_category_filter_unclear', keywords: ['unclear', 'not classified'] },
      { key: 'low_debt', labelKey: 'stock_category_filter_low_debt', keywords: ['low debt', 'debt ratio'] },
      { key: 'compatible_distributions', labelKey: 'stock_category_filter_compatible_distributions', keywords: ['dividend', 'distribution'] },
      { key: 'sharia_funds', labelKey: 'stock_category_filter_sharia_funds', keywords: ['Islamic ETF', 'Sharia ETF', 'Sharia fund'] },
      { key: 'gulf_stocks', labelKey: 'stock_category_filter_gulf_stocks', keywords: ['Gulf stock', 'Saudi', 'Kuwait', 'Qatar'] },
      { key: 'global_stocks', labelKey: 'stock_category_filter_global_stocks', keywords: ['global stock', 'US stock', 'international stock'] },
    ],
    metricCards: [
    ...
    watchlist: [
      { symbol: 'SPUS', name: 'SP Funds S&P 500 Sharia Industry Exclusions ETF', filter: 'sharia_funds', aliases: ['SP Funds'] },
      { symbol: 'HLAL', name: 'Wahed FTSE USA Shariah ETF', filter: 'sharia_funds', aliases: ['Wahed', 'FTSE USA Shariah'] },
      { symbol: 'UMMA', name: 'Wahed Dow Jones Islamic World ETF', filter: 'sharia_funds', aliases: ['Dow Jones Islamic World'] },
    ],
  },
];
