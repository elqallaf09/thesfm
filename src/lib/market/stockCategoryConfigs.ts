...
export const STOCK_CATEGORY_CONFIGS: StockCategoryConfig[] = [
  ...
  },
  {
    ...
    noNewsMessage: 'No recent high income stocks news found from configured real data sources.',
    rssQuery: 'high income stocks OR high dividend yield stocks OR dividend income stocks OR REIT income stocks OR telecom dividends OR utility dividends OR energy dividends',
    filters: [
      commonFilterAll,
      { key: 'dividends', labelKey: 'stock_category_filter_dividends', keywords: ['dividend', 'dividends', 'distribution', 'payout', 'ex-dividend'] },
      { key: 'high_yield', labelKey: 'stock_category_filter_high_yield', keywords: ['high yield', 'high-yield', 'yield', 'income'] },
      { key: 'earnings', labelKey: 'stock_category_filter_earnings', keywords: ['earnings', 'profit', 'revenue', 'quarterly results'] },
      { key: 'fixed_income', labelKey: 'stock_category_filter_fixed_income', keywords: ['fixed income', 'income fund', 'bond', 'treasury'] },
      { key: 'defensive', labelKey: 'stock_category_filter_defensive_stocks', keywords: ['defensive', 'consumer staples', 'healthcare', 'utility'] },
  ...
  },
  {
    ...
    watchlist: [
      ...
      { symbol: 'BKR', name: 'Baker Hughes', filter: 'oil_services' },
      ...
      { symbol: 'TRP', name: 'TC Energy', filter: 'pipelines', aliases: ['TransCanada'] },
      { symbol: 'KMI', name: 'Kinder Morgan', filter: 'pipelines' },
      ...
      { symbol: 'PLUG', name: 'Plug Power', filter: 'renewables', aliases: ['PlugPower'] },
  ...
  },
  {
    ...
    watchlist: [
      ...
      { symbol: 'TFC', name: 'Truist Financial', filter: 'regional_banks' },
      { symbol: 'SCHW', name: 'Charles Schwab', filter: 'asset_management' },
      { symbol: 'BLK', name: 'BlackRock', filter: 'asset_management' },
      { symbol: 'BK', name: 'Bank of New York Mellon', filter: 'asset_management', aliases: ['BNY Mellon'] },
  ...
  },
  {
    ...
    watchlist: [
      { symbol: 'AAPL', name: 'Apple', filter: 'unclassified' },
      { symbol: 'MSFT', name: 'Microsoft', filter: 'unclassified' },
      { symbol: 'NVDA', name: 'NVIDIA', filter: 'unclassified' },
      { symbol: 'GOOGL', name: 'Alphabet', filter: 'unclassified', aliases: ['Google'] },
      { symbol: 'META', name: 'Meta Platforms', filter: 'unclassified' },
      { symbol: 'TSLA', name: 'Tesla', filter: 'unclassified' },
      { symbol: 'AMD', name: 'Advanced Micro Devices', filter: 'unclassified' },
      { symbol: 'ASML', name: 'ASML Holding', filter: 'unclassified' },
      { symbol: 'TSM', name: 'Taiwan Semiconductor', filter: 'unclassified' },
      { symbol: 'AVGO', name: 'Broadcom', filter: 'unclassified' },
      { symbol: 'COST', name: 'Costco Wholesale', filter: 'unclassified' },
      { symbol: 'WMT', name: 'Walmart', filter: 'unclassified' },
      { symbol: 'PG', name: 'Procter & Gamble', filter: 'unclassified' },
      { symbol: 'KO', name: 'Coca-Cola', filter: 'unclassified' },
      { symbol: 'PEP', name: 'PepsiCo', filter: 'unclassified' },
      { symbol: 'JNJ', name: 'Johnson & Johnson', filter: 'unclassified' },
      { symbol: 'ABBV', name: 'AbbVie', filter: 'unclassified' },
      { symbol: 'MRK', name: 'Merck', filter: 'unclassified' },
      { symbol: 'UNH', name: 'UnitedHealth Group', filter: 'unclassified' },
      ...
      { symbol: 'SPRE', name: 'SP Funds S&P Global REIT Sharia ETF', filter: 'unclassified' },
      { symbol: 'SPSK', name: 'SP Funds Dow Jones Global Sukuk ETF', filter: 'unclassified' },
    ],
  },
];
