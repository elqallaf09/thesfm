...
const PACKAGED_API_PATHS = new Set(['/api/tv/snapshot', '/api/tv/catalog', '/api/tv/instruments', '/api/tv/strips', '/api/tv/news', '/api/tv/pair', '/api/tv/device', '/api/intelligence/latest']);
