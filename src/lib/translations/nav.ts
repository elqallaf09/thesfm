...
export const TR_NAV: Record<string, TranslationEntry> = {
  ...
  nav_group_market_news: { ar:'أخبار الأسواق', en:'Market News', fr:'Actualités des marchés' },
  nav_subgroup_regional_markets: { ar:'الأسواق والمناطق', en:'Regional & Market', fr:'Régional et marché' },
  nav_subgroup_sector_strategy: { ar:'القطاعات والاستراتيجيات', en:'Sector & Strategy', fr:'Secteur et stratégie' },
  ...
  nav_group_services: { ar:'الشركات والخدمات', en:'Companies & Services', fr:'Entreprises et services' },
  ...
  nav_ai_analyst: { ar:'إس إف إم المحلل الذكي', en:'SFM Smart Analyst', fr:'Analyste intelligent SFM' },
  ...
  nav_business_operations: { ar:'لوحة الإدارة', en:'Business Dashboard', fr:'Tableau de gestion' },
  nav_clients_subscriptions: { ar:'العملاء والاشتراكات', en:'Clients & Subscriptions', fr:'Clients et abonnements' },
  ...
  nav_khums:      { ar:'الخمس', en:'Khums', fr:'Khums' },
  ...
  nav_company_submission: { ar:'إضافة شركة', en:'Submit a Company', fr:'Proposer une société' },
  ...
  nav_admin_news_providers: { ar: 'حالة مصادر الأخبار', en: 'News Provider Status', fr: 'État des sources d’actualités' },
  ...
  nav_group_trader_trading: { ar: 'التداول', en: 'Trading', fr: 'Trading' },
  nav_group_trader_follow: { ar: 'المتابعة', en: 'Watch & Track', fr: 'Suivi' },
  nav_group_trader_more: { ar: 'أخرى', en: 'More', fr: 'Autres' },
  nav_trader_dashboard: { ar: 'القيادة', en: 'Command Center', fr: 'Centre de commande' },
  nav_trader_markets: { ar: 'الأسواق', en: 'Markets', fr: 'Marchés' },
  nav_trader_ai_scanner: { ar: 'ماسح الذكاء', en: 'AI Scanner', fr: 'Scanner IA' },
  nav_trader_symbol_details: { ar: 'تفاصيل الرمز', en: 'Symbol Details', fr: 'Détails du symbole' },
  nav_trader_watchlist: { ar: 'قائمة المتابعة', en: 'Watchlist', fr: 'Liste de suivi' },
  nav_trader_portfolio: { ar: 'المحفظة', en: 'Portfolio', fr: 'Portefeuille' },
  nav_trader_alerts: { ar: 'التنبيهات', en: 'Alerts', fr: 'Alertes' },
  nav_trader_recommendations: { ar: 'التوصيات', en: 'Recommendations', fr: 'Recommandations' },
  nav_trader_trade_performance: { ar: 'أداء الصفقات', en: 'Trade Performance', fr: 'Performance des trades' },
  nav_trader_news: { ar: 'الأخبار', en: 'News', fr: 'Actualités' },
  nav_trader_calendar: { ar: 'التقويم', en: 'Calendar', fr: 'Calendrier' },
  nav_trader_education: { ar: 'التعليم', en: 'Education', fr: 'Éducation' },
  nav_trader_settings: { ar: 'الإعدادات', en: 'Settings', fr: 'Paramètres' },
};
