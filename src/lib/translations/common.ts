...
export const TR_COMMON: Record<string, TranslationEntry> = {
  admin_access_denied_title: { ar:'ليس لديك صلاحية للوصول إلى هذه الصفحة.', en:'You do not have permission to access this page.', fr:'Vous n’avez pas l’autorisation d’accéder à cette page.' },
  admin_access_denied_body: { ar:'إذا كنت تحتاج إلى هذه الصلاحية، فتواصل مع المسؤول الرئيسي.', en:'If you need this permission, contact the super administrator.', fr:'Si vous avez besoin de cette autorisation, contactez le super administrateur.' },
  income_sources_required: { ar:'أدخل مبلغاً واحداً على الأقل من أنواع الدخل الشهري.', en:'Enter at least one monthly income amount.', fr:'Saisissez au moins un montant de revenu mensuel.' },
  income_sources_save_error: { ar:'تعذر حفظ أنواع الدخل.', en:'Unable to save income sources.', fr:'Impossible d’enregistrer les sources de revenus.' },
  income_sources_welcome: { ar:'مرحباً', en:'Welcome', fr:'Bienvenue' },
  income_sources_you: { ar:'بك', en:'to your account', fr:'dans votre espace' },
  income_sources_title: { ar:'أنواع الدخل الشهري', en:'Monthly income sources', fr:'Sources de revenus mensuels' },
  income_sources_description: { ar:'اختر مصادر دخلك وأدخل قيمة كل مصدر ليتم حساب دخلك الشهري بدقة.', en:'Select your income sources and enter each amount to calculate your monthly income accurately.', fr:'Sélectionnez vos sources de revenus et saisissez chaque montant pour calculer précisément votre revenu mensuel.' },
  income_sources_form_title: { ar:'إدخال الدخل الشهري', en:'Enter monthly income', fr:'Saisir le revenu mensuel' },
  income_sources_optional_hint: { ar:'يمكنك ترك أي نوع دخل لا ينطبق عليك فارغاً.', en:'You can leave any income source that does not apply blank.', fr:'Vous pouvez laisser vide toute source de revenus qui ne vous concerne pas.' },
  income_sources_monthly_amount: { ar:'المبلغ الشهري', en:'Monthly amount', fr:'Montant mensuel' },
  income_sources_total: { ar:'إجمالي الدخل الشهري', en:'Total monthly income', fr:'Revenu mensuel total' },
  income_sources_saving: { ar:'جارٍ الحفظ...', en:'Saving...', fr:'Enregistrement...' },
  income_sources_save_continue: { ar:'حفظ ومتابعة', en:'Save and continue', fr:'Enregistrer et continuer' },
  income_category_active: { ar:'الدخل النشط', en:'Active income', fr:'Revenu actif' },
  income_category_active_examples: { ar:'الدخل الشهري|الأجر اليومي أو بالساعة|العمولات|العمل الحر', en:'Monthly pay|Daily or hourly wages|Commissions|Freelance work', fr:'Salaire mensuel|Salaire journalier ou horaire|Commissions|Travail indépendant' },
  income_category_passive: { ar:'الدخل السلبي', en:'Passive income', fr:'Revenu passif' },
  income_category_passive_examples: { ar:'إيجار العقارات|أرباح الأسهم|عوائد المشاريع|بيع المنتجات الرقمية|قنوات يوتيوب أو تطبيقات', en:'Property rent|Dividends|Project returns|Digital product sales|YouTube channels or apps', fr:'Loyers immobiliers|Dividendes|Rendements de projets|Vente de produits numériques|Chaînes YouTube ou applications' },
  income_category_investment: { ar:'دخل الاستثمار', en:'Investment income', fr:'Revenu d’investissement' },
  income_category_investment_examples: { ar:'الأسهم|الصناديق الاستثمارية|السندات|العملات الرقمية', en:'Stocks|Investment funds|Bonds|Cryptocurrencies', fr:'Actions|Fonds d’investissement|Obligations|Cryptomonnaies' },
  income_category_business: { ar:'دخل الأعمال', en:'Business income', fr:'Revenu d’entreprise' },
  income_category_business_examples: { ar:'متجر|مطعم|شركة خدمات|تجارة إلكترونية', en:'Store|Restaurant|Service company|E-commerce', fr:'Magasin|Restaurant|Société de services|Commerce électronique' },
  income_category_additional: { ar:'الدخل الإضافي', en:'Additional income', fr:'Revenu complémentaire' },
  income_category_additional_examples: { ar:'التوصيل|التصميم|التدريس|التسويق بالعمولة', en:'Delivery work|Design|Teaching|Affiliate marketing', fr:'Livraison|Design|Enseignement|Marketing d’affiliation' },
  income_category_seasonal: { ar:'الدخل الموسمي أو المؤقت', en:'Seasonal or temporary income', fr:'Revenu saisonnier ou temporaire' },
  income_category_seasonal_examples: { ar:'مواسم البيع|المكافآت السنوية|مشاريع مؤقتة', en:'Sales seasons|Annual bonuses|Temporary projects', fr:'Saisons de vente|Primes annuelles|Projets temporaires' },
  income_category_government: { ar:'الدخل الحكومي أو الدعم', en:'Government income or support', fr:'Revenu public ou aides' },
  income_category_government_examples: { ar:'التقاعد|الإعانات|الدعم الحكومي', en:'Pension|Benefits|Government support', fr:'Retraite|Allocations|Aides publiques' },
  guest_loading: { ar:'جارٍ الدخول بوصفك ضيفاً...', en:'Signing in as a guest...', fr:'Connexion en tant qu’invité...' },
  guest_error: { ar:'تعذر بدء وضع الضيف.', en:'Unable to start guest mode.', fr:'Impossible de démarrer le mode invité.' },
  skip_to_content: { ar:'تخطَّ إلى المحتوى', en:'Skip to content', fr:'Aller au contenu' },
  debug_business_data: { ar:'تشخيص بيانات الأعمال', en:'Business data diagnostics', fr:'Diagnostic des données d’activité' },
  ...
  accessibility_pagination: { ar:'ترقيم الصفحات', en:'Pagination', fr:'Pagination' },
  accessibility_breadcrumb: { ar:'مسار التنقل', en:'Breadcrumb', fr:'Fil d’Ariane' },
  accessibility_previous_page: { ar:'الانتقال إلى الصفحة السابقة', en:'Go to previous page', fr:'Aller à la page précédente' },
  accessibility_next_page: { ar:'الانتقال إلى الصفحة التالية', en:'Go to next page', fr:'Aller à la page suivante' },
  accessibility_more_pages: { ar:'صفحات إضافية', en:'More pages', fr:'Pages supplémentaires' },
  accessibility_previous_slide: { ar:'الشريحة السابقة', en:'Previous slide', fr:'Diapositive précédente' },
  accessibility_next_slide: { ar:'الشريحة التالية', en:'Next slide', fr:'Diapositive suivante' },
  accessibility_more: { ar:'المزيد', en:'More', fr:'Plus' },
  accessibility_toggle_sidebar: { ar:'إظهار أو إخفاء الشريط الجانبي', en:'Toggle sidebar', fr:'Afficher ou masquer la barre latérale' },
  accessibility_refresh: { ar:'تحديث', en:'Refresh', fr:'Actualiser' },
  accessibility_refresh_technology_news: { ar:'تحديث أخبار التقنية', en:'Refresh technology news', fr:'Actualiser les actualités technologiques' },
  accessibility_open_navigation: { ar:'فتح قائمة التنقل', en:'Open navigation', fr:'Ouvrir la navigation' },
  accessibility_close_navigation: { ar:'إغلاق قائمة التنقل', en:'Close navigation', fr:'Fermer la navigation' },
  accessibility_send_message: { ar:'إرسال الرسالة', en:'Send message', fr:'Envoyer le message' },
  error_generic_title: { ar:'حدث خطأ', en:'An error occurred', fr:'Une erreur est survenue' },
  error_generic_body: { ar:'تعذر تحميل هذه الصفحة. يرجى المحاولة مرة أخرى.', en:'This page could not be loaded. Please try again.', fr:'Impossible de charger cette page. Veuillez réessayer.' },
  error_report_action: { ar:'إرسال تفاصيل الخطأ', en:'Send error details', fr:'Envoyer les détails de l’erreur' },
  not_found_title: { ar:'الصفحة غير موجودة', en:'Page not found', fr:'Page introuvable' },
  not_found_body: { ar:'الرابط الذي فتحته غير متاح أو تم نقله. يمكنك العودة إلى الصفحة الرئيسية ومتابعة استخدام THE SFM.', en:'The link you opened is unavailable or has moved. Return to the home page to continue using THE SFM.', fr:'Le lien ouvert est indisponible ou a été déplacé. Revenez à l’accueil pour continuer à utiliser THE SFM.' },
  not_found_home: { ar:'العودة إلى الرئيسية', en:'Return home', fr:'Retour à l’accueil' },
