...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_sessions_utc_note: { ar:'الأوقات محسوبة بتوقيت UTC وتعرض محلياً', en:'Times are calculated in UTC and displayed locally', fr:'Les horaires sont calculés en UTC et affichés localement' },
  ...
  market_london_newyork_liquidity_note: { ar:'تكون السيولة غالبًا أعلى خلال تداخل جلستي لندن ونيويورك.', en:'Liquidity is often highest during the London and New York overlap.', fr:'La liquidité est souvent la plus élevée pendant le chevauchement Londres-New York.' },
