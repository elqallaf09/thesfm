...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_calendar_not_configured_body: { ar:'أضف ECONOMIC_CALENDAR_API_KEY لتفعيل أحداث NFP وCPI وقرارات الفائدة وخطابات البنوك المركزية.', en:'Add ECONOMIC_CALENDAR_API_KEY to enable NFP, CPI, rate decisions, and central bank events.', fr:'Ajoutez ECONOMIC_CALENDAR_API_KEY pour activer NFP, CPI, décisions de taux et événements des banques centrales.' },
