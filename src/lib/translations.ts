...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_news_not_configured_body: { ar:'أضف CENTRAL_BANK_NEWS_API_KEY أو NEWS_API_KEY لعرض الأخبار الحقيقية مع رابط المصدر الأصلي.', en:'Add CENTRAL_BANK_NEWS_API_KEY or NEWS_API_KEY to show real news with original source links.', fr:'Ajoutez CENTRAL_BANK_NEWS_API_KEY ou NEWS_API_KEY pour afficher les vraies actualités avec les liens sources.' },
  ...
  market_sentiment_not_configured_body: { ar:'أضف MARKET_SENTIMENT_API_KEY لعرض نسب الشراء والبيع الحقيقية.', en:'Add MARKET_SENTIMENT_API_KEY to show real buy and sell ratios.', fr:'Ajoutez MARKET_SENTIMENT_API_KEY pour afficher les vrais ratios achat/vente.' },
