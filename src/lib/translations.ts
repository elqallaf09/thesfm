...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_performance_unavailable_title: { ar:'لا توجد بيانات أداء حقيقية حالياً', en:'No real performance data is available right now', fr:'Aucune donnée réelle de performance disponible pour le moment' },
  market_performance_unavailable_body: { ar:'اربط OPENBB_SERVICE_URL أو OPENBB_API_URL لعرض أفضل وأسوأ الأصول وأداء الأسبوع والشهر.', en:'Connect OPENBB_SERVICE_URL or OPENBB_API_URL to show best/worst assets and weekly/monthly performance.', fr:'Connectez OPENBB_SERVICE_URL ou OPENBB_API_URL pour afficher les meilleurs/pires actifs et les performances hebdomadaires/mensuelles.' },
