...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_news_not_configured_body: { ar:'سيتم عرض أخبار Fed و ECB و BoE و BoJ فور تفعيل مصدر الأخبار.', en:'News from the Fed, ECB, BoE, and BoJ will appear once the news source is enabled.', fr:'Les actualités de la Fed, de la BCE, de la BoE et de la BoJ apparaîtront une fois la source activée.' },
  ...
  market_news_unavailable_body: { ar:'تعذر جلب أخبار البنوك المركزية حاليًا من مزود البيانات. حاول مرة أخرى لاحقًا.', en:'Central bank news is currently unavailable from the data provider. Try again later.', fr:'Les actualités des banques centrales sont actuellement indisponibles auprès du fournisseur de données. Réessayez plus tard.' },
  market_news_no_items_title: { ar:'لا توجد أخبار متاحة حاليًا', en:'No news is available right now', fr:'Aucune actualité n’est disponible pour le moment' },
  market_news_no_items_body: { ar:'ستظهر الأخبار فور توفرها من مزود البيانات.', en:'News will appear as soon as it is available from the data provider.', fr:'Les actualités apparaîtront dès qu’elles seront disponibles auprès du fournisseur de données.' },
