...
export const TR: Record<string, TranslationEntry> = {
  ...
  tech_news_dashboard_category_ai: { ar:'الذكاء الاصطناعي', en:'AI', fr:'IA' },
  tech_news_dashboard_category_semiconductors: { ar:'أشباه الموصلات', en:'Semiconductors', fr:'Semi-conducteurs' },
  tech_news_dashboard_category_markets: { ar:'الأسواق', en:'Markets', fr:'Marchés' },
  tech_news_dashboard_category_crypto: { ar:'العملات الرقمية', en:'Crypto', fr:'Crypto' },
  tech_news_dashboard_category_companies: { ar:'الشركات', en:'Companies', fr:'Entreprises' },
