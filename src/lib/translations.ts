...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_sentiment_unavailable_body: { ar:'تعذر جلب مشاعر السوق حاليًا من مزود البيانات. حاول مرة أخرى لاحقًا.', en:'Market sentiment is currently unavailable from the data provider. Try again later.', fr:'Le sentiment du marché est actuellement indisponible auprès du fournisseur de données. Réessayez plus tard.' },
  market_sentiment_no_items_title: { ar:'لا توجد بيانات مشاعر متاحة حاليًا', en:'No sentiment data is available right now', fr:'Aucune donnée de sentiment n’est disponible pour le moment' },
  market_sentiment_no_items_body: { ar:'لا توجد نسب شراء وبيع كافية لهذا الأصل من مزود البيانات الحالي.', en:'No reliable buy and sell ratios are available for this asset from the current data provider.', fr:'Aucun ratio d’achat et de vente fiable n’est disponible pour cet actif auprès du fournisseur actuel.' },
