...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_news_sentiment_subtitle: { ar:'تابع أخبار البنوك المركزية ومؤشرات مشاعر السوق.', en:'Track central bank news and market sentiment indicators.', fr:'Suivez les actualités des banques centrales et les indicateurs de sentiment du marché.' },
  ...
  market_central_bank_topics: { ar:'Fed وECB وBoE وBoJ وSNB وBoC وRBA', en:'Fed, ECB, BoE, BoJ, SNB, BoC, and RBA', fr:'Fed, BCE, BoE, BoJ, BNS, BoC et RBA' },
  ...
  market_sentiment_note_title: { ar:'مؤشر مساعد', en:'Supporting indicator', fr:'Indicateur d’aide' },
