...
export const TR: Record<string, TranslationEntry> = {
  ...
  stock_category_empty: { ar:'لا توجد أخبار حاليًا في هذا التصنيف.', en:'No news available in this category right now.', fr:'Aucune actualité disponible dans cette catégorie pour le moment.' },
  ...
  stock_category_movers_empty: { ar:'لا توجد بيانات سوق كافية لعرض حركة الأسهم حاليًا.', en:'Not enough market data to show stock movers right now.', fr:'Données de marché insuffisantes pour afficher les mouvements.' },
  ...
  stock_category_dividend_explanation: { ar:'أسهم التوزيعات هي أسهم شركات تعيد جزءًا من أرباحها للمساهمين على شكل توزيعات نقدية. لا تعني بالضرورة أنها منخفضة المخاطر، لذلك يجب مراجعة استدامة التوزيعات ونسبة الدفع والديون.', en:'Dividend stocks are shares of companies that return part of their profits to shareholders as cash dividends. They are not automatically low risk, so dividend sustainability, payout ratio, and debt should be reviewed.', fr:'Les actions à dividendes sont des actions de sociétés qui reversent une partie de leurs bénéfices aux actionnaires sous forme de dividendes. Elles ne sont pas nécessairement peu risquées : durabilité, taux de distribution et dette doivent être examinés.' },
