...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_timeout_error: { ar:'تعذر تحميل بيانات السوق حالياً.', en:'Market data could not be loaded right now.', fr:'Impossible de charger les données de marché pour le moment.' },
  ...
  market_no_data_for_symbol: { ar:'لا توجد بيانات لهذا الرمز حالياً.', en:'No data is available for this symbol right now.', fr:'Aucune donnée n’est disponible pour ce symbole pour le moment.' },
