...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_calendar_not_configured_body: { ar:'سيتم عرض الأحداث عالية التأثير مثل قرارات الفائدة وCPI وNFP فور تفعيل مصدر البيانات.', en:'High-impact events such as interest rate decisions, CPI, and NFP will appear once the data source is enabled.', fr:'Les événements à fort impact comme les décisions de taux, le CPI et le NFP apparaîtront dès que la source de données sera activée.' },
