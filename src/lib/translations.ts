...
export const TR: Record<string, TranslationEntry> = {
  ...
  tech_news_search_placeholder: { ar:'ابحث باسم الشركة أو الرمز...', en:'Search by company or ticker...', fr:'Rechercher par société ou symbole...' },
  ...
  gulf_news_title: { ar:'أخبار أسواق الخليج', en:'Gulf Market News', fr:'Actualités des marchés du Golfe' },
  ...
  gulf_news_market_kuwait: { ar:'الكويت', en:'Kuwait', fr:'Koweït' },
  gulf_news_market_saudi: { ar:'السعودية', en:'Saudi Arabia', fr:'Arabie saoudite' },
  gulf_news_market_oman: { ar:'عُمان', en:'Oman', fr:'Oman' },
  gulf_news_market_bahrain: { ar:'البحرين', en:'Bahrain', fr:'Bahreïn' },
  gulf_news_market_uae: { ar:'الإمارات', en:'UAE', fr:'Émirats arabes unis' },
  gulf_news_market_qatar: { ar:'قطر', en:'Qatar', fr:'Qatar' },
  ...
  gulf_news_disclaimer: { ar:'الأسعار والمؤشرات المعروضة مؤجلة وقد لا تكون متاحة لكل الأسواق. الأخبار يتم جلبها من مصادر RSS عامة. هذه المعلومات ليست توصية استثمارية.', en:'Displayed prices and indices are delayed and may not be available for every market. News is fetched from public RSS sources. This information is not investment advice.', fr:'Les prix et indices affichés sont différés et peuvent ne pas être disponibles pour tous les marchés. Les actualités proviennent de sources RSS publiques. Ces informations ne constituent pas un conseil en investissement.' },
