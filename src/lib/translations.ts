...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_sentiment_myfxbook_auth_failed_body: { ar:'تعذر تسجيل الدخول إلى Myfxbook. يرجى التحقق من البريد الإلكتروني وكلمة المرور.', en:'Could not sign in to Myfxbook. Please verify the email and password.', fr:'Impossible de se connecter à Myfxbook. Veuillez vérifier l’adresse e-mail et le mot de passe.' },
