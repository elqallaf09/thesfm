...
export const TR: Record<string, TranslationEntry> = {
  ...
  admin_no_data: { ar:'لا توجد بيانات تحليلات حتى الآن. ستبدأ الأرقام بالظهور بعد دخول الزوار واستخدامهم للموقع.', en:'No analytics data yet. Numbers will appear after visitors start using the website.', fr:'Aucune donnée analytique pour le moment. Les chiffres apparaîtront après l’utilisation du site.' },
  admin_error: { ar:'حدث خطأ أثناء تحميل بيانات الأدمن.', en:'An error occurred while loading admin data.', fr:'Une erreur est survenue lors du chargement des données administrateur.' },
  ...
  admin_loading: { ar:'جاري تحميل تحليلات الأدمن...', en:'Loading admin analytics...', fr:'Chargement des analyses administrateur...' },
