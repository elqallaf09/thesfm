...
export const TR = {
  ...
  /* ── Navigation / Sidebar ── */
  nav_home:       { ar:'الرئيسية',        en:'Dashboard' },
  nav_expenses:   { ar:'المصاريف',        en:'Expenses' },
  nav_income:     { ar:'الدخل',           en:'Income' },
  nav_invest:     { ar:'الاستثمارات',     en:'Investments' },
  nav_goals:      { ar:'الأهداف المالية', en:'Financial Goals' },
  nav_projects:   { ar:'مشاريعي',         en:'My Projects' },
  nav_charity:    { ar:'الأعمال الخيرية', en:'Charity' },
  nav_reports:    { ar:'التقارير',        en:'Reports' },
  nav_ai:         { ar:'تحليلات الذكاء',  en:'AI Analytics' },
  nav_notif:      { ar:'الإشعارات',       en:'Notifications' },
  nav_settings:   { ar:'الإعدادات',       en:'Settings' },
  nav_profile:    { ar:'الملف الشخصي',    en:'Profile' },
  nav_logout:     { ar:'تسجيل الخروج',    en:'Sign Out' },
  nav_savings:    { ar:'المدخرات',        en:'Savings' },
  nav_education:  { ar:'التعليم المالي',   en:'Financial Education' },
  ...
  ai_manager:     { ar:'المدير المالي الذكي', en:'AI Finance Manager' },
