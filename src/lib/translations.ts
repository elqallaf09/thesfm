...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_search_placeholder: { ar:'Apple أو AAPL أو BTC أو EURUSD', en:'Apple, AAPL, BTC, or EURUSD', fr:'Apple, AAPL, BTC ou EURUSD' },
  market_asset_type: { ar:'اختر أصل مالي', en:'Select an asset', fr:'Sélectionner un actif' },
  ...
  market_demo_data_shown: { ar:'يتم عرض بيانات تجريبية لهذا الأصل لأن مزود البيانات لم يرجع بيانات حقيقية.', en:'Demo data is shown for this asset because the provider did not return real data.', fr:'Des données démo sont affichées pour cet actif car le fournisseur n’a pas renvoyé de données réelles.' },
  ...
  market_no_search_results: { ar:'لم يتم العثور على هذا الأصل. جرّب كتابة الرمز مباشرة مثل AAPL أو BTC.', en:'No asset found. Try entering the symbol directly, such as AAPL or BTC.', fr:'Aucun actif trouvé. Essayez de saisir le symbole directement, comme AAPL ou BTC.' },
