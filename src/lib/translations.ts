...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_amount_with_currency_placeholder: { ar:'أدخل المبلغ ({currency})', en:'Enter amount ({currency})', fr:'Saisissez le montant ({currency})' },
  market_amount_currency_label: { ar:'عملة المبلغ', en:'Amount currency', fr:'Devise du montant' },
  ...
  gulf_news_header_subtitle: { ar:'المصدر: خلاصات RSS مجانية • تحديث تلقائي كل 5 دقائق', en:'Source: free RSS feeds • automatic refresh every 5 minutes', fr:'Source : flux RSS gratuits • actualisation automatique toutes les 5 minutes' },
  ...
  gulf_news_unavailable_helper: { ar:'لا يتوفر مصدر مجاني موثوق لهذا المؤشر حاليًا', en:'No reliable free source is currently available for this index', fr:'Aucune source gratuite fiable n’est actuellement disponible pour cet indice' },
  ...
  europe_news_header_subtitle: { ar:'المصدر: خلاصات RSS مجانية • تحديث تلقائي كل 5 دقائق', en:'Source: free RSS feeds • automatic refresh every 5 minutes', fr:'Source : flux RSS gratuits • actualisation automatique toutes les 5 minutes' },
  ...
  europe_news_unavailable_helper: { ar:'لا يتوفر مصدر مجاني موثوق لهذا المؤشر حاليًا', en:'No reliable free source is currently available for this index', fr:'Aucune source gratuite fiable n’est actuellement disponible pour cet indice' },
