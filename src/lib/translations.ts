...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_sentiment_symbol_required_body: { ar:'يرجى اختيار أصل لعرض مشاعر السوق.', en:'Please select an asset to view market sentiment.', fr:'Veuillez sélectionner un actif pour afficher le sentiment de marché.' },
  ...
  market_sentiment_no_items_title: { ar:'لا تتوفر بيانات مشاعر سوق لهذا الأصل حاليًا', en:'No market sentiment data is available for this asset right now', fr:'Aucune donnée de sentiment de marché n’est disponible pour cet actif actuellement' },
