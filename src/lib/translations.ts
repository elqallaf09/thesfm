...
export const TR: Record<string, TranslationEntry> = {
  ...
  market_hero_badge: { ar:'بيانات تجريبية مؤقتة', en:'Temporary demo data', fr:'Données de démonstration temporaires' },
  market_badge_live: { ar:'بيانات سوق حقيقية عبر OpenBB', en:'Live market data via OpenBB', fr:'Données de marché via OpenBB' },
  market_badge_demo: { ar:'بيانات تجريبية مؤقتة', en:'Temporary demo data', fr:'Données de démonstration temporaires' },
  ...
  market_hero_subtitle: { ar:'استعرض الأسهم والعملات الرقمية والذهب ببيانات تجريبية، مؤشرات فنية، ملخص ذكي، ومخاطر واضحة دون الاتصال بأي مزود بيانات.', en:'Explore stocks, crypto, and gold with mock data, technical indicators, AI-style summaries, and clear risk signals without connecting to any data provider.', fr:'Explorez actions, crypto et or avec des données fictives, indicateurs techniques, synthèses IA et signaux de risque sans connecter de fournisseur.' },
  market_search_label: { ar:'البحث عن أصل مالي', en:'Search for an asset', fr:'Rechercher un actif' },
  market_search_placeholder: { ar:'اكتب رمزاً مثل AAPL أو BTC', en:'Type a symbol like AAPL or BTC', fr:'Saisissez un symbole comme AAPL ou BTC' },
  ...
  market_compare_assets: { ar:'مقارنة الأصول', en:'Compare assets', fr:'Comparer les actifs' },
  market_no_data: { ar:'لا توجد بيانات', en:'No data', fr:'Aucune donnée' },
  market_error_message: { ar:'تعذر عرض التحليل التجريبي حالياً', en:'Could not show the mock analysis right now', fr:"Impossible d'afficher l'analyse fictive pour le moment" },
  market_service_connected: { ar:'خدمة بيانات السوق متصلة عبر OpenBB', en:'Market data service is connected through OpenBB', fr:'Le service de données du marché est connecté via OpenBB' },
  ...
  market_service_unavailable: { ar:'تعذر تحميل بيانات السوق حالياً. حاول لاحقاً.', en:'Market data could not be loaded right now. Please try again later.', fr:'Impossible de charger les données du marché pour le moment. Veuillez réessayer plus tard.' },
  market_service_status: { ar:'حالة خدمة السوق', en:'Market service status', fr:'État du service de marché' },
  market_status_demo: { ar:'بيانات تجريبية', en:'Demo data', fr:'Données démo' },
  ...
  market_chart_demo: { ar:'مخطط السعر التجريبي', en:'Demo price chart', fr:'Graphique de prix démo' },
  ...
  market_disclaimer: { ar:'هذه المعلومات لأغراض تعليمية وتحليلية فقط وليست نصيحة استثمارية.', en:'This information is for educational and analytical purposes only and is not financial advice.', fr:'Ces informations sont fournies à des fins éducatives et analytiques uniquement et ne constituent pas un conseil financier.' },
  market_mock_data: { ar:'بيانات تجريبية', en:'Mock data', fr:'Données fictives' },
  market_price_chart: { ar:'مخطط السعر التجريبي', en:'Mock price chart', fr:'Graphique de prix fictif' },
  market_sample_cards: { ar:'بطاقات تحليل السوق', en:'Market analysis cards', fr:"Cartes d'analyse du marché" },
  ...
  market_ai_summary_text: { ar:'التحليل التجريبي يشير إلى مراقبة الاتجاه، تأكيد الاختراق، وعدم الاعتماد على مؤشر واحد فقط.', en:'The mock analysis suggests watching trend confirmation, breakout quality, and avoiding reliance on a single indicator.', fr:"L'analyse fictive suggère de surveiller la tendance, la qualité des cassures et d'éviter un seul indicateur." },
  ...
  market_fallback_reason: { ar:'سبب استخدام البيانات التجريبية', en:'Fallback reason', fr:'Raison du mode démo' },
  market_fallback_reason_default: { ar:'تعذر جلب البيانات الحقيقية من مزود السوق.', en:'The real market provider could not return data.', fr:'Le fournisseur de marché réel n’a pas renvoyé de données.' },
  market_no_fallback: { ar:'لا توجد بيانات تجريبية مستخدمة', en:'No fallback data in use', fr:'Aucune donnée de secours utilisée' },
  ...
  market_asset_not_in_portfolio: { ar:'هذا الأصل غير موجود في محفظتك', en:'This asset is not in your portfolio', fr:'Cet actif n’est pas dans votre portefeuille' },
  ...
  market_price_alerts: { ar:'تنبيهات السعر', en:'Price alerts', fr:'Alertes de prix' },
  ...
  market_alert_saved: { ar:'تم حفظ التنبيه. سيتم تفعيله عند جاهزية محرك الإشعارات.', en:'Alert saved. It will activate when the notification engine is ready.', fr:'Alerte enregistrée. Elle sera active lorsque le moteur de notifications sera prêt.' },
  ...
  market_ai_asset_report: { ar:'تقرير أصل بالذكاء المالي', en:'AI asset report', fr:'Rapport IA de l’actif' },
