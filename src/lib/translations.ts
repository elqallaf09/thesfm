...
export const TR: Record<string, TranslationEntry> = {
  ...
  nav_group_charity: { ar:'الأعمال الخيرية', en:'Charity', fr:'Charité' },
  ...
  nav_watchlist: { ar:'قائمة المتابعة', en:'Watchlist', fr:'Liste de suivi' },
  nav_market_alerts: { ar:'تنبيهات السوق', en:'Market Alerts', fr:'Alertes de marché' },
