...
export const TR: Record<string, TranslationEntry> = {
  ...
  nav_sharia_stocks: { ar:'أخبار الأسهم الشرعية', en:'Sharia Stocks News', fr:'Actualités des actions conformes à la charia' },
  ...
  stock_category_sharia_title: { ar:'أخبار الأسهم الشرعية', en:'Sharia Stocks News', fr:'Actualités des actions conformes à la charia' },
  ...
  stock_category_sharia_explanation_title: { ar:'ما هي الأسهم الشرعية؟', en:'What are Sharia stocks?', fr:'Que sont les actions conformes à la charia ?' },
  stock_category_sharia_explanation: { ar:'الأسهم الشرعية هي أسهم شركات يكون نشاطها الأساسي مباحًا، وتلتزم بنسب مالية معينة تتعلق بالديون والإيرادات غير المتوافقة والسيولة حسب معايير الجهة الشرعية المستخدمة.', en:'Sharia stocks are shares of companies whose core activity is permissible and that meet financial ratio screens related to debt, non-compliant revenue, and liquidity according to the screening standard used.', fr:'Les actions conformes à la charia sont celles de sociétés dont l’activité principale est permise et qui respectent certains ratios financiers selon le standard de filtrage utilisé.' },
  ...
  stock_category_sharia_disclaimer_body: { ar:'هذه الصفحة تعليمية وتحليلية فقط ولا تُعد فتوى شرعية. يجب الرجوع إلى جهة شرعية مختصة أو مزود فلترة شرعية معتمد قبل اتخاذ أي قرار استثماري.', en:'This page is educational and analytical only and is not a Sharia ruling. Consult a qualified Sharia authority or approved screening provider before making investment decisions.', fr:'Cette page est éducative et analytique uniquement et ne constitue pas un avis religieux. Consultez une autorité compétente ou un fournisseur de filtrage reconnu avant toute décision.' },
  ...
  stock_category_filter_permissible_activity: { ar:'نشاط مباح', en:'Permissible Activity', fr:'Activité permise' },
  stock_category_filter_needs_review: { ar:'يحتاج مراجعة', en:'Needs Review', fr:'À examiner' },
  stock_category_filter_unclear: { ar:'غير واضح', en:'Unclear', fr:'Non clair' },
  stock_category_filter_low_debt: { ar:'منخفض الديون', en:'Low Debt', fr:'Faible dette' },
  stock_category_filter_compatible_distributions: { ar:'توزيعات متوافقة', en:'Compatible Distributions', fr:'Distributions compatibles' },
  stock_category_filter_sharia_funds: { ar:'صناديق شرعية', en:'Sharia Funds', fr:'Fonds charia' },
  stock_category_filter_gulf_stocks: { ar:'أسهم خليجية', en:'Gulf Stocks', fr:'Actions du Golfe' },
  stock_category_filter_global_stocks: { ar:'أسهم عالمية', en:'Global Stocks', fr:'Actions mondiales' },
