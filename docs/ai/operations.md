...
- Authenticated Preview CI uses `SUPABASE_PREVIEW_SERVICE_ROLE_KEY`; the shared `SUPABASE_SERVICE_ROLE_KEY` remains Production-scoped and is never reused for Preview mutations.
