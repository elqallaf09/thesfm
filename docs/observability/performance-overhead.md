...
- Phase build static JavaScript with RUM enabled: 10,915,789 bytes across 625 files.
- Repository-wide delta, including the admin-only dashboard: 63,041 bytes uncompressed (0.581%).
